 ...
 */
export const setCaseContext = createAction('insight/caseContext/set', (payload) => {
 ...
 * Set case id action
 */
export const setCaseId = createAction('insight/caseId/set', (payload) => {
 ...
 */
export const setCaseNumber = createAction('insight/caseNumber/set', (payload) => {
    const valueSchema = requiredEmptyAllowedString;
    const valuesError = validatePayload(payload, valueSchema).error;
    if (valuesError) {
        return { payload, error: valuesError };

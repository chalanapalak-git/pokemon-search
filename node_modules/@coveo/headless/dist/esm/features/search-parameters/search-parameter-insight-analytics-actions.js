...
import { logFacetClearAll, logFacetDeselect, logFacetSelect, } from '../facets/facet-set/facet-set-insight-analytics-actions.js';
...
export function logParametersChange(previousParameters, newParameters) {
...
function logRangeFacetAnalyticsAction(previousFacets = {}, newFacets = {}) {
    return logFacetAnalyticsAction(parseRangeFacetParams(previousFacets), parseRangeFacetParams(newFacets));
}

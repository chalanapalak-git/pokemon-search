...
import { fetchCaseClassifications, registerCaseField, updateCaseField, } from './case-field-actions.js';
import { getCaseFieldInitialState } from './case-field-state.js';
export const caseFieldReducer = createReducer(getCaseFieldInitialState(), (builder) => {
    builder

...
const ensureStringOrUndefined = (result, key) => isString(result.raw[key]) ? String(result.raw[key]) : undefined;
/**
 ...
 */
export const buildAttachedResultFromSearchResult = (result, caseId) => {
    return {

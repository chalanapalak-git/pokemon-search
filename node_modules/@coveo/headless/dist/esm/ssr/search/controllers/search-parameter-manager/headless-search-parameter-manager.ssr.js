import { buildSearchParameterManager, } from '../../../../controllers/search-parameter-manager/headless-search-parameter-manager.js';
 ...
 * */
export function defineSearchParameterManager() {
    return {

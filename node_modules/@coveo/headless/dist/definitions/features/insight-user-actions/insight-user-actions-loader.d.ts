...
import { type FetchUserActionsThunkReturn, type RegisterUserActionsPayload, type StateNeededByFetchUserActions } from './insight-user-actions-actions.js';
...
export interface InsightUserActionsActionCreators {
     ...
     */
    registerUserActions(payload: RegisterUserActionsPayload): PayloadAction<RegisterUserActionsPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    fetchUserActions(userId: string): AsyncThunkAction<FetchUserActionsThunkReturn, string, AsyncThunkInsightOptions<StateNeededByFetchUserActions>>;
}
/**
 ...
 * @category InsightUserActions
 */
export declare function loadInsightUserActionsActions(engine: CoreEngine): InsightUserActionsActionCreators;

...
import { type AddDictionaryFieldContextActionCreatorPayload } from './dictionary-field-context-actions.js';
...
export interface DictionaryFieldContextActionCreators {
     ...
     */
    addContext(payload: AddDictionaryFieldContextActionCreatorPayload): PayloadAction<AddDictionaryFieldContextActionCreatorPayload>;
    /**
 ...
 * @category DictionaryFieldContext
 */
export declare function loadDictionaryFieldContextActions(engine: CoreEngine): DictionaryFieldContextActionCreators;

...
import { type ToggleSelectLocationFacetValuePayload } from './location-facet-actions.js';
...
export interface LocationFacetActionCreators {
     ...
     */
    toggleSelectLocationFacetValue(payload: ToggleSelectLocationFacetValuePayload): PayloadAction<ToggleSelectLocationFacetValuePayload>;
}
/**
 ...
 */
export declare function loadLocationFacetActions(engine: CommerceEngine): LocationFacetActionCreators;

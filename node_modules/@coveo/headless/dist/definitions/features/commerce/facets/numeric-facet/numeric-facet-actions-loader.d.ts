...
export interface NumericFacetActionCreators {
     ...
     */
    toggleSelectNumericFacetValue(payload: ToggleSelectNumericFacetValuePayload): PayloadAction<ToggleSelectNumericFacetValuePayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    toggleExcludeNumericFacetValue(payload: ToggleExcludeNumericFacetValuePayload): PayloadAction<ToggleExcludeNumericFacetValuePayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateNumericFacetValues(payload: UpdateNumericFacetValuesPayload): PayloadAction<UpdateNumericFacetValuesPayload>;
}
/**
 ...
 * @category NumericFacet
 */
export declare function loadNumericFacetActions(engine: CommerceEngine): NumericFacetActionCreators;

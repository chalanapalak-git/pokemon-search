...
import { type ToggleExcludeFacetValuePayload, type ToggleSelectFacetValuePayload } from './regular-facet-actions.js';
...
export interface RegularFacetActionCreators {
     ...
     */
    toggleExcludeFacetValue(payload: ToggleExcludeFacetValuePayload): PayloadAction<ToggleExcludeFacetValuePayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    toggleSelectFacetValue(payload: ToggleSelectFacetValuePayload): PayloadAction<ToggleSelectFacetValuePayload>;
}
/**
 ...
 * @category RegularFacet
 */
export declare function loadRegularFacetActions(engine: CommerceEngine): RegularFacetActionCreators;

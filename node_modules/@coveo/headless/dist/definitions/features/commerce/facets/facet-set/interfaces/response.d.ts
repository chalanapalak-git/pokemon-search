...
export type CategoryFacetResponse = BaseFacetResponse<CategoryFacetValue, 'hierarchical'> & CategoryFacetDelimitingCharacter;
...
export type NumericFacetResponse = BaseFacetResponse<NumericFacetValue, 'numericalRange'> & NumericFacetExtraProperties;
...
export type AnyFacetValueResponse = RegularFacetValue | LocationFacetValue | NumericFacetValue | DateFacetValue | CategoryFacetValue;
type MappedFacetResponse = {
    [T in FacetType]: T extends 'numericalRange' ? NumericFacetResponse : T extends 'regular' ? RegularFacetResponse : T extends 'dateRange' ? DateFacetResponse : T extends 'hierarchical' ? CategoryFacetResponse : T extends 'location' ? LocationFacetResponse : never;
};

...
export interface RecommendationsActionCreator {
     ...
     * @returns A dispatchable action.
     */
    fetchMoreRecommendations(payload: FetchMoreRecommendationsPayload): AsyncThunkAction<QueryRecommendationsCommerceAPIThunkReturn | null, FetchMoreRecommendationsPayload, AsyncThunkCommerceOptions<StateNeededByFetchRecommendations>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    promoteChildToParent(payload: PromoteChildToParentPayload): PayloadAction<PromoteChildToParentPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    registerRecommendationsSlot(payload: RegisterRecommendationsSlotPayload): PayloadAction<RegisterRecommendationsSlotPayload>;
}
/**
 ...
 * @category Recommendations
 */
export declare function loadRecommendationsActions(engine: CommerceEngine): RecommendationsActionCreator;

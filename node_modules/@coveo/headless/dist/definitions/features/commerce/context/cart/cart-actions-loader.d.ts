...
import { type CartActionPayload, type PurchasePayload, type SetItemsPayload, type UpdateItemQuantityPayload } from './cart-actions.js';
...
export interface CartActionCreators {
     ...
     */
    emitPurchaseEvent(payload: PurchasePayload): AsyncThunkAction<void, PurchasePayload, AsyncThunkCommerceOptions<CommerceEngineState>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    emitCartActionEvent(payload: CartActionPayload): AsyncThunkAction<void, CartActionPayload, AsyncThunkCommerceOptions<CommerceEngineState>>;
    /**
 ...
 * @category Cart
 */
export declare function loadCartActions(engine: CommerceEngine): CartActionCreators;

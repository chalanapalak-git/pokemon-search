...
import { type RestoreSearchParametersPayload } from './search-parameters-actions.js';
...
export interface SearchParametersActionCreators {
     ...
     */
    restoreSearchParameters(payload: RestoreSearchParametersPayload): PayloadAction<RestoreSearchParametersPayload>;
}
/**
 ...
 * @category SearchParameters
 */
export declare function loadSearchParametersActions(engine: CommerceEngine): SearchParametersActionCreators;

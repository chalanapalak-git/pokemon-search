...
import { type FetchRedirectUrlPayload, type RegisterStandaloneSearchBoxPayload, type ResetStandaloneSearchBoxPayload } from './standalone-search-box-set-actions.js';
export type { FetchRedirectUrlPayload, RegisterStandaloneSearchBoxPayload, ResetStandaloneSearchBoxPayload, };
/**
...
export interface StandaloneSearchBoxSetActionCreators {
     ...
     */
    fetchRedirectUrl(payload: FetchRedirectUrlPayload): AsyncThunkAction<string, FetchRedirectUrlPayload, AsyncThunkCommerceOptions<StateNeededForPlanCommerceAPIRequest>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    registerStandaloneSearchBox(payload: RegisterStandaloneSearchBoxPayload): PayloadAction<RegisterStandaloneSearchBoxPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    resetStandaloneSearchBox(payload: ResetStandaloneSearchBoxPayload): PayloadAction<ResetStandaloneSearchBoxPayload>;
    /**
     * Updates the redirection URL of the standalone search box.
     * @param payload - The action creator payload.
     * @returns A dispatchable action.
     */
    updateStandaloneSearchBoxRedirectionUrl(payload: RegisterStandaloneSearchBoxPayload): PayloadAction<RegisterStandaloneSearchBoxPayload>;
}
/**
 ...
 * @category StandaloneSearchBoxSet
 */
export declare function loadStandaloneSearchBoxSetActions(engine: CommerceEngine): StandaloneSearchBoxSetActionCreators;

...
import { type UpdateAnalyticsConfigurationPayload, type UpdateBasicConfigurationPayload, type UpdateProxyBaseUrlPayload } from './configuration-actions.js';
...
export interface ConfigurationActionCreators {
     ...
     * @returns A dispatchable action.
     */
    updateAnalyticsConfiguration(payload: UpdateAnalyticsConfigurationPayload): PayloadAction<UpdateAnalyticsConfigurationPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateBasicConfiguration(payload: UpdateBasicConfigurationPayload): PayloadAction<UpdateBasicConfigurationPayload>;
    /**
 ...
 * @category Configuration
 */
export declare function loadConfigurationActions(engine: CommerceEngine): ConfigurationActionCreators;

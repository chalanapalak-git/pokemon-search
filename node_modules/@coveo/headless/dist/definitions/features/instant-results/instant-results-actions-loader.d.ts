...
export interface InstantResultsActionCreators {
     ...
     */
    registerInstantResults(payload: RegisterInstantResultActionCreatorPayload): PayloadAction<RegisterInstantResultActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateInstantResultsQuery(payload: UpdateInstantResultQueryActionCreatorPayload): PayloadAction<UpdateInstantResultQueryActionCreatorPayload>;
    /**
     * Updates the query expression to request instant results for the specified search box ID.
     *
     * @param payload - The action creator payload.
     * @returns A dispatchable action.
     */
    clearExpiredResults(payload: ClearExpiredInstantResultsActionCreatorPayload): PayloadAction<RegisterInstantResultActionCreatorPayload>;
}
/**
 ...
 * @category InsightResults
 */
export declare function loadInstantResultsActions(engine: SearchEngine): InstantResultsActionCreators;

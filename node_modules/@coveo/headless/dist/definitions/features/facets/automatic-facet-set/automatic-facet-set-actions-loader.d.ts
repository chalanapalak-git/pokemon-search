...
import { type ToggleSelectAutomaticFacetValueActionCreatorPayload } from './automatic-facet-set-actions.js';
/**
...
export interface AutomaticFacetsActionCreators {
     ...
     */
    setOptions(options: Partial<AutomaticFacetGeneratorOptions>): PayloadAction<Partial<AutomaticFacetGeneratorOptions>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    toggleSelectAutomaticFacetValue(payload: ToggleSelectAutomaticFacetValueActionCreatorPayload): PayloadAction<ToggleSelectAutomaticFacetValueActionCreatorPayload>;
}
/**
 ...
 * @category Automatic facets
 */
export declare function loadAutomaticFacetSetActions(engine: SearchEngine): AutomaticFacetsActionCreators;

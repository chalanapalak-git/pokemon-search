...
export interface SortCriteria<T extends 'score' | 'alphanumeric' | 'alphanumericDescending' | 'alphanumericNatural' | 'alphanumericNaturalDescending' | 'ascending' | 'descending' | 'occurrences' | 'automatic' | SpecificSortCriteriaExplicitAlphanumeric> {
...
export declare const facetResultsMustMatch: FacetResultsMustMatch[];

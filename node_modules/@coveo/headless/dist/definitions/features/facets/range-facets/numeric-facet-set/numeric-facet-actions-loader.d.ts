...
import { type RegisterNumericFacetActionCreatorPayload, type ToggleSelectNumericFacetValueActionCreatorPayload, type UpdateNumericFacetSortCriterionActionCreatorPayload, type UpdateNumericFacetValuesActionCreatorPayload } from './numeric-facet-actions.js';
...
export interface NumericFacetSetActionCreators {
     ...
     * @returns A dispatchable action.
     */
    toggleExcludeNumericFacetValue(payload: ToggleSelectNumericFacetValueActionCreatorPayload): PayloadAction<ToggleSelectNumericFacetValueActionCreatorPayload>;
    /**
 ...
 * @category NumericFacetSet
 */
export declare function loadNumericFacetSetActions(engine: CoreEngine): NumericFacetSetActionCreators;

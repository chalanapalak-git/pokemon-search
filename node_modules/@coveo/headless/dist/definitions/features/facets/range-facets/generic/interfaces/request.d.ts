...
export declare const rangeFacetSortCriteria: RangeFacetSortCriterion[];
/**
 ...
 */
export declare const rangeFacetRangeAlgorithm: RangeFacetRangeAlgorithm[];
...
export interface BaseRangeFacetRequest extends BaseFacetRequest, AutomaticRanges<boolean>, SortCriteria<RangeFacetSortCriterion>, RangeAlgorithm<RangeFacetRangeAlgorithm> {

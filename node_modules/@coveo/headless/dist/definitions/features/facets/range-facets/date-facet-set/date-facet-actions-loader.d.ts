...
import { type RegisterDateFacetActionCreatorPayload, type ToggleSelectDateFacetValueActionCreatorPayload, type UpdateDateFacetSortCriterionActionCreatorPayload, type UpdateDateFacetValuesActionCreatorPayload } from './date-facet-actions.js';
...
export interface DateFacetSetActionCreators {
     ...
     * @returns A dispatchable action.
     */
    toggleExcludeDateFacetValue(payload: ToggleSelectDateFacetValueActionCreatorPayload): PayloadAction<ToggleSelectDateFacetValueActionCreatorPayload>;
    /**
 ...
 * @category DateFacetSet
 */
export declare function loadDateFacetSetActions(engine: CoreEngine): DateFacetSetActionCreators;

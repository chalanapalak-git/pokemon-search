import type { AutomaticFacetSection, CategoryFacetSection, DateFacetSection, FacetSection, NumericFacetSection } from '../../../state/state-sections.js';
export type SectionNeededForFacetMetadata = FacetSection & CategoryFacetSection & DateFacetSection & NumericFacetSection & AutomaticFacetSection;
...
export declare const buildFacetStateMetadata: (state: SectionNeededForFacetMetadata) => import("coveo.analytics").FacetStateRequest[];

...
import { type FetchClassificationsThunkReturn, type SetCaseFieldActionCreatorPayload, type StateNeededByFetchClassifications } from './case-field-actions.js';
...
export interface CaseFieldActionCreators {
     ...
     */
    registerCaseField(payload: SetCaseFieldActionCreatorPayload): PayloadAction<SetCaseFieldActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateCaseField(payload: SetCaseFieldActionCreatorPayload): PayloadAction<SetCaseFieldActionCreatorPayload>;
    /**
 ...
 * @category CaseField
 */
export declare function loadCaseFieldActions(engine: CaseAssistEngine): CaseFieldActionCreators;

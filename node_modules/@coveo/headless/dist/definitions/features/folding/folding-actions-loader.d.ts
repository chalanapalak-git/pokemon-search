...
import { type LoadCollectionFulfilledReturn, type RegisterFoldingActionCreatorPayload, type StateNeededByLoadCollection } from './folding-actions.js';
...
export interface FoldingActionCreators {
     ...
     */
    registerFolding(payload: RegisterFoldingActionCreatorPayload): PayloadAction<RegisterFoldingActionCreatorPayload>;
    /**
 ...
 * @category Folding
 */
export declare function loadFoldingActions(engine: SearchEngine): FoldingActionCreators;

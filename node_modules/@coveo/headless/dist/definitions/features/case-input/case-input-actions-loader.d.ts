...
import { type SetCaseInputActionCreatorPayload } from './case-input-actions.js';
...
export interface CaseInputActionCreators {
     ...
     */
    updateCaseInput(payload: SetCaseInputActionCreatorPayload): PayloadAction<SetCaseInputActionCreatorPayload>;
}
/**
 ...
 * @category CaseInput
 */
export declare function loadCaseInputActions(engine: CaseAssistEngine): CaseInputActionCreators;

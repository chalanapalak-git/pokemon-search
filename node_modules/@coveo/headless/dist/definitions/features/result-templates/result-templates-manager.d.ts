...
import { type Template, type TemplateCondition } from '../templates/templates-manager.js';
 ...
 */
export declare function buildResultTemplatesManager<Content = unknown, LinkContent = unknown>(engine: CoreEngine | CoreEngineNext): ResultTemplatesManager<Content, LinkContent>;

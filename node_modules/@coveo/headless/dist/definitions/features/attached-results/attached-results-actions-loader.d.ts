...
import { type SetAttachedResultsActionCreatorPayload } from './attached-results-actions.js';
...
export interface AttachedResultsActionCreators {
     ...
     */
    setAttachedResults(payload: SetAttachedResultsActionCreatorPayload): PayloadAction<SetAttachedResultsActionCreatorPayload>;
    /**
 ...
 * @category AttachedResults
 */
export declare function loadAttachedResultsActions(engine: InsightEngine): AttachedResultsActionCreators;

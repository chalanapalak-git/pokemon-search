...
import type { LogFacetBreadcrumbActionCreatorPayload, LogFacetDeselectActionCreatorPayload, LogFacetExcludeActionCreatorPayload, LogFacetSelectActionCreatorPayload, LogFacetUnexcludeActionCreatorPayload } from '../facets/facet-set/facet-set-analytics-actions.js';
import { type LogFacetUpdateSortActionCreatorPayload } from '../facets/facet-set/facet-set-insight-analytics-actions.js';
...
import { type CreateArticleMetadata } from '../insight-search/insight-analytics-actions.js';
...
export interface InsightAnalyticsActionCreators {
     ...
     * @returns A dispatchable action.
     */
    logCategoryFacetBreadcrumb(payload: LogCategoryFacetBreadcrumbActionCreatorPayload): InsightAction;
    /**
 ...
 * @category Analytics
 */
export declare function loadInsightAnalyticsActions(engine: InsightEngine): InsightAnalyticsActionCreators;

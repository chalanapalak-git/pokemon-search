...
export declare const buildSearchAndFoldingLoadCollectionRequest: (state: StateNeededByExecuteSearchAndFolding, navigatorContext: NavigatorContext, eventDescription?: EventDescription) => SearchRequest;
export {};

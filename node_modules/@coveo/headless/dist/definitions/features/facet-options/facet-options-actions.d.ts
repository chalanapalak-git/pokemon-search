...
export declare const updateFacetOptions: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[payload?: UpdateFacetOptionsActionCreatorPayload | undefined], UpdateFacetOptionsActionCreatorPayload, "facetOptions/update", never, never>;

...
import { type AsyncThunkGlobalOptions, type FetchResultContentThunkReturn, type PreparePreviewPaginationActionPayload, type UpdateContentURLOptions, type UpdateContentURLThunkReturn } from './result-preview-actions.js';
...
export interface ResultPreviewActionCreators {
    ...
    preparePreviewPagination(payload: PreparePreviewPaginationActionPayload): PayloadAction<PreparePreviewPaginationActionPayload>;
}
/**
 ...
 * @category ResultPreview
 */
export declare function loadResultPreviewActions(engine: CoreEngine): ResultPreviewActionCreators;

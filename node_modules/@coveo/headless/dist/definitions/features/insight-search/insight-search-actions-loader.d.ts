...
import { type FetchQuerySuggestionsActionCreatorPayload, type FetchQuerySuggestionsThunkReturn, type RegisterQuerySuggestActionCreatorPayload } from '../query-suggest/query-suggest-actions.js';
import type { ExecuteSearchThunkReturn } from '../search/legacy/search-actions.js';
import { type StateNeededByExecuteSearch, type StateNeededByQuerySuggest } from './insight-search-actions.js';
 ...
 */
export declare function loadInsightSearchActions(engine: InsightEngine): InsightSearchActionCreators;

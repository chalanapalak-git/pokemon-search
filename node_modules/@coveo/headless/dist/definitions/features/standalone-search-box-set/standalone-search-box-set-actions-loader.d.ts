...
export interface StandaloneSearchBoxSetActionCreators {
     ...
     */
    registerStandaloneSearchBox(payload: RegisterStandaloneSearchBoxActionCreatorPayload): PayloadAction<RegisterStandaloneSearchBoxActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    resetStandaloneSearchBox(payload: ResetStandaloneSearchBoxActionCreatorPayload): PayloadAction<ResetStandaloneSearchBoxActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    fetchRedirectUrl(payload: FetchRedirectUrlActionCreatorPayload): AsyncThunkAction<string, FetchRedirectUrlActionCreatorPayload, AsyncThunkSearchOptions<StateNeededForRedirect>>;
    /**
     * Updates the redirection URL of the standalone search box.
     * @param payload - The action creator payload.
     * @returns A dispatchable action.
     */
    updateStandaloneSearchBoxRedirectionUrl(payload: RegisterStandaloneSearchBoxActionCreatorPayload): PayloadAction<RegisterStandaloneSearchBoxActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateAnalyticsToSearchFromLink(payload: UpdateAnalyticsToSearchFromLinkActionCreatorPayload): PayloadAction<UpdateAnalyticsToSearchFromLinkActionCreatorPayload>;
    /**
     ...
     * @returns A dispatchable action.
     */
    updateAnalyticsToOmniboxFromLink(payload: UpdateAnalyticsToOmniboxFromLinkActionCreatorPayload): PayloadAction<UpdateAnalyticsToOmniboxFromLinkActionCreatorPayload>;
}
/**
 ...
 * @category StandaloneSearchBoxSet
 */
export declare function loadStandaloneSearchBoxSetActions(engine: SearchEngine): StandaloneSearchBoxSetActionCreators;

...
export interface GetAnswerQuerySection {
    answer: CombinedState<{
        getAnswer: QueryDefinition<AnswerApiQueryParams, BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError, {} & RetryOptions, {}>, never, GeneratedAnswerStream, 'answer'>;
    }, never, 'answer'>;
}

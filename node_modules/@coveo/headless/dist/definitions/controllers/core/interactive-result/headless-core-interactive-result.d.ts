 ...
 */
export declare function buildInteractiveResultCore(engine: CoreEngine | CoreEngineNext, props: InteractiveResultCoreProps, action: () => void): InteractiveResultCore;

...
export interface InteractiveCitationOptions extends InteractiveResultCoreOptions {
    /**
 ...
 */
export declare function buildInteractiveCitationCore(engine: CoreEngine, analyticsClient: InteractiveCitationAnalyticsClient, props: InteractiveCitationProps): InteractiveCitation;
export {};

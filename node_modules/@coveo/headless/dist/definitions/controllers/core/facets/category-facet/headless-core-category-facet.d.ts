...
import { type CategoryFacetOptions, type CategoryFacetSearchOptions } from './headless-core-category-facet-options.js';
export type { CategoryFacetValueCommon, CategoryFacetValue, CategoryFacetOptions, CategoryFacetSearchOptions, };
 ...
 * @category CategoryFacet
 * */
export declare function buildCoreCategoryFacet(engine: CoreEngine, props: CategoryFacetProps): CoreCategoryFacet;

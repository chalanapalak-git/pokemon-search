...
import { type Subscribable } from '../../controller/headless-controller.js';
 ...
 * @category CategoryFieldSuggestions
 */
export declare function buildCategoryFieldSuggestions(engine: SearchEngine, props: CategoryFieldSuggestionsProps): CategoryFieldSuggestions;

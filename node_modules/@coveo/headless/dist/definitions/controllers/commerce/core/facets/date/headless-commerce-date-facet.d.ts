...
import { type CoreCommerceFacet, type CoreCommerceFacetOptions, type CoreCommerceFacetState, type DateFacetValue, type DateRangeRequest, type FacetControllerType } from '../headless-core-commerce-facet.js';
export type { DateFacetValue };
export type DateFacetOptions = Omit<CoreCommerceFacetOptions, 'toggleSelectActionCreator' | 'toggleExcludeActionCreator'>;
/**
 ...
 */
export declare function buildCommerceDateFacet(engine: CommerceEngine, options: DateFacetOptions): DateFacet;
export declare const getDateFacetState: (coreState: CoreCommerceFacetState<DateFacetValue>) => DateFacetState;

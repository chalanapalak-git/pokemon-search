...
export interface SearchAndListingSubControllers<P extends Parameters, S extends SummaryState> extends BaseSolutionTypeSubControllers<S> {
    /**
...
export interface SearchAndListingSubControllerProps<P extends Parameters, S extends SummaryState> extends BaseSubControllerProps<S> {
 ...
 */
export declare function buildSearchSubControllers(engine: CommerceEngine, subControllerProps: Omit<SearchAndListingSubControllerProps<CommerceSearchParameters, SearchSummaryState>, 'facetSearchType'>): SearchSubControllers;
/**
 ...
 */
export declare function buildSearchAndListingsSubControllers<P extends Parameters, S extends SummaryState>(engine: CommerceEngine, subControllerProps: SearchAndListingSubControllerProps<P, S>): SearchAndListingSubControllers<P, S>;
/**
 ...
 */
export declare function buildBaseSubControllers<S extends SummaryState>(engine: CommerceEngine, subControllerProps: BaseSubControllerProps<S>): BaseSolutionTypeSubControllers<S>;
export {};

...
import { type Context, type ContextProps, type ContextState } from '../core/context/headless-core-context.js';
export type { Context, ContextState, ContextPayload, ContextValue, ContextInitialState, ContextProps, };
/**
 ...
 * @category Context
 */
export declare function buildContext(engine: CoreEngine, props?: ContextProps): Context;

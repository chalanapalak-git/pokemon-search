...
export declare const defaultNodeJSNavigatorContextProvider: NavigatorContextProvider;
export declare const getNavigatorContext: (relay: Relay, customProvider?: NavigatorContextProvider) => NavigatorContext;

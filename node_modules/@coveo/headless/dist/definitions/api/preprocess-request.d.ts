...
export type PlatformClientOrigin = AnalyticsClientOrigin | 'searchApiFetch' | 'insightApiFetch' | 'caseAssistApiFetch' | 'commerceApiFetch';
 ...
 */
metadata?: RequestMetadata) => PlatformRequestOptions | Promise<PlatformRequestOptions>;

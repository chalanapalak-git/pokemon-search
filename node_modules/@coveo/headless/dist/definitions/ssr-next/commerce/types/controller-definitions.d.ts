...
import type { ListingAndStandaloneController, NonRecommendationController, RecommendationOnlyController, SearchAndListingController, SearchOnlyController, StandaloneController, UniversalController } from './controller-scopes.js';
...
export interface ControllerDefinitionWithProps<TController extends Controller, TProps> {
     ...
     * @returns The created controller instance.
     */
    buildWithProps(engine: SSRCommerceEngine, props?: TProps, solutionType?: SolutionType): TController;
}
...
export type ControllerDefinition<TController extends Controller> = SolutionTypeAvailability & (ControllerDefinitionWithoutProps<TController> | ControllerDefinitionWithProps<TController, unknown>);
 ...
 */
export type CommerceEngineDefinitionControllersPropsOption<TControllers extends ControllerDefinitionsMap<Controller>, TControllersPropsMap extends ControllersPropsMap, TSolutionType extends SolutionType> = RequiredEngineDefinitionControllersPropsOption<TControllers, TControllersPropsMap, TSolutionType>;
...
export type SearchAndListingControllerDefinitionWithProps<TController extends Controller, TProps> = ControllerDefinitionWithProps<TController, TProps> & SearchAndListingController;
export type StandaloneControllerWithProps<TController extends Controller, TProps> = ControllerDefinitionWithProps<TController, TProps> & StandaloneController;

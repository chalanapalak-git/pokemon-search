...
import { type Tab, type TabProps } from '../../../../controllers/tab/headless-tab.js';
...
export interface TabDefinition extends ControllerDefinitionWithoutProps<SearchEngine, Tab> {
}
/**
 ...
 * */
export declare function defineTab(props: TabProps): TabDefinition;

...
import { type DateFieldExpression } from './date-field/date-field.js';
import { type DateRangeFieldExpression } from './date-range-field/date-range-field.js';
import { type ExactMatchExpression } from './exact-match/exact-match.js';
import { type FieldExistsExpression } from './field-exists/field-exists.js';
import { type KeywordExpression } from './keyword/keyword.js';
import { type NearExpression, type OtherTerm } from './near/near.js';
import { type NumericFieldExpression } from './numeric-field/numeric-field.js';
import { type NumericRangeFieldExpression } from './numeric-range-field/numeric-range-field.js';

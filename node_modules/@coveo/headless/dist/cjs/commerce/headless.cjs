...
var commerce_index_exports = {};
__export(commerce_index_exports, {
  HighlightUtils: () => highlight_exports,
  ProductTemplatesHelpers: () => ProductTemplatesHelpers,
  ResultType: () => ResultType,
  Selectors: () => commerce_selectors_index_exports,
  SortBy: () => SortBy,
  SortDirection: () => SortDirection,
  VERSION: () => VERSION,
  buildCart: () => buildCart,
  buildCategoryFilterSuggestions: () => buildCategoryFilterSuggestions,
  buildCommerceEngine: () => buildCommerceEngine,
  buildContext: () => buildContext,
  buildController: () => buildController,
  buildDateRange: () => buildDateRange,
  buildFieldSuggestionsGenerator: () => buildFieldSuggestionsGenerator,
  buildFieldsSortCriterion: () => buildFieldsSortCriterion,
  buildFilterSuggestions: () => buildFilterSuggestions,
  buildFilterSuggestionsGenerator: () => buildFilterSuggestionsGenerator,
  buildInstantProducts: () => buildInstantProducts,
  buildNotifyTrigger: () => buildNotifyTrigger,
  buildProductEnrichment: () => buildProductEnrichment,
  buildProductListing: () => buildProductListing,
  buildProductTemplatesManager: () => buildProductTemplatesManager,
  buildProductView: () => buildProductView,
  buildQueryTrigger: () => buildQueryTrigger,
  buildRecentQueriesList: () => buildRecentQueriesList,
  buildRecommendations: () => buildRecommendations,
  buildRedirectionTrigger: () => buildRedirectionTrigger,
  buildRelevanceSortCriterion: () => buildRelevanceSortCriterion,
  buildSearch: () => buildSearch,
  buildSearchBox: () => buildSearchBox,
  buildStandaloneSearchBox: () => buildStandaloneSearchBox,
  ...
  loadLocationFacetActions: () => loadLocationFacetActions,
  ...
  loadSpotlightContentActions: () => loadSpotlightContentActions,
  loadStandaloneSearchBoxSetActions: () => loadStandaloneSearchBoxSetActions,
  loadTriggersActions: () => loadTriggersActions,
  productListingSerializer: () => productListingSerializer,
  searchSerializer: () => searchSerializer,
  validateRelativeDate: () => validateRelativeDate
});
module.exports = __toCommonJS(commerce_index_exports);

// src/selectors/commerce-selectors.index.ts
var commerce_selectors_index_exports = {};
__export(commerce_selectors_index_exports, {
...
var moreProductsAvailableSelector = (0, import_toolkit.createSelector)(
  (state) => ({
...
var isLoadingSelector = (state) => {
  ...
  return (0, import_bueno.isNullOrUndefined)(isLoading) ? false : isLoading;
};
...
var sortCriterionDefinition = new import_bueno2.RecordValue({
  options: {
    required: false
  },
  values: {
    by: new import_bueno2.EnumValue({ enum: SortBy, required: true }),
    fields: new import_bueno2.ArrayValue({
      each: new import_bueno2.RecordValue({
        values: {
          field: new import_bueno2.StringValue({ required: true }),
          direction: new import_bueno2.EnumValue({ enum: SortDirection }),
          displayName: new import_bueno2.StringValue()
        }
      })
    })
  }
...
var isLoadingSelector2 = (state) => {
  ...
  return (0, import_bueno3.isNullOrUndefined)(isLoading) ? false : isLoading;
};
...
var queryExecutedFromResponseSelector = (state, response) => {
  if (!(0, import_bueno3.isNullOrUndefined)(response.queryCorrection?.correctedQuery)) {
...
var Search;
((Search2) => {
  Search2.responseIdSelector = wrapWithAccessFromEngine(
    responseIdSelector2
  );
})(Search || (Search = {}));
var ProductListing;
((ProductListing2) => {
  ProductListing2.responseIdSelector = wrapWithAccessFromEngine(
    responseIdSelector
  );
})(ProductListing || (ProductListing = {}));
...
function highlightString(params) {
  ...
  if ((0, import_bueno4.isNullOrUndefined)(params.content) || isEmptyString(params.content)) {
...
var requiredNonEmptyString = new import_bueno5.StringValue({
  required: true,
  emptyAllowed: false
});
var nonEmptyString = new import_bueno5.StringValue({
  required: false,
  emptyAllowed: false
});
var requiredEmptyAllowedString = new import_bueno5.StringValue({
  required: true,
  emptyAllowed: true
});
var nonRequiredEmptyAllowedString = new import_bueno5.StringValue({
  required: false,
  emptyAllowed: true
});
var nonEmptyStringArray = new import_bueno5.ArrayValue({
  each: requiredNonEmptyString,
  required: true
});
var optionalNonEmptyVersionString = new import_bueno5.StringValue({
  required: false,
  emptyAllowed: false,
  regex: /^\d+\.\d+\.\d+$/
});
var optionalTrackingId = new import_bueno5.StringValue({
  required: false,
  emptyAllowed: false,
  regex: /^[a-zA-Z0-9_\-.]{1,100}$/
});
var requiredTrackingId = new import_bueno5.StringValue({
  required: true,
  emptyAllowed: false,
  regex: /^[a-zA-Z0-9_\-.]{1,100}$/
});
...
var validatePayloadAndThrow = (payload, definition3) => {
  ...
  if (isSchemaValue) {
    return {
      payload: new import_bueno5.Schema({
        value: definition3
      }).validate({ value: payload }).value
    };
  }
  const asRecordValue = new import_bueno5.RecordValue({
    options: { required: true },
    values: definition3
  });
  const isInvalid = asRecordValue.validate(payload);
  if (isInvalid) {
    throw new import_bueno5.SchemaValidationError(isInvalid);
  }
  return { payload };
};
...
// src/features/commerce/configuration/configuration-actions.ts
var updateBasicConfiguration2 = (0, import_toolkit4.createAction)(
  "commerce/configuration/updateBasicConfiguration",
  (payload) => validatePayload(payload, {
    accessToken: nonEmptyString,
    environment: new import_bueno7.StringValue({
      required: false,
      constrainTo: ["prod", "hipaa", "stg", "dev"]
    }),
    organizationId: nonEmptyString
...
var updateProxyBaseUrl = (0, import_toolkit4.createAction)(
  "commerce/configuration/updateProxyBaseUrl",
  (payload) => validatePayload(payload, {
    proxyBaseUrl: new import_bueno7.StringValue({ required: false, url: true })
  })
);
var updateAnalyticsConfiguration2 = (0, import_toolkit4.createAction)(
...
var disableAnalytics2 = (0, import_toolkit4.createAction)(
  "commerce/configuration/analytics/disable"
);
var enableAnalytics2 = (0, import_toolkit4.createAction)(
...
// src/features/commerce/configuration/configuration-slice.ts
var configurationReducer = (0, import_toolkit5.createReducer)(
...
var itemsSelector = (0, import_toolkit6.createSelector)(
  (cartState) => cartState.cart,
  (cartState) => cartState.cartItems,
  (cart, cartItems) => cartItems.map((key) => cart[key])
);
var productQuantitySelector = (0, import_toolkit6.createSelector)(
  itemsSelector,
...
var itemPayloadDefinition = {
  ...
  quantity: new import_bueno9.NumberValue({
    required: true,
    min: 0
  }),
  name: new import_bueno9.StringValue({ required: false }),
  price: new import_bueno9.NumberValue({ required: false, min: 0 })
};
var setItemsPayloadDefinition = new import_bueno9.ArrayValue({
  each: new import_bueno9.RecordValue({
    values: {
...
var cartSchema = new import_bueno9.Schema(cartDefinition);

// src/features/commerce/context/cart/cart-actions.ts
var setItems = (0, import_toolkit7.createAction)(
  "commerce/cart/setItems",
  (payload) => validatePayload(payload, setItemsPayloadDefinition)
);
var updateItemQuantity = (0, import_toolkit7.createAction)(
  "commerce/cart/updateItemQuantity",
  (payload) => validatePayload(payload, itemPayloadDefinition)
);
var purchase = (0, import_toolkit7.createAction)("commerce/cart/purchase");
var emitPurchaseEvent = (0, import_toolkit7.createAsyncThunk)(
...
var emitCartActionEvent = (0, import_toolkit7.createAsyncThunk)(
...
var totalQuantitySelector = (0, import_toolkit8.createSelector)(
  itemsSelector,
  (items) => items.reduce((prev, cur) => prev + cur.quantity, 0)
);
var totalPriceSelector = (0, import_toolkit8.createSelector)(
  itemsSelector,
...
// src/features/commerce/context/cart/cart-slice.ts
var cartReducer = (0, import_toolkit9.createReducer)(
  getCartInitialState(),
  (builder) => {
...
var currencyDefinition = new import_bueno10.StringValue({
  required: true,
  emptyAllowed: false,
...
var locationDefinition = {
  latitude: new import_bueno10.NumberValue({ min: -90, max: 90, required: true }),
  longitude: new import_bueno10.NumberValue({ min: -180, max: 180, required: true })
};
var customDefinition = {
  custom: new import_bueno10.RecordValue({
    options: { required: false }
  })
};
var contextDefinition = {
  ...
  view: new import_bueno10.RecordValue({
    options: { required: true },
    values: viewDefinition
  }),
  location: new import_bueno10.RecordValue({
    options: { required: false },
...
var contextSchema = new import_bueno10.Schema(contextDefinition);

// src/features/commerce/context/context-actions.ts
var setContext = (0, import_toolkit10.createAction)(
  "commerce/context/set",
  (payload) => validatePayload(payload, contextDefinition)
);
var setView = (0, import_toolkit10.createAction)(
  "commerce/context/setView",
  (payload) => validatePayload(payload, viewDefinition)
);
var setLocation = (0, import_toolkit10.createAction)(
  "commerce/context/setLocation",
  (payload) => validatePayload(payload, locationDefinition)
);
var setCustom = (0, import_toolkit10.createAction)(
...
// src/features/commerce/context/context-slice.ts
var contextReducer = (0, import_toolkit11.createReducer)(
...
var getAnalyticsSource = (0, import_toolkit12.createSelector)(
  (state) => state.source,
...
var updateCoreFacetNumberOfValues = (0, import_toolkit13.createAction)(
  "commerce/facets/core/updateNumberOfValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    numberOfValues: new import_bueno11.NumberValue({ required: true, min: 1 })
  })
);
var updateCoreFacetIsFieldExpanded = (0, import_toolkit13.createAction)(
  "commerce/facets/core/updateIsFieldExpanded",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    isFieldExpanded: new import_bueno11.BooleanValue({ required: true })
  })
);
var clearAllCoreFacets = (0, import_toolkit13.createAction)("commerce/facets/core/clearAll");
var deleteAllCoreFacets = (0, import_toolkit13.createAction)(
  "commerce/facets/core/deleteAll"
);
var deselectAllValuesInCoreFacet = (0, import_toolkit13.createAction)(
  "commerce/facets/core/deselectAllValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString
  })
);
var updateCoreFacetFreezeCurrentValues = (0, import_toolkit13.createAction)(
  "commerce/facets/core/updateFreezeCurrentValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    freezeCurrentValues: new import_bueno11.BooleanValue({ required: true })
  })
);
var updateAutoSelectionForAllCoreFacets = (0, import_toolkit13.createAction)(
  "commerce/facets/core/updateAutoSelectionForAll",
  (payload) => validatePayload(payload, {
    allow: new import_bueno11.BooleanValue({ required: true })
  })
);
...
var setPageSizeDefinition = {
  ...slotIdDefinition,
  pageSize: new import_bueno12.NumberValue({ required: true, min: 0 })
};
var setPageSize = (0, import_toolkit14.createAction)(
  "commerce/pagination/setPageSize",
  (payload) => validatePayload(payload, setPageSizeDefinition)
);
var selectPageDefinition = {
  ...slotIdDefinition,
  page: new import_bueno12.NumberValue({ required: true, min: 0 })
};
var selectPage = (0, import_toolkit14.createAction)(
  "commerce/pagination/selectPage",
  (payload) => validatePayload(payload, selectPageDefinition)
);
var nextPage = (0, import_toolkit14.createAction)(
  "commerce/pagination/nextPage",
  (payload) => validatePayload(payload, slotIdDefinition)
);
var previousPage = (0, import_toolkit14.createAction)(
  "commerce/pagination/previousPage",
  (payload) => validatePayload(payload, slotIdDefinition)
);
var registerRecommendationsSlotPagination = (0, import_toolkit14.createAction)(
...
var updateQuery = (0, import_toolkit15.createAction)(
  ...
  (payload) => validatePayload(payload, {
    query: new import_bueno13.StringValue()
  })
);
...
var updateIgnoreQueryTrigger = (0, import_toolkit16.createAction)(
  "commerce/triggers/query/updateIgnore",
  (payload) => validatePayload(payload, {
    q: new import_bueno14.StringValue({ emptyAllowed: true, required: true })
  })
);
var applyQueryTriggerModification = (0, import_toolkit16.createAction)(
  "commerce/triggers/query/applyModification",
  (payload) => validatePayload(
    payload,
    new import_bueno14.RecordValue({
...
var AsyncSearchThunkProcessor = class {
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteQueryCorrection = !(0, import_bueno15.isNullOrUndefined)(queryCorrection) && !(0, import_bueno15.isNullOrUndefined)(queryCorrection.correctedQuery);
...
// src/features/commerce/search/search-actions.ts
var executeSearch = (0, import_toolkit17.createAsyncThunk)("commerce/search/executeSearch", async (payload = {}, config) => {
...
var fetchMoreProducts = (0, import_toolkit17.createAsyncThunk)("commerce/search/fetchMoreProducts", async (payload = {}, config) => {
  const { getState } = config;
  const state = getState();
  const { navigatorContext } = config.extra;
...
var prepareForSearchWithQuery = (0, import_toolkit17.createAsyncThunk)("commerce/search/prepareForSearchWithQuery", (payload, thunk) => {
  const { dispatch } = thunk;
  validatePayload(payload, {
    query: new import_bueno16.StringValue(),
    clearFilters: new import_bueno16.BooleanValue()
  });
...
var fetchInstantProducts = (0, import_toolkit17.createAsyncThunk)(
...
var promoteChildToParentDefinition = {
  child: new import_bueno16.RecordValue({
    options: { required: true },
    values: {
      permanentid: new import_bueno16.StringValue({ required: true })
    }
  })
};
var promoteChildToParent = (0, import_toolkit17.createAction)(
...
// src/features/commerce/did-you-mean/did-you-mean-slice.ts
var didYouMeanReducer = (0, import_toolkit18.createReducer)(
...
var facetSearchOptionsDefinition = {
  ...
  captions: new import_bueno17.RecordValue({ options: { required: false } }),
  numberOfValues: new import_bueno17.NumberValue({ required: false, min: 1 }),
  query: new import_bueno17.StringValue({ required: false, emptyAllowed: true })
};

// src/features/facets/facet-search-set/category/category-facet-search-actions.ts
var categoryFacetSearchResultDefinition = {
  path: new import_bueno18.ArrayValue({
    required: true,
    each: requiredNonEmptyString
  }),
  displayValue: requiredEmptyAllowedString,
  rawValue: requiredEmptyAllowedString,
  count: new import_bueno18.NumberValue({ required: true, min: 0 })
};
var selectCategoryFacetSearchResult = (0, import_toolkit19.createAction)(
  "categoryFacet/selectSearchResult",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    value: new import_bueno18.RecordValue({ values: categoryFacetSearchResultDefinition })
  })
);
var registerCategoryFacetSearch = (0, import_toolkit19.createAction)(
...
var selectFacetSearchResultPayloadDefinition = {
  facetId: facetIdDefinition,
  value: new import_bueno19.RecordValue({
    values: {
      displayValue: requiredEmptyAllowedString,
      rawValue: requiredEmptyAllowedString,
      count: new import_bueno19.NumberValue({ required: true, min: 0 })
    }
  })
};
var registerFacetSearch = (0, import_toolkit20.createAction)(
  "facetSearch/register",
  (payload) => validatePayload(payload, facetSearchOptionsDefinition)
);
var updateFacetSearch = (0, import_toolkit20.createAction)(
  "facetSearch/update",
  (payload) => validatePayload(payload, facetSearchOptionsDefinition)
);
var selectFacetSearchResult = (0, import_toolkit20.createAction)(
  "facetSearch/toggleSelectValue",
  (payload) => validatePayload(payload, selectFacetSearchResultPayloadDefinition)
);
var excludeFacetSearchResult = (0, import_toolkit20.createAction)(
...
var deselectAllBreadcrumbs = (0, import_toolkit21.createAction)("breadcrumb/deselectAll");
var deselectAllNonBreadcrumbs = (0, import_toolkit21.createAction)(
...
var updateFacetOptions = (0, import_toolkit22.createAction)(
  "facetOptions/update",
  (payload = { freezeFacetOrder: true }) => validatePayload(payload, {
    freezeFacetOrder: new import_bueno20.BooleanValue({ required: false })
  })
);
var enableFacet = (0, import_toolkit22.createAction)(
  "facetOptions/facet/enable",
  (payload) => validatePayload(payload, facetIdDefinition)
);
var disableFacet = (0, import_toolkit22.createAction)(
...
var undo = (0, import_toolkit23.createAction)("history/undo");
var redo = (0, import_toolkit23.createAction)("history/redo");
var snapshot = (0, import_toolkit23.createAction)("history/snapshot");
var back = (0, import_toolkit23.createAsyncThunk)("history/back", async (_, { dispatch }) => {
  dispatch(undo());
  await dispatch(change());
});
var forward = (0, import_toolkit23.createAsyncThunk)(
  "history/forward",
  async (_, { dispatch }) => {
    dispatch(redo());
    await dispatch(change());
...
var change = (0, import_toolkit23.createAsyncThunk)(
  "history/change",
  async (_, { getState }) => {
    const s = getState();
...
var history_store_default = HistoryStore;
...
// src/api/analytics/analytics-relay-client.ts
var getRelayInstanceFromState = (0, import_toolkit24.createSelector)(
...
function hasCookieStorage2() {
  return hasNavigator2() && navigator.cookieEnabled;
}
...
var addDefaultValues = (eventType, payload) => {
  return eventTypesForDefaultValues.indexOf(eventType) !== -1 ? Object.assign({ language: hasDocument() ? document.documentElement.lang : "unknown", userAgent: hasNavigator2() ? navigator.userAgent : "unknown" }, payload) : payload;
};
...
var CookieStorage2 = class _CookieStorage2 {
  getItem(key) {
    return Cookie2.get(`${_CookieStorage2.prefix}${key}`);
  }
  removeItem(key) {
    Cookie2.erase(`${_CookieStorage2.prefix}${key}`);
  }
  setItem(key, data, expire) {
    Cookie2.set(`${_CookieStorage2.prefix}${key}`, data, expire);
  }
};
CookieStorage2.prefix = "coveo_";
var CookieAndLocalStorage = class {
  constructor() {
    this.cookieStorage = new CookieStorage2();
  }
  getItem(key) {
...
var HistoryStore2 = class {
  ...
  getHistoryWithInternalTimeAsync() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const elements = yield this.store.getItem(STORE_KEY2);
        if (elements) {
          return JSON.parse(elements);
        } else {
          return [];
  ...
  setHistory(history) {
    try {
      this.store.setItem(STORE_KEY2, JSON.stringify(history.slice(0, MAX_NUMBER_OF_HISTORY_ELEMENTS2)));
    } catch (e) {
    }
  }
  clear() {
...
var NodeJSRuntime = class {
  constructor(clientOptions, storage) {
    this.storage = storage || new NullStorage2();
    this.client = new AnalyticsFetchClient(clientOptions);
  }
  getClientDependingOnEventType(eventType) {
    return this.client;
...
var isGeneratedAnswerFeatureEnabledWithAnswerAPI = (state) => "answer" in state && "generatedAnswer" in state && !(0, import_bueno21.isNullOrUndefined)(state.generatedAnswer?.answerConfigurationId);
...
var citationSourceSelector = (0, import_toolkit25.createSelector)(
...
var buildCriterionExpression = (criterion) => {
  if ((0, import_bueno22.isArray)(criterion)) {
...
var criterionDefinition = new import_bueno22.RecordValue({
  values: {
    by: new import_bueno22.EnumValue({ enum: SortBy2, required: true }),
    order: new import_bueno22.EnumValue({ enum: SortOrder }),
    field: new import_bueno22.StringValue()
  }
});
...
function makePreparableAnalyticsAction(prefix, buildEvent) {
  const createAnalyticsAction = (body) => makeInstantlyCallable(
    (0, import_toolkit26.createAsyncThunk)(prefix, body)
  );
...
var rawPartialDefinition = {
  urihash: new import_bueno23.StringValue(),
  sourcetype: new import_bueno23.StringValue(),
  permanentid: new import_bueno23.StringValue()
};
var resultPartialDefinition = {
  uniqueId: requiredNonEmptyString,
  raw: new import_bueno23.RecordValue({ values: rawPartialDefinition }),
  title: requiredNonEmptyString,
  uri: requiredNonEmptyString,
  clickUri: requiredNonEmptyString,
  rankingModifier: new import_bueno23.StringValue({ required: false, emptyAllowed: true })
};
...
var updateFacetAutoSelection = (0, import_toolkit27.createAction)(
  "facet/updateFacetAutoSelection",
  (payload) => validatePayload(payload, {
    allow: new import_bueno24.BooleanValue({ required: true })
  })
);
...
var registerInstantResults = (0, import_toolkit28.createAction)(
  "instantResults/register",
  (payload) => validatePayload(payload, instantResultsRegisterDefinition)
);
var updateInstantResultsQuery = (0, import_toolkit28.createAction)(
  "instantResults/updateQuery",
  (payload) => validatePayload(payload, instantResultsQueryDefinition)
);
var clearExpiredResults = (0, import_toolkit28.createAction)(
...
var numberValue = new import_bueno25.NumberValue({ required: true, min: 0 });
var registerNumberOfResults = (0, import_toolkit29.createAction)(
  "pagination/registerNumberOfResults",
  (payload) => validatePayload(payload, numberValue)
);
var updateNumberOfResults = (0, import_toolkit29.createAction)(
  "pagination/updateNumberOfResults",
  (payload) => validatePayload(payload, numberValue)
);
var registerPage = (0, import_toolkit29.createAction)(
  "pagination/registerPage",
  (payload) => validatePayload(payload, numberValue)
);
var updatePage = (0, import_toolkit29.createAction)(
  "pagination/updatePage",
  (payload) => validatePayload(payload, numberValue)
);
var nextPage2 = (0, import_toolkit29.createAction)("pagination/nextPage");
var previousPage2 = (0, import_toolkit29.createAction)("pagination/previousPage");

// src/features/query/query-actions.ts
var import_bueno26 = require("@coveo/bueno");
var import_toolkit30 = require("@reduxjs/toolkit");
var updateQuery2 = (0, import_toolkit30.createAction)(
  "query/updateQuery",
  (payload) => validatePayload(payload, {
    q: new import_bueno26.StringValue(),
    enableQuerySyntax: new import_bueno26.BooleanValue()
  })
);
...
var buildSearchAndFoldingLoadCollectionRequest = (state, navigatorContext, eventDescription) => {
  return {
    ...
    ...state.excerptLength && !(0, import_bueno27.isNullOrUndefined)(state.excerptLength.length) && {
...
var buildSearchAndFoldingLoadCollectionRequest2 = async (state, eventDescription) => {
  return {
    ...
    ...state.excerptLength && !(0, import_bueno28.isNullOrUndefined)(state.excerptLength.length) && {
      excerptLength: state.excerptLength.length
    },
    ...state.configuration.search.authenticationProviders.length && {
      authentication: state.configuration.search.authenticationProviders.join(",")
...
var buildRelativeDateDefinition = (period) => {
  ...
  return {
    amount: new import_bueno29.NumberValue({ required: !isNow, min: 1 }),
    unit: new import_bueno29.StringValue({
      required: !isNow,
      constrainTo: validRelativeDateUnits
    }),
    period: new import_bueno29.StringValue({
      required: true,
...
function validateRelativeDate(date) {
  ...
  new import_bueno29.Schema(buildRelativeDateDefinition(relativeDate.period)).validate(
    relativeDate
  );
...
var enableDidYouMean = (0, import_toolkit31.createAction)("didYouMean/enable");
var disableDidYouMean = (0, import_toolkit31.createAction)("didYouMean/disable");
var disableAutomaticQueryCorrection = (0, import_toolkit31.createAction)(
  "didYouMean/automaticCorrections/disable"
);
var enableAutomaticQueryCorrection = (0, import_toolkit31.createAction)(
  "didYouMean/automaticCorrections/enable"
);
var applyDidYouMeanCorrection = (0, import_toolkit31.createAction)(
  "didYouMean/correction",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setCorrectionMode = (0, import_toolkit31.createAction)(
  "didYouMean/automaticCorrections/mode",
  (payload) => validatePayload(
    payload,
    new import_bueno31.StringValue({
...
var logUndoTriggerQueryPayloadDefinition = new import_bueno32.RecordValue({
  values: {
...
var updateIgnoreQueryTrigger2 = (0, import_toolkit32.createAction)(
  "trigger/query/ignore",
  (q) => validatePayload(q, new import_bueno33.StringValue({ emptyAllowed: true, required: true }))
);
var applyQueryTriggerModification2 = (0, import_toolkit32.createAction)(
  "trigger/query/modification",
  (payload) => validatePayload(
    payload,
    new import_bueno33.RecordValue({
      values: { originalQuery: nonEmptyString, modification: nonEmptyString }
    })
  )
);
...
var AsyncSearchThunkProcessor2 = class {
  constructor(config, onUpdateQueryForCorrection = (modification) => {
    this.dispatch(updateQuery2({ q: modification }));
  }) {
    this.config = config;
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteModernDidYouMeanAutoCorrection = !(0, import_bueno34.isNullOrUndefined)(queryCorrection) && !(0, import_bueno34.isNullOrUndefined)(queryCorrection.correctedQuery);
  ...
  async processQueryTriggersOrContinue(fetched) {
    ...
    const ignored = this.getState().triggers?.queryModification.queryToIgnore;
    if (ignored === correctedQuery) {
      this.dispatch(updateIgnoreQueryTrigger2(""));
      return null;
    }
...
// src/features/search/legacy/search-actions.ts
var executeSearch2 = (0, import_toolkit33.createAsyncThunk)("search/executeSearch", async (searchAction, config) => {
  const state = config.getState();
  return await legacyExecuteSearch(state, config, searchAction);
});
var fetchPage = (0, import_toolkit33.createAsyncThunk)("search/fetchPage", async (searchAction, config) => {
  const state = config.getState();
  return await legacyFetchPage(state, config, searchAction);
});
var fetchMoreResults = (0, import_toolkit33.createAsyncThunk)("search/fetchMoreResults", async (_, config) => {
  const state = config.getState();
  return await legacyFetchMoreResults(config, state);
});
var fetchFacetValues = (0, import_toolkit33.createAsyncThunk)(
...
var fetchInstantResults = (0, import_toolkit33.createAsyncThunk)(
...
async function legacyFetchInstantResults(payload, config) {
  validatePayload(payload, {
    ...
    maxResultsPerQuery: new import_bueno35.NumberValue({
      required: true,
      min: 1
    }),
    cacheTimeout: new import_bueno35.NumberValue()
  });
  const { q, maxResultsPerQuery } = payload;
  const state = config.getState();
  const processor = new AsyncSearchThunkProcessor2({ ...config, analyticsAction: logInstantResultsSearch() }, (modification) => {
    config.dispatch(
...
async function legacyFetchFacetValues(config, searchAction, state) {
  ...
  const processor = new AsyncSearchThunkProcessor2({ ...config, analyticsAction: searchAction });
...
var selectStaticFilterExpressions = (0, import_toolkit34.createSelector)(
...
var AsyncSearchThunkProcessor3 = class {
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteClassicDidYouMeanAutoCorrection = results.length === 0 && queryCorrections && queryCorrections.length !== 0;
    const shouldExecuteModernDidYouMeanAutoCorrection = !(0, import_bueno36.isNullOrUndefined)(queryCorrection) && !(0, import_bueno36.isNullOrUndefined)(queryCorrection.correctedQuery);
    const shouldExitWithNoAutoCorrection = !shouldExecuteClassicDidYouMeanAutoCorrection && !shouldExecuteModernDidYouMeanAutoCorrection;
    if (shouldExitWithNoAutoCorrection) {
      return null;
    }
...
// src/features/search/search-actions.ts
var prepareForSearchWithQuery2 = (0, import_toolkit35.createAsyncThunk)("search/prepareForSearchWithQuery", (payload, thunk) => {
  const { dispatch } = thunk;
  validatePayload(payload, {
    q: new import_bueno37.StringValue(),
    enableQuerySyntax: new import_bueno37.BooleanValue(),
    clearFilters: new import_bueno37.BooleanValue()
  });
  if (payload.clearFilters) {
  ...
  dispatch(
    updateQuery2({ q: payload.q, enableQuerySyntax: payload.enableQuerySyntax })
  );
  dispatch(updatePage(1));
});
var updateSearchAction = (0, import_toolkit35.createAction)(
  "search/updateSearchAction"
);
var executeSearch3 = (0, import_toolkit35.createAsyncThunk)(
  ...
  async (searchAction, config) => {
    ...
    const processor = new AsyncSearchThunkProcessor3({ ...config, analyticsAction: analyticsAction ?? {} });
    const fetched = await processor.fetchFromAPI(request, {
      origin: "mainSearch"
    });
    return await processor.process(fetched);
...
var fetchPage2 = (0, import_toolkit35.createAsyncThunk)("search/fetchPage", async (searchAction, config) => {
  const state = config.getState();
  addEntryInActionsHistory2(state);
  ...
  const processor = new AsyncSearchThunkProcessor3({
    ...config,
...
var fetchMoreResults2 = (0, import_toolkit35.createAsyncThunk)("search/fetchMoreResults", async (_, config) => {
  const state = config.getState();
  if (state.configuration.analytics.analyticsMode === "legacy") {
...
var fetchFacetValues2 = (0, import_toolkit35.createAsyncThunk)(
  "search/fetchFacetValues",
  async (searchAction, config) => {
    const state = config.getState();
    if (state.configuration.analytics.analyticsMode === "legacy") {
    ...
    const processor = new AsyncSearchThunkProcessor3({ ...config, analyticsAction: {} });
...
var fetchInstantResults2 = (0, import_toolkit35.createAsyncThunk)(
  "search/fetchInstantResults",
  async (payload, config) => {
    const state = config.getState();
    if (state.configuration.analytics.analyticsMode === "legacy") {
    ...
    validatePayload(payload, {
      id: requiredNonEmptyString,
      q: requiredNonEmptyString,
      maxResultsPerQuery: new import_bueno37.NumberValue({
        required: true,
        min: 1
      }),
      cacheTimeout: new import_bueno37.NumberValue()
    });
    const { q, maxResultsPerQuery } = payload;
    ...
    const processor = new AsyncSearchThunkProcessor3({ ...config, analyticsAction }, (modification) => {
      config.dispatch(
        updateInstantResultsQuery({ q: modification, id: payload.id })
      );
    });
...
var searchParametersDefinition = {
  q: new import_bueno38.StringValue(),
  enableQuerySyntax: new import_bueno38.BooleanValue(),
  aq: new import_bueno38.StringValue(),
  cq: new import_bueno38.StringValue(),
  firstResult: new import_bueno38.NumberValue({ min: 0 }),
  numberOfResults: new import_bueno38.NumberValue({ min: 0 }),
  sortCriteria: new import_bueno38.StringValue(),
  f: new import_bueno38.RecordValue(),
  fExcluded: new import_bueno38.RecordValue(),
  cf: new import_bueno38.RecordValue(),
  nf: new import_bueno38.RecordValue(),
  mnf: new import_bueno38.RecordValue(),
  df: new import_bueno38.RecordValue(),
  debug: new import_bueno38.BooleanValue(),
  sf: new import_bueno38.RecordValue(),
  tab: new import_bueno38.StringValue(),
  af: new import_bueno38.RecordValue()
};

// src/features/search-parameters/search-parameter-actions.ts
var restoreSearchParameters = (0, import_toolkit36.createAction)(
  "searchParameters/restore",
  (payload) => validatePayload(payload, searchParametersDefinition)
);
var restoreTab = (0, import_toolkit36.createAction)(
...
var facetId = new import_bueno39.StringValue({
  regex: /^[a-zA-Z0-9-_]+$/
});
var field = new import_bueno39.StringValue({ required: true });
var basePath = new import_bueno39.ArrayValue({
  each: new import_bueno39.StringValue()
});
var delimitingCharacter = new import_bueno39.StringValue();
var filterByBasePath = new import_bueno39.BooleanValue();
var filterFacetCount = new import_bueno39.BooleanValue();
var injectionDepth = new import_bueno39.NumberValue({ min: 0 });
var numberOfValues = new import_bueno39.NumberValue({ min: 1 });
var generateAutomaticRanges = new import_bueno39.BooleanValue({
  required: true
});
var captions = new import_bueno39.RecordValue();
var query = new import_bueno39.StringValue();
var facetSearchOptionDefinitions = {
  captions,
  numberOfValues,
  query
};
var facetSearch = new import_bueno39.RecordValue({
  values: facetSearchOptionDefinitions
});
var allowedValues = new import_bueno39.RecordValue({
  options: { required: false },
  values: {
    type: new import_bueno39.StringValue({
      constrainTo: ["simple"],
      emptyAllowed: false,
      required: true
    }),
    values: new import_bueno39.ArrayValue({
      required: true,
      max: 25,
      each: new import_bueno39.StringValue({ emptyAllowed: false, required: true })
    })
  }
});
var hasBreadcrumbs = new import_bueno39.BooleanValue();
var customSort = new import_bueno39.ArrayValue({
  min: 1,
  max: 25,
  required: false,
  each: new import_bueno39.StringValue({ emptyAllowed: false, required: true })
...
var facetValueDefinition = {
  ...
  numberOfResults: new import_bueno40.NumberValue({ min: 0 }),
...
var registerFacet = (0, import_toolkit37.createAction)(
  "facet/register",
  (payload) => validatePayload(payload, facetRegistrationOptionsDefinition)
);
var toggleSelectFacetValue = (0, import_toolkit37.createAction)(
...
var toggleExcludeFacetValue = (0, import_toolkit37.createAction)(
...
var deselectAllFacetValues = (0, import_toolkit37.createAction)(
  "facet/deselectAll",
  (payload) => validatePayload(payload, facetIdDefinition)
);
var updateFacetSortCriterion = (0, import_toolkit37.createAction)(
...
var updateFacetNumberOfValues = (0, import_toolkit37.createAction)(
...
var updateFacetIsFieldExpanded = (0, import_toolkit37.createAction)(
...
var updateFreezeCurrentValues = (0, import_toolkit37.createAction)(
...
// src/features/facets/facet-set/facet-set-slice.ts
var facetSetReducer = (0, import_toolkit38.createReducer)(
...
var updateRangeFacetSortCriterion = (0, import_toolkit39.createAction)(
  "rangeFacet/updateSortCriterion",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    criterion: new import_bueno42.Value({ required: true })
  })
);
...
var numericFacetValueDefinition = {
  state: requiredNonEmptyString,
  start: new import_bueno43.NumberValue({ required: true }),
  end: new import_bueno43.NumberValue({ required: true }),
  endInclusive: new import_bueno43.BooleanValue({ required: true }),
  numberOfResults: new import_bueno43.NumberValue({ required: true, min: 0 })
};
...
var rangeFacetSelectionPayloadDefinition = (selection) => ({
  facetId: facetIdDefinition,
  selection: typeof selection.start === "string" ? new import_bueno43.RecordValue({ values: dateFacetValueDefinition }) : new import_bueno43.RecordValue({ values: numericFacetValueDefinition })
});
...
var dateRangeRequestDefinition = {
  ...
  endInclusive: new import_bueno44.BooleanValue({ required: true }),
  state: requiredNonEmptyString
};
var dateFacetRegistrationOptionsDefinition = {
  facetId: facetIdDefinition,
  field: requiredNonEmptyString,
  tabs: new import_bueno44.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno44.ArrayValue({ each: new import_bueno44.StringValue() }),
      excluded: new import_bueno44.ArrayValue({ each: new import_bueno44.StringValue() })
    }
  }),
  activeTab: new import_bueno44.StringValue({ required: false }),
  currentValues: new import_bueno44.ArrayValue({
    required: false,
    each: new import_bueno44.RecordValue({ values: dateRangeRequestDefinition })
  }),
  generateAutomaticRanges: new import_bueno44.BooleanValue({ required: true }),
  filterFacetCount: new import_bueno44.BooleanValue({ required: false }),
  injectionDepth: new import_bueno44.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno44.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno44.Value({ required: false }),
  rangeAlgorithm: new import_bueno44.Value({ required: false })
};
...
var registerDateFacet = (0, import_toolkit40.createAction)(
  "dateFacet/register",
  (payload) => {
    try {
...
var toggleSelectDateFacetValue = (0, import_toolkit40.createAction)(
  "dateFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno44.RecordValue({ values: dateFacetValueDefinition })
  })
);
var toggleExcludeDateFacetValue = (0, import_toolkit40.createAction)(
...
var updateDateFacetValues = (0, import_toolkit40.createAction)(
  "dateFacet/updateFacetValues",
  (payload) => {
    try {
      validatePayloadAndThrow(payload, {
        facetId: facetIdDefinition,
        values: new import_bueno44.ArrayValue({
          each: new import_bueno44.RecordValue({ values: dateFacetValueDefinition })
        })
      });
...
// src/features/facets/range-facets/date-facet-set/date-facet-set-slice.ts
var dateFacetSetReducer = (0, import_toolkit41.createReducer)(
...
var numericFacetRegistrationOptionsDefinition = {
  facetId: facetIdDefinition,
  field: requiredNonEmptyString,
  tabs: new import_bueno45.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno45.ArrayValue({ each: new import_bueno45.StringValue() }),
      excluded: new import_bueno45.ArrayValue({ each: new import_bueno45.StringValue() })
    }
  }),
  activeTab: new import_bueno45.StringValue({ required: false }),
  currentValues: new import_bueno45.ArrayValue({
    required: false,
    each: new import_bueno45.RecordValue({ values: numericFacetRequestDefinition })
  }),
  generateAutomaticRanges: new import_bueno45.BooleanValue({ required: true }),
  filterFacetCount: new import_bueno45.BooleanValue({ required: false }),
  injectionDepth: new import_bueno45.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno45.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno45.Value({ required: false }),
  rangeAlgorithm: new import_bueno45.Value({ required: false })
};
...
var registerNumericFacet = (0, import_toolkit42.createAction)(
...
var toggleSelectNumericFacetValue = (0, import_toolkit42.createAction)(
  "numericFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno45.RecordValue({ values: numericFacetValueDefinition })
  })
);
var toggleExcludeNumericFacetValue = (0, import_toolkit42.createAction)(
...
var updateNumericFacetValues = (0, import_toolkit42.createAction)(
  "numericFacet/updateFacetValues",
  (payload) => {
    try {
      validatePayloadAndThrow(payload, {
        facetId: facetIdDefinition,
        values: new import_bueno45.ArrayValue({
          each: new import_bueno45.RecordValue({ values: numericFacetValueDefinition })
        })
      });
...
// src/features/facets/range-facets/numeric-facet-set/numeric-facet-set-slice.ts
var numericFacetSetReducer = (0, import_toolkit43.createReducer)(
...
var fetchProductListing = (0, import_toolkit44.createAsyncThunk)(
...
var fetchMoreProducts2 = (0, import_toolkit44.createAsyncThunk)(
...
var promoteChildToParent2 = (0, import_toolkit44.createAction)(
...
var parametersDefinition = {
  f: new import_bueno47.RecordValue(),
  fExcluded: new import_bueno47.RecordValue(),
  lf: new import_bueno47.RecordValue(),
  cf: new import_bueno47.RecordValue(),
  nf: new import_bueno47.RecordValue(),
  nfExcluded: new import_bueno47.RecordValue(),
  mnf: new import_bueno47.RecordValue(),
  mnfExcluded: new import_bueno47.RecordValue(),
  df: new import_bueno47.RecordValue(),
  dfExcluded: new import_bueno47.RecordValue(),
  sortCriteria: new import_bueno47.RecordValue(),
  page: new import_bueno47.NumberValue({ min: 0 }),
  perPage: new import_bueno47.NumberValue({ min: 1 })
};

// src/features/commerce/product-listing-parameters/product-listing-parameters-actions.ts
var restoreProductListingParameters = (0, import_toolkit45.createAction)(
...
// src/features/commerce/query-suggest/query-suggest-actions.ts
var clearQuerySuggest = (0, import_toolkit46.createAction)(
  "commerce/querySuggest/clear",
  (payload) => validatePayload(payload, { id: requiredNonEmptyString })
);
var fetchQuerySuggestions = (0, import_toolkit46.createAsyncThunk)(
...
var registerQuerySuggest = (0, import_toolkit46.createAction)(
  "commerce/querySuggest/register",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString,
    count: new import_bueno48.NumberValue({ min: 0 })
  })
);
var selectQuerySuggestion = (0, import_toolkit46.createAction)(
...
var searchParametersDefinition2 = {
  q: new import_bueno49.StringValue(),
  ...parametersDefinition
};

// src/features/commerce/search-parameters/search-parameters-actions.ts
var restoreSearchParameters2 = (0, import_toolkit47.createAction)(
...
var categoryFacetValueDefinition = {
  state: new import_bueno50.Value({ required: true }),
  numberOfResults: new import_bueno50.NumberValue({ required: true, min: 0 }),
  value: new import_bueno50.StringValue({ required: true, emptyAllowed: true }),
  path: new import_bueno50.ArrayValue({ required: true, each: requiredNonEmptyString }),
  moreValuesAvailable: new import_bueno50.BooleanValue({ required: false })
};
...
// src/features/commerce/facets/category-facet/category-facet-actions.ts
var updateCategoryFacetNumberOfValues = (0, import_toolkit48.createAction)(
  "commerce/facets/categoryFacet/updateNumberOfValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    numberOfValues: new import_bueno51.NumberValue({ required: false, min: 1 })
  })
);
var toggleSelectCategoryFacetValue = (0, import_toolkit48.createAction)(
...
var toggleSelectDateFacetValue2 = (0, import_toolkit49.createAction)(
  "commerce/facets/dateFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    selection: new import_bueno52.RecordValue({ values: dateFacetValueDefinition })
  })
);
var toggleExcludeDateFacetValue2 = (0, import_toolkit49.createAction)(
...
var updateDateFacetValues2 = (0, import_toolkit49.createAction)(
  "commerce/facets/dateFacet/updateValues",
  (payload) => {
    try {
      validatePayloadAndThrow(payload, {
        facetId: requiredNonEmptyString,
        values: new import_bueno52.ArrayValue({
          each: new import_bueno52.RecordValue({ values: dateFacetValueDefinition })
        })
      });
      validateManualDateRanges({ currentValues: payload.values });
      return { payload, error: null };
...
var executeCommerceFacetSearch = (0, import_toolkit50.createAsyncThunk)(
  "commerce/facetSearch/executeSearch",
  getExecuteFacetSearchThunkPayloadCreator(false)
);
var executeCommerceFieldSuggest = (0, import_toolkit50.createAsyncThunk)(
...
var toggleSelectLocationFacetValue = (0, import_toolkit51.createAction)(
  "commerce/facets/locationFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    selection: new import_bueno53.RecordValue({ values: facetValueDefinition })
  })
);
...
var toggleSelectNumericFacetValue2 = (0, import_toolkit52.createAction)(
  "commerce/facets/numericFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    selection: new import_bueno54.RecordValue({
      values: numericFacetValueDefinition2
    })
  })
);
var toggleExcludeNumericFacetValue2 = (0, import_toolkit52.createAction)(
...
var updateNumericFacetValues2 = (0, import_toolkit52.createAction)(
    ...
    try {
      validatePayloadAndThrow(payload, {
        ...
        values: new import_bueno54.ArrayValue({
          each: new import_bueno54.RecordValue({ values: numericFacetValueDefinition2 })
        })
      });
      validateManualNumericRanges({ currentValues: payload.values });
      return { payload, error: null };
...
var updateManualNumericFacetRange = (0, import_toolkit52.createAction)(
...
var numericFacetValueDefinition2 = {
  state: new import_bueno54.StringValue({
    required: true,
    constrainTo: ["idle", "selected", "excluded"]
  }),
  start: new import_bueno54.NumberValue({ required: true }),
  end: new import_bueno54.NumberValue({ required: true }),
  endInclusive: new import_bueno54.BooleanValue({ required: true })
};
...
var toggleExcludeFacetValue2 = (0, import_toolkit53.createAction)(
  "commerce/facets/regularFacet/toggleExcludeValue",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    selection: new import_bueno55.RecordValue({ values: facetValueDefinition })
  })
);
var toggleSelectFacetValue2 = (0, import_toolkit53.createAction)(
...
// src/features/commerce/facets/facet-set/facet-set-slice.ts
var commerceFacetSetReducer = (0, import_toolkit54.createReducer)(
  getCommerceFacetSetInitialState(),
  (builder) => {
    builder.addCase(fetchProductListing.fulfilled, handleQueryFulfilled).addCase(executeSearch.fulfilled, handleQueryFulfilled).addCase(
...
// src/features/commerce/facets/field-suggestions-order/field-suggestions-order-slice.ts
var fieldSuggestionsOrderReducer = (0, import_toolkit55.createReducer)(
...
// src/features/commerce/facets/numeric-facet/manual-numeric-facet-slice.ts
var manualNumericFacetReducer = (0, import_toolkit56.createReducer)(
...
var recommendationsSlotDefinition = {
  slotId: requiredNonEmptyString,
  productId: new import_bueno56.StringValue({ required: false, emptyAllowed: false })
};
var recommendationsOptionsSchema = new import_bueno56.Schema(
...
var moreRecommendationsAvailableSelector = (0, import_toolkit57.createSelector)(
  (state, slotId) => ({
...
var isLoadingSelector3 = (state, slotId) => {
  ...
  return (0, import_bueno57.isNullOrUndefined)(isLoading) ? false : isLoading;
};
...
var fetchRecommendations = (0, import_toolkit58.createAsyncThunk)(
...
var fetchMoreRecommendations = (0, import_toolkit58.createAsyncThunk)(
...
var registerRecommendationsSlot = (0, import_toolkit58.createAction)(
...
var promoteChildToParentDefinition3 = {
  child: new import_bueno58.RecordValue({
    options: { required: true },
    values: {
      permanentid: new import_bueno58.StringValue({ required: true })
    }
  }),
  ...recommendationsSlotDefinition
};
var promoteChildToParent3 = (0, import_toolkit58.createAction)(
...
var applySort = (0, import_toolkit59.createAction)(
  "commerce/sort/apply",
  (payload) => validatePayload(payload, {
    by: new import_bueno59.EnumValue({
      enum: SortBy,
      required: true
    })
  })
...
// src/features/commerce/pagination/pagination-slice.ts
var paginationReducer = (0, import_toolkit60.createReducer)(
...
var setError = (0, import_toolkit61.createAction)("app/setError");
...
// src/features/commerce/product-listing/product-listing-slice.ts
var productListingReducer = (0, import_toolkit62.createReducer)(
...
var queryReducer = (0, import_toolkit63.createReducer)(
...
// src/features/commerce/recommendations/recommendations-slice.ts
var recommendationsReducer = (0, import_toolkit64.createReducer)(
  ...
  (builder) => {
    builder.addCase(registerRecommendationsSlot, (state, action) => {
      ...
      handleFulfilled2(state, slotId, response);
      ...
      Object.keys(state).forEach((slotId) => {
        handleError2(state, slotId, action.payload);
      });
    });
  }
);
...
function handleFulfilled2(state, slotId, response) {
  const recommendations = state[slotId];
  if (!recommendations) {
    return;
  }
...
function getPaginationOffset2(actionPayload) {
...
// src/features/commerce/search/search-slice.ts
var commerceSearchReducer = (0, import_toolkit65.createReducer)(
...
function handleFulfilled3(state, response, query2) {
  state.error = null;
  state.facets = response.facets;
  state.responseId = response.responseId;
  state.isLoading = false;
...
function getPaginationOffset3(payload) {
  const pagination = payload.response.pagination;
  return pagination.page * pagination.perPage;
}
...
function preprocessResult2(result, position, responseId) {
  ...
  return preprocessProduct3(result, position, responseId);
}
...
// src/features/commerce/triggers/triggers-slice.ts
var commerceTriggersReducer = (0, import_toolkit67.createReducer)(
  getTriggerInitialState(),
  (builder) => builder.addCase(executeSearch.pending, handleFetchItemsPending).addCase(
...
var versionReducer = (0, import_toolkit68.createReducer)(VERSION, (builder) => builder);

// src/features/facets/facet-order/facet-order-slice.ts
var import_toolkit69 = require("@reduxjs/toolkit");
var facetOrderReducer = (0, import_toolkit69.createReducer)(
  getFacetOrderInitialState(),
  (builder) => {
    builder.addCase(executeSearch3.fulfilled, handleQueryFulfilled2).addCase(fetchProductListing.fulfilled, handleQueryFulfilled2).addCase(executeSearch.fulfilled, handleQueryFulfilled2).addCase(restoreSearchParameters2, handleRestoreParameters3).addCase(restoreProductListingParameters, handleRestoreParameters3).addCase(change.fulfilled, (state, action) => {
...
function handleRestoreParameters3(_, action) {
  return [
...
var categoryFacetSearchSetReducer = (0, import_toolkit71.createReducer)(
  ...
  (builder) => {
    builder.addCase(registerCategoryFacetSearch, (state, action) => {
      ...
      executeSearch.fulfilled,
      (state) => handleFacetSearchSetClear(state, buildEmptyResponse)
    ).addCase(executeSearch3.fulfilled, (state) => {
...
// src/features/facets/facet-search-set/specific/specific-facet-search-set-slice.ts
var specificFacetSearchSetReducer = (0, import_toolkit72.createReducer)(
...
// src/features/generated-answer/answer-api-selectors.ts
var selectAnswerTriggerParams = (0, import_toolkit73.createSelector)(
...
var selectAnswerApiQueryParams = (0, import_toolkit73.createSelector)(
...
// src/features/follow-up-answers/follow-up-answers-actions.ts
var stringValue = new import_bueno60.StringValue({ required: true });
var setIsEnabled = (0, import_toolkit74.createAction)(
  "followUpAnswers/setIsEnabled",
  (payload) => validatePayload(payload, new import_bueno60.BooleanValue({ required: true }))
);
var setFollowUpAnswersConversationId = (0, import_toolkit74.createAction)(
  "followUpAnswers/setFollowUpAnswersConversationId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var createFollowUpAnswer = (0, import_toolkit74.createAction)(
  "followUpAnswers/createFollowUpAnswer",
  (payload) => validatePayload(payload, {
    question: requiredNonEmptyString
  })
);
var setActiveFollowUpAnswerId = (0, import_toolkit74.createAction)(
  "followUpAnswers/setActiveFollowUpAnswerId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setFollowUpAnswerContentFormat = (0, import_toolkit74.createAction)(
...
var setFollowUpIsLoading = (0, import_toolkit74.createAction)(
  "followUpAnswers/setFollowUpIsLoading",
  (payload) => validatePayload(payload, {
    isLoading: new import_bueno60.BooleanValue({ required: true }),
    answerId: requiredNonEmptyString
  })
);
var followUpMessageChunkReceived = (0, import_toolkit74.createAction)(
...
var followUpCitationsReceived = (0, import_toolkit74.createAction)(
  "followUpAnswers/followUpCitationsReceived",
  (payload) => validatePayload(payload, {
    citations: new import_bueno60.ArrayValue({
      required: true,
      each: new import_bueno60.RecordValue({
...
var followUpCompleted = (0, import_toolkit74.createAction)(
  "followUpAnswers/followUpCompleted",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString,
    cannotAnswer: new import_bueno60.BooleanValue({ required: false })
  })
);
var followUpFailed = (0, import_toolkit74.createAction)(
  "followUpAnswers/followUpFailed",
  (payload) => validatePayload(payload, {
    message: new import_bueno60.StringValue(),
    code: new import_bueno60.NumberValue({ min: 0 }),
    answerId: requiredNonEmptyString
  })
);
var likeFollowUp = (0, import_toolkit74.createAction)(
  "followUpAnswers/likeFollowUp",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var dislikeFollowUp = (0, import_toolkit74.createAction)(
  "followUpAnswers/dislikeFollowUp",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var submitFollowUpFeedback = (0, import_toolkit74.createAction)(
  "followUpAnswers/submitFollowUpFeedback",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var resetFollowUpAnswers = (0, import_toolkit74.createAction)(
  "followUpAnswers/resetFollowUpAnswers"
);
var generateFollowUpAnswer = (0, import_toolkit74.createAsyncThunk)(
...
var selectAdvancedSearchQueries = (0, import_toolkit75.createSelector)(
...
// src/features/search/search-selectors.ts
var selectSearchActionCause = (0, import_toolkit76.createSelector)(
  (state) => state.search,
  (state) => {
...
var selectActiveTab = (0, import_toolkit77.createSelector)(
  (state) => state,
  (tabSetState) => {
    if (!tabSetState) {
      return "";
...
var selectActiveTabExpression = (0, import_toolkit77.createSelector)(
  (state) => state,
  (tabSetState) => {
...
var getGeneratedFacetParams = (state) => getFacets3(state)?.map(
...
// src/features/generated-answer/generated-answer-actions.ts
var stringValue2 = new import_bueno62.StringValue({ required: true });
var optionalStringValue = new import_bueno62.StringValue();
var booleanValue = new import_bueno62.BooleanValue({ required: true });
var citationSchema = {
  id: stringValue2,
  title: stringValue2,
  uri: stringValue2,
...
var answerContentFormatSchema = new import_bueno62.StringValue({
  required: true,
  constrainTo: generatedContentFormat
});
var setIsVisible = (0, import_toolkit78.createAction)(
  "generatedAnswer/setIsVisible",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerId2 = (0, import_toolkit78.createAction)(
  "generatedAnswer/setAnswerId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setAnswerGenerationMode = (0, import_toolkit78.createAction)(
  "generatedAnswer/setAnswerGenerationMode",
  (payload) => validatePayload(
    payload,
    new import_bueno62.StringValue({
...
var setIsEnabled2 = (0, import_toolkit78.createAction)(
  "generatedAnswer/setIsEnabled",
  (payload) => validatePayload(payload, booleanValue)
);
var updateMessage = (0, import_toolkit78.createAction)(
  "generatedAnswer/updateMessage",
  (payload) => validatePayload(payload, {
    textDelta: stringValue2
  })
);
var updateCitations = (0, import_toolkit78.createAction)(
  "generatedAnswer/updateCitations",
  (payload) => validatePayload(payload, {
    citations: new import_bueno62.ArrayValue({
      required: true,
      each: new import_bueno62.RecordValue({
        values: citationSchema
      })
    })
  })
);
var updateError = (0, import_toolkit78.createAction)(
  "generatedAnswer/updateError",
  (payload) => validatePayload(payload, {
    message: optionalStringValue,
    code: new import_bueno62.NumberValue({ min: 0 })
  })
);
var resetAnswer = (0, import_toolkit78.createAction)("generatedAnswer/resetAnswer");
var likeGeneratedAnswer = (0, import_toolkit78.createAction)("generatedAnswer/like");
var dislikeGeneratedAnswer = (0, import_toolkit78.createAction)("generatedAnswer/dislike");
var openGeneratedAnswerFeedbackModal = (0, import_toolkit78.createAction)(
  "generatedAnswer/feedbackModal/open"
);
var expandGeneratedAnswer = (0, import_toolkit78.createAction)("generatedAnswer/expand");
var collapseGeneratedAnswer = (0, import_toolkit78.createAction)("generatedAnswer/collapse");
var setId = (0, import_toolkit78.createAction)(
  "generatedAnswer/setId",
  (payload) => validatePayload(payload, {
    id: new import_bueno62.StringValue({
      required: true
    })
  })
);
var closeGeneratedAnswerFeedbackModal = (0, import_toolkit78.createAction)(
  "generatedAnswer/feedbackModal/close"
);
var sendGeneratedAnswerFeedback = (0, import_toolkit78.createAction)(
  "generatedAnswer/sendFeedback"
);
var setIsLoading = (0, import_toolkit78.createAction)(
  "generatedAnswer/setIsLoading",
  (payload) => validatePayload(payload, booleanValue)
);
var setIsStreaming = (0, import_toolkit78.createAction)(
  "generatedAnswer/setIsStreaming",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerContentFormat = (0, import_toolkit78.createAction)(
  "generatedAnswer/setAnswerContentFormat",
  (payload) => validatePayload(payload, answerContentFormatSchema)
);
var updateResponseFormat = (0, import_toolkit78.createAction)(
  "generatedAnswer/updateResponseFormat",
  (payload) => validatePayload(payload, {
    contentFormat: new import_bueno62.ArrayValue({
      each: answerContentFormatSchema,
      default: ["text/plain"]
    })
  })
);
var updateAnswerConfigurationId = (0, import_toolkit78.createAction)(
  "knowledge/updateAnswerConfigurationId",
  (payload) => validatePayload(payload, stringValue2)
);
var registerFieldsToIncludeInCitations = (0, import_toolkit78.createAction)(
  "generatedAnswer/registerFieldsToIncludeInCitations",
  (payload) => validatePayload(payload, nonEmptyStringArray)
);
var setIsAnswerGenerated = (0, import_toolkit78.createAction)(
  "generatedAnswer/setIsAnswerGenerated",
  (payload) => validatePayload(payload, booleanValue)
);
var setCannotAnswer = (0, import_toolkit78.createAction)(
  "generatedAnswer/setCannotAnswer",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerApiQueryParams = (0, import_toolkit78.createAction)(
  "generatedAnswer/setAnswerApiQueryParams",
  (payload) => validatePayload(payload, new import_bueno62.RecordValue({}))
);
var streamAnswer = (0, import_toolkit78.createAsyncThunk)("generatedAnswer/streamAnswer", async (params, config) => {
  const state = config.getState();
...
var generateAnswer = (0, import_toolkit78.createAsyncThunk)(
...
var generateHeadAnswer = (0, import_toolkit78.createAsyncThunk)(
...
var handleError4 = (draft, message) => {
  const errorMessage = message.errorMessage || "Unknown error occurred";
  draft.error = {
    message: errorMessage,
    code: message.code
...
function isAnalyticsAction(action) {
  ...
  return isActionWithType(action) && !(0, import_bueno63.isNullOrUndefined)(analytics);
}
...
var registerTab = (0, import_toolkit79.createAction)(
  "tab/register",
  (payload) => {
    const schema = new import_bueno64.RecordValue({
      values: {
        id: requiredNonEmptyString,
        expression: requiredEmptyAllowedString
      }
...
var updateActiveTab = (0, import_toolkit79.createAction)(
  "tab/updateActiveTab",
  (id2) => {
...
// src/features/configuration/configuration-slice.ts
var configurationReducer2 = (0, import_toolkit80.createReducer)(
  ...
  (builder) => builder.addCase(updateBasicConfiguration, (state, action) => {
    ...
    if (!(0, import_bueno65.isNullOrUndefined)(action.payload.tab)) {
...
function handleUpdateBasicConfiguration2(state, payload) {
  if (!(0, import_bueno65.isNullOrUndefined)(payload.accessToken)) {
    state.accessToken = payload.accessToken;
  }
  state.environment = payload.environment ?? "prod";
  if (!(0, import_bueno65.isNullOrUndefined)(payload.organizationId)) {
    state.organizationId = payload.organizationId;
  }
}
function handleUpdateSearchConfiguration(state, payload) {
  if (!(0, import_bueno65.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.search.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.locale)) {
    state.search.locale = payload.locale;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.timezone)) {
    state.search.timezone = payload.timezone;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.authenticationProviders)) {
    state.search.authenticationProviders = payload.authenticationProviders;
  }
}
function handleUpdateAnalyticsConfiguration(state, payload) {
  if (!(0, import_bueno65.isNullOrUndefined)(payload.enabled)) {
    state.analytics.enabled = payload.enabled;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.originContext)) {
    state.analytics.originContext = payload.originContext;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.originLevel2)) {
    state.analytics.originLevel2 = payload.originLevel2;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.originLevel3)) {
    state.analytics.originLevel3 = payload.originLevel3;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.analytics.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.trackingId)) {
    state.analytics.trackingId = payload.trackingId;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.analyticsMode)) {
    state.analytics.analyticsMode = payload.analyticsMode;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.source)) {
    state.analytics.source = payload.source;
  }
  try {
  ...
  if (!(0, import_bueno65.isNullOrUndefined)(payload.runtimeEnvironment)) {
    state.analytics.runtimeEnvironment = payload.runtimeEnvironment;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.anonymous)) {
    state.analytics.anonymous = payload.anonymous;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.deviceId)) {
    state.analytics.deviceId = payload.deviceId;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.userDisplayName)) {
    state.analytics.userDisplayName = payload.userDisplayName;
  }
  if (!(0, import_bueno65.isNullOrUndefined)(payload.documentLocation)) {
    state.analytics.documentLocation = payload.documentLocation;
  }
}

// src/app/common-reducers.ts
var configuration = configurationReducer2;
...
var generateAnswerListener = (0, import_toolkit81.createListenerMiddleware)();
generateAnswerListener.startListening({
  actionCreator: executeSearch3.pending,
...
function createReducerManager(initialReducers, preloadedState) {
  ...
  return {
    get combinedReducer() {
      ...
      return rootReducer(
        (0, import_toolkit82.combineReducers)({ ...placeholderReducers, ...reducers })
      );
    },
...
function configureStore({
  ...
  return (0, import_toolkit83.configureStore)({
    reducer,
    preloadedState,
    devTools: {
...
var engineConfigurationDefinitions = {
  ...
  name: new import_bueno66.StringValue({
    required: false,
    emptyAllowed: false
  }),
  analytics: new import_bueno66.RecordValue({
    options: {
      required: false
    },
    values: {
      enabled: new import_bueno66.BooleanValue({
        required: false
      }),
      originContext: new import_bueno66.StringValue({
        required: false
      }),
      originLevel2: new import_bueno66.StringValue({
        required: false
      }),
      originLevel3: new import_bueno66.StringValue({
        required: false
      }),
      analyticsMode: new import_bueno66.StringValue({
        constrainTo: ["legacy", "next"],
        required: false,
        default: "next"
      }),
      proxyBaseUrl: new import_bueno66.StringValue({
        required: false,
        url: true
      }),
      trackingId: new import_bueno66.StringValue({
        required: false,
        emptyAllowed: false,
        regex: /^[a-zA-Z0-9_\-.]{1,100}$/
      })
  ...
  environment: new import_bueno66.StringValue({
    required: false,
    default: "prod",
    constrainTo: ["prod", "hipaa", "stg", "dev"]
  })
...
// src/app/commerce-engine/commerce-engine-configuration.ts
var commerceEngineConfigurationSchema = new import_bueno67.Schema({
  ...engineConfigurationDefinitions,
  analytics: new import_bueno67.RecordValue({
    options: { required: true },
    values: {
      enabled: new import_bueno67.BooleanValue({ required: false, default: true }),
      proxyBaseUrl: new import_bueno67.StringValue({ required: false, url: true }),
      source: new import_bueno67.RecordValue({
        options: { required: false },
        values: {
      ...
      trackingId: new import_bueno67.StringValue({
        required: true,
        emptyAllowed: false,
        regex: /^[a-zA-Z0-9_\-.]{1,100}$/
      })
  ...
  context: new import_bueno67.RecordValue({
    options: { required: true },
    values: contextDefinition
  }),
  cart: new import_bueno67.RecordValue({
...
function loadConfigurationActions(engine) {
  engine.addReducers({ configuration: configurationReducer2 });
  return {
...
// src/features/commerce/facets/location-facet/location-facet-actions-loader.ts
function loadLocationFacetActions(engine) {
  engine.addReducers({ commerceFacetSet: commerceFacetSetReducer });
  return {
...
var clearExpiredProducts = (0, import_toolkit84.createAction)(
...
var promoteChildToParentDefinition4 = {
  child: new import_bueno68.RecordValue({
    options: { required: true },
    values: {
      permanentid: new import_bueno68.StringValue({ required: true })
    }
  }),
  ...instantProductsQueryDefinition
};
var promoteChildToParent4 = (0, import_toolkit84.createAction)(
  "commerce/instantProducts/promoteChildToParent",
  (payload) => validatePayload(payload, promoteChildToParentDefinition4)
);
var registerInstantProducts = (0, import_toolkit84.createAction)(
  "commerce/instantProducts/register",
  (payload) => validatePayload(payload, instantProductsIdDefinition)
);
var updateInstantProductsQuery = (0, import_toolkit84.createAction)(
...
// src/features/commerce/instant-products/instant-products-slice.ts
var instantProductsReducer = (0, import_toolkit85.createReducer)(
...
var productView = (0, import_toolkit86.createAsyncThunk)("commerce/product/view", async (payload, { extra, getState }) => {
  const { relay } = extra;
...
var productClick = (0, import_toolkit86.createAsyncThunk)(
...
var productEnrichmentDefinition = {
  placementIds: new import_bueno69.ArrayValue({
    required: false,
    min: 1,
    each: requiredNonEmptyString
  }),
...
var productEnrichmentOptionsSchema = new import_bueno69.Schema(productEnrichmentDefinition);

// src/features/commerce/product-enrichment/product-enrichment-actions.ts
var registerProductEnrichmentOptions = (0, import_toolkit87.createAction)(
...
var fetchBadges = (0, import_toolkit87.createAsyncThunk)(
...
// src/features/commerce/product-enrichment/product-enrichment-slice.ts
var productEnrichmentReducer = (0, import_toolkit88.createReducer)(
  ...
  (builder) => {
    builder.addCase(registerProductEnrichmentOptions, (state, action) => {
      ...
      handleFulfilled4(state);
      state.products = action.payload.response.products;
    }).addCase(fetchBadges.rejected, (state, action) => {
      handleError5(state, action.payload);
    });
  }
);
function handleError5(state, error) {
  state.error = error || null;
  state.isLoading = false;
  state.products = [];
}
function handleFulfilled4(state) {
  state.error = null;
  state.isLoading = false;
}
...
var registerQuerySetQuery = (0, import_toolkit89.createAction)(
  "querySet/register",
  (payload) => validatePayload(payload, querySetDefinition)
);
var updateQuerySetQuery = (0, import_toolkit89.createAction)(
  "querySet/update",
  (payload) => validatePayload(payload, querySetDefinition)
);

// src/features/commerce/query-set/query-set-actions.ts
var registerQuerySetQuery2 = (0, import_toolkit90.createAction)(
  "commerce/querySet/register",
  (payload) => validatePayload(payload, querySetDefinition)
);
var updateQuerySetQuery2 = (0, import_toolkit90.createAction)(
...
var registerQuerySuggest2 = (0, import_toolkit91.createAction)(
  "querySuggest/register",
  (payload) => validatePayload(payload, {
    ...idDefinition,
    count: new import_bueno70.NumberValue({ min: 0 })
  })
);
var unregisterQuerySuggest = (0, import_toolkit91.createAction)(
  "querySuggest/unregister",
  (payload) => validatePayload(payload, idDefinition)
);
var selectQuerySuggestion2 = (0, import_toolkit91.createAction)(
...
var clearQuerySuggest2 = (0, import_toolkit91.createAction)(
  "querySuggest/clear",
  (payload) => validatePayload(payload, idDefinition)
);
var fetchQuerySuggestions2 = (0, import_toolkit91.createAsyncThunk)(
  "querySuggest/fetch",
  async (payload, {
    getState,
    rejectWithValue,
...
// src/features/query-set/query-set-slice.ts
var querySetReducer = (0, import_toolkit92.createReducer)(
...
function handleRestoreSearchParameters(state, action) {
  if (!(0, import_bueno71.isNullOrUndefined)(action.payload.q)) {
...
// src/features/query-suggest/query-suggest-slice.ts
var querySuggestReducer = (0, import_toolkit93.createReducer)(
...
var registerRecentQueriesPayloadDefinition = {
  queries: new import_bueno72.ArrayValue({
    required: true,
    each: new import_bueno72.StringValue({ emptyAllowed: false })
  }),
  maxLength: new import_bueno72.NumberValue({ required: true, min: 1, default: 10 })
};
var registerRecentQueries = (0, import_toolkit94.createAction)(
  "recentQueries/registerRecentQueries",
  (payload) => validatePayload(payload, registerRecentQueriesPayloadDefinition)
);
var clearRecentQueries = (0, import_toolkit94.createAction)(
...
// src/features/recent-queries/recent-queries-slice.ts
var recentQueriesReducer = (0, import_toolkit95.createReducer)(
...
var clearRecentQueries2 = (0, import_toolkit96.createAction)("commerce/recentQueries/clear");
var registerRecentQueries2 = (0, import_toolkit96.createAction)(
  "commerce/recentQueries/register",
  (payload) => validatePayload(payload, registerRecentQueriesPayloadDefinition)
);

// src/features/commerce/recent-queries/recent-queries-slice.ts
var recentQueriesReducer2 = (0, import_toolkit97.createReducer)(
  getRecentQueriesInitialState(),
  (builder) => {
    builder.addCase(registerRecentQueries2, handleRegisterQueries).addCase(clearRecentQueries2, handleClearRecentQueries).addCase(executeSearch.fulfilled, (state, action) => {
      const query2 = action.payload.queryExecuted;
...
var spotlightContentClick = (0, import_toolkit98.createAsyncThunk)(
...
// src/features/commerce/spotlight-content/spotlight-content-actions-loaders.ts
function loadSpotlightContentActions() {
  return {
...
// src/features/standalone-search-box-set/standalone-search-box-set-actions.ts
var registerStandaloneSearchBox = (0, import_toolkit99.createAction)(
  "standaloneSearchBox/register",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString,
    redirectionUrl: requiredNonEmptyString,
    overwrite: new import_bueno73.BooleanValue({ required: false })
  })
);
var updateStandaloneSearchBoxRedirectionUrl = (0, import_toolkit99.createAction)(
...
var resetStandaloneSearchBox = (0, import_toolkit99.createAction)(
  "standaloneSearchBox/reset",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString
  })
);
var updateAnalyticsToSearchFromLink = (0, import_toolkit99.createAction)(
  "standaloneSearchBox/updateAnalyticsToSearchFromLink",
  (payload) => validatePayload(payload, { id: requiredNonEmptyString })
);
var updateAnalyticsToOmniboxFromLink = (0, import_toolkit99.createAction)(
  "standaloneSearchBox/updateAnalyticsToOmniboxFromLink"
);
var fetchRedirectUrl = (0, import_toolkit99.createAsyncThunk)(
  ...
  async (payload, {
    ...
    validatePayload2(payload, { id: new import_bueno73.StringValue({ emptyAllowed: false }) });
...
// src/features/standalone-search-box-set/standalone-search-box-set-slice.ts
var standaloneSearchBoxSetReducer = (0, import_toolkit100.createReducer)(
...
var buildPlanRequest2 = (state, navigatorContext) => {
  const baseRequest2 = buildBaseCommerceAPIRequest(state, navigatorContext);
  return {
    ...baseRequest2,
    context: {
...
// src/features/commerce/standalone-search-box-set/standalone-search-box-set-actions.ts
var fetchRedirectUrl2 = (0, import_toolkit101.createAsyncThunk)(
  "commerce/standaloneSearchBox/fetchRedirect",
  async (payload, { getState, rejectWithValue, extra: { apiClient, navigatorContext } }) => {
    validatePayload(payload, { id: new import_bueno74.StringValue({ emptyAllowed: false }) });
    const state = getState();
    const request = buildPlanRequest2(state, navigatorContext);
    const response = await apiClient.plan(request);
    if (isErrorResponse(response)) {
      return rejectWithValue(response.error);
    }
...
var registerStandaloneSearchBox2 = (0, import_toolkit101.createAction)(
  "commerce/standaloneSearchBox/register",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString,
    redirectionUrl: requiredNonEmptyString,
    overwrite: new import_bueno74.BooleanValue({ required: false })
  })
);
var updateStandaloneSearchBoxRedirectionUrl2 = (0, import_toolkit101.createAction)(
...
var resetStandaloneSearchBox2 = (0, import_toolkit101.createAction)(
...
function loadStandaloneSearchBoxSetActions(engine) {
  ...
  return {
    fetchRedirectUrl: fetchRedirectUrl2,
    registerStandaloneSearchBox: registerStandaloneSearchBox2,
    updateStandaloneSearchBoxRedirectionUrl: updateStandaloneSearchBoxRedirectionUrl2,
    resetStandaloneSearchBox: resetStandaloneSearchBox2
  };
}
...
var facetRequestSelector = (0, import_toolkit102.createSelector)(
  (state, facetId2) => ({
...
function validateSortInitialState(engine, state) {
  ...
  const schema = new import_bueno75.Schema({
...
var facetResponseSelector = (0, import_toolkit103.createSelector)(
...
var isFacetLoadingResponseSelector = (0, import_toolkit103.createSelector)(
  (state) => ({ state }),
...
function buildCategoryFieldSuggestions(engine, options) {
  ...
  const controller = buildController(engine);
  const facetSearchStateSelector = (0, import_toolkit104.createSelector)(
...
function buildFieldSuggestionsGenerator(engine) {
  ...
  const controller = buildController(engine);
  const createFieldSuggestionsControllers = (0, import_toolkit105.createSelector)(
...
var categoryFacetPayloadDefinition = {
  facetId: facetIdDefinition,
  field: requiredNonEmptyString,
  tabs: new import_bueno77.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno77.ArrayValue({ each: new import_bueno77.StringValue() }),
      excluded: new import_bueno77.ArrayValue({ each: new import_bueno77.StringValue() })
    }
  }),
  activeTab: new import_bueno77.StringValue({ required: false }),
  delimitingCharacter: new import_bueno77.StringValue({ required: false, emptyAllowed: true }),
  filterFacetCount: new import_bueno77.BooleanValue({ required: false }),
  injectionDepth: new import_bueno77.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno77.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno77.Value({ required: false }),
  basePath: new import_bueno77.ArrayValue({ required: false, each: requiredNonEmptyString }),
  filterByBasePath: new import_bueno77.BooleanValue({ required: false })
};
var registerCategoryFacet = (0, import_toolkit106.createAction)(
  "categoryFacet/register",
  (payload) => validatePayload(payload, categoryFacetPayloadDefinition)
);
var toggleSelectCategoryFacetValue2 = (0, import_toolkit106.createAction)(
...
var deselectAllCategoryFacetValues = (0, import_toolkit106.createAction)(
  "categoryFacet/deselectAll",
  (payload) => validatePayload(payload, categoryFacetPayloadDefinition.facetId)
);
var updateCategoryFacetNumberOfValues2 = (0, import_toolkit106.createAction)(
...
var updateCategoryFacetSortCriterion = (0, import_toolkit106.createAction)(
  "categoryFacet/updateSortCriterion",
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    criterion: new import_bueno77.Value()
  })
);
var updateCategoryFacetBasePath = (0, import_toolkit106.createAction)(
  "categoryFacet/updateBasePath",
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    basePath: new import_bueno77.ArrayValue({ each: requiredNonEmptyString })
  })
);

// src/features/facet-options/facet-options-slice.ts
var facetOptionsReducer = (0, import_toolkit107.createReducer)(
  ...
  (builder) => {
    ...
    }).addCase(executeSearch3.rejected, (state) => {
      state.freezeFacetOrder = false;
    }).addCase(
      change.fulfilled,
...
var executeToggleRangeFacetSelect = (0, import_toolkit108.createAction)(
...
var executeToggleRangeFacetExclude = (0, import_toolkit108.createAction)(
...
var definition = {
  facetId: facetIdDefinition,
  selection: new import_bueno78.RecordValue({ values: dateFacetValueDefinition })
};
var executeToggleDateFacetSelect = (0, import_toolkit109.createAsyncThunk)(
...
var executeToggleDateFacetExclude = (0, import_toolkit109.createAsyncThunk)(
...
var searchReducer = (0, import_toolkit110.createReducer)(
  getSearchInitialState(),
  (builder) => {
    builder.addCase(
...
var dateRangeRequestDefinition2 = {
  start: new import_bueno79.StringValue(),
  end: new import_bueno79.StringValue(),
  endInclusive: new import_bueno79.BooleanValue(),
  state: new import_bueno79.StringValue({ constrainTo: facetValueStates })
};
var dateFacetOptionsSchema = new import_bueno79.Schema({
  facetId,
  field,
  tabs: new import_bueno79.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno79.ArrayValue({ each: new import_bueno79.StringValue() }),
      excluded: new import_bueno79.ArrayValue({ each: new import_bueno79.StringValue() })
    }
  }),
  ...
  injectionDepth,
  numberOfValues,
  currentValues: new import_bueno79.ArrayValue({
    each: new import_bueno79.RecordValue({ values: dateRangeRequestDefinition2 })
  }),
  sortCriteria: new import_bueno79.StringValue({ constrainTo: rangeFacetSortCriteria }),
  rangeAlgorithm: new import_bueno79.StringValue({ constrainTo: rangeFacetRangeAlgorithm })
});
...
var definition2 = {
  facetId: facetIdDefinition,
  selection: new import_bueno80.RecordValue({ values: numericFacetValueDefinition })
};
var executeToggleNumericFacetSelect = (0, import_toolkit111.createAsyncThunk)(
...
var executeToggleNumericFacetExclude = (0, import_toolkit111.createAsyncThunk)(
...
var numericRangeRequestDefinition = {
  start: new import_bueno81.NumberValue(),
  end: new import_bueno81.NumberValue(),
  endInclusive: new import_bueno81.BooleanValue(),
  state: new import_bueno81.StringValue({ constrainTo: facetValueStates })
};
var numericFacetOptionsSchema = new import_bueno81.Schema({
  facetId,
  tabs: new import_bueno81.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno81.ArrayValue({ each: new import_bueno81.StringValue() }),
      excluded: new import_bueno81.ArrayValue({ each: new import_bueno81.StringValue() })
    }
  }),
  field,
  generateAutomaticRanges,
  ...
  injectionDepth,
  numberOfValues,
  currentValues: new import_bueno81.ArrayValue({
    each: new import_bueno81.RecordValue({ values: numericRangeRequestDefinition })
  }),
  sortCriteria: new import_bueno81.StringValue({ constrainTo: rangeFacetSortCriteria }),
  resultsMustMatch: new import_bueno81.StringValue({ constrainTo: facetResultsMustMatch }),
  rangeAlgorithm: new import_bueno81.StringValue({ constrainTo: rangeFacetRangeAlgorithm })
});
...
function castUnknownObject(value) {
  ...
  Object.entries(jsonParsed).forEach((entry) => {
    ...
    ret[id2] = values.map((v) => (0, import_bueno82.isString)(v) ? decodeURIComponent(v) : v);
  });
  return ret;
}
...
function buildCategoryFilterSuggestions(engine, options) {
  ...
  const getState = () => engine[stateKey];
  const controller = buildController(engine);
  const facetForFieldSuggestionsSelector = (0, import_toolkit112.createSelector)(
    (state) => state.fieldSuggestionsOrder,
    (facets) => facets.find((facet) => facet.facetId === options.facetId)
  );
  const facetSearchStateSelector = (0, import_toolkit112.createSelector)(
    (state) => state.categoryFacetSearchSet[namespacedFacetId],
    (facetSearch3) => ({
      isLoading: facetSearch3.isLoading,
      moreValuesAvailable: facetSearch3.response.moreValuesAvailable,
...
function buildFilterSuggestions(engine, options) {
  ...
  const getState = () => engine[stateKey];
  const controller = buildController(engine);
  const facetForFieldSuggestionsSelector = (0, import_toolkit113.createSelector)(
    (state) => state.fieldSuggestionsOrder,
    (facets) => facets.find((facet) => facet.facetId === options.facetId)
  );
  const facetSearchStateSelector = (0, import_toolkit113.createSelector)(
...
function buildFilterSuggestionsGenerator(engine) {
  ...
  const controller = buildController(engine);
  const createFacetedSearchControllers = (0, import_toolkit114.createSelector)(
    (state) => state.fieldSuggestionsOrder,
    (facetOrder) => facetOrder.map(({ type, facetId: facetId2 }) => {
      switch (type) {
        case "hierarchical":
...
var instantProductsOptionDefinitions = {
  ...
  cacheTimeout: new import_bueno83.NumberValue()
};
var instantProductsOptionsSchema = new import_bueno83.Schema(instantProductsOptionDefinitions);
...
function buildCoreBreadcrumbManager(engine, options) {
  ...
  const commerceFacetSelector = (0, import_toolkit115.createSelector)(
...
var categoryFacetSearchStateSelector = (0, import_toolkit116.createSelector)(
  (state, facetId2) => ({
...
function buildFacetGenerator(engine, options) {
  ...
  const controller = buildController(engine);
  const { dispatch } = engine;
  const createFacetControllers = (0, import_toolkit117.createSelector)(
    [
      (state) => state.facetOrder,
  ...
  const createFacetController = (0, import_toolkit117.createSelector)(
...
var specificFacetSearchStateSelector = (0, import_toolkit118.createSelector)(
  (state, facetId2) => ({
...
var optionsSchema = new import_bueno84.Schema({
  pageSize: new import_bueno84.NumberValue({ min: 1, max: 1e3, required: false })
});
function buildCorePagination(engine, props) {
  ...
  const paginationSelector = (0, import_toolkit119.createSelector)(
...
// src/features/commerce/parameters/parameters-slice.ts
var parametersReducer = (0, import_toolkit120.createReducer)(
...
// src/controllers/commerce/core/parameter-manager/headless-core-parameter-manager.ts
var initialStateSchema = (parametersDefinition2) => new import_bueno85.Schema({
  parameters: new import_bueno85.RecordValue({
    options: { required: true },
...
var numberOfValuesDefinition = new import_bueno86.NumberValue({
  min: NUMBER_OF_VALUE_MINIMUM,
  default: NUMBER_OF_VALUE_DEFAULT,
  required: false
});
var desiredCountDefinition = new import_bueno86.NumberValue({
...
var setOptions = (0, import_toolkit121.createAction)(
  "automaticFacet/setOptions",
  (payload) => validatePayload(payload, optionsSchema2)
);
var deselectAllAutomaticFacetValues = (0, import_toolkit121.createAction)(
  "automaticFacet/deselectAll",
  (payload) => validatePayload(payload, facetIdDefinition)
);
var fieldDefinition = requiredNonEmptyString;
var toggleSelectAutomaticFacetValue = (0, import_toolkit121.createAction)(
  "automaticFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    field: fieldDefinition,
    selection: new import_bueno86.RecordValue({ values: facetValueDefinition })
  })
);

// src/features/pagination/pagination-slice.ts
var paginationReducer2 = (0, import_toolkit122.createReducer)(
  ...
  (builder) => {
    builder.addCase(registerNumberOfResults, (state, action) => {
      ...
      handlePaginationReset2(state);
    }).addCase(toggleSelectCategoryFacetValue2, (state) => {
      handlePaginationReset2(state);
...
var initialStateSchema2 = new import_bueno87.Schema({
  parameters: new import_bueno87.RecordValue({
    options: { required: true },
...
// src/controllers/url-manager/headless-url-manager.ts
var initialStateSchema3 = new import_bueno88.Schema({
  fragment: new import_bueno88.StringValue()
});
...
var facetResponseSelector2 = (0, import_toolkit123.createSelector)(
  (state, facetId2) => ({ state, facetId: facetId2 }),
  ({ state, facetId: facetId2 }) => {
...
var isFacetLoadingResponseSelector3 = (0, import_toolkit123.createSelector)(
  (state) => ({ state }),
...
var initialStateSchema4 = new import_bueno89.Schema({
  queries: new import_bueno89.ArrayValue({ required: true })
});
var optionsSchema3 = new import_bueno89.Schema({
  maxLength: new import_bueno89.NumberValue({ required: true, min: 1 }),
  clearFilters: new import_bueno89.BooleanValue()
});
...
function buildRecentQueriesList(engine, props) {
  ...
  return {
    ...
    updateRecentQueries(queries) {
      const errorMessage = new import_bueno89.ArrayValue({
        required: true,
        each: new import_bueno89.StringValue({ required: true }),
        min: 1
      }).validate(queries);
      if (errorMessage) {
    ...
    executeRecentQuery(index) {
      const errorMessage = new import_bueno89.NumberValue({
        required: true,
        min: 0,
...
var queryReducer2 = (0, import_toolkit124.createReducer)(
  getQueryInitialState(),
  (builder) => builder.addCase(updateQuery2, (state, action) => ({ ...state, ...action.payload })).addCase(applyDidYouMeanCorrection, (state, action) => {
...
var searchBoxOptionDefinitions2 = {
  ...
  highlightOptions,
  clearFilters,
  enableResults: new import_bueno91.BooleanValue()
};
var searchBoxOptionsSchema2 = new import_bueno91.Schema(
...
// src/features/commerce/standalone-search-box-set/standalone-search-box-set-slice.ts
var commerceStandaloneSearchBoxSetReducer = (0, import_toolkit125.createReducer)(
...
var standaloneSearchBoxSchema = new import_bueno92.Schema({
  ...searchBoxOptionDefinitions2,
  redirectionUrl: new import_bueno92.StringValue({
    required: true,
    emptyAllowed: false
  }),
  overwrite: new import_bueno92.BooleanValue({
    required: false
  })
});
...
function buildStandaloneSearchBox(engine, props) {
  ...
  return {
    ...
    afterRedirection() {
      dispatch(resetStandaloneSearchBox2({ id: id2 }));
    },
    updateRedirectUrl(url) {
      dispatch(
        updateStandaloneSearchBoxRedirectionUrl2({ id: id2, redirectionUrl: url })
      );
    },
    submit() {
      dispatch(
      ...
      dispatch(fetchRedirectUrl2({ id: id2 }));
    },
    get state() {
      const state = getState();
...
var getProductProperty = (product, property) => {
  ...
  if (!(0, import_bueno93.isNullOrUndefined)(anyProduct[property])) {
    return anyProduct[property];
  }
  if (!(0, import_bueno93.isNullOrUndefined)(product.additionalFields[property])) {
...
var fieldsMustBeDefined = (fieldNames) => {
  return (product) => {
    return fieldNames.every(
      (fieldName) => !(0, import_bueno93.isNullOrUndefined)(getProductProperty(product, fieldName))
    );
  };
};
...
var getFieldValuesFromProduct = (fieldName, product) => {
  ...
  return (0, import_bueno93.isArray)(rawValue) ? rawValue : [rawValue];
};

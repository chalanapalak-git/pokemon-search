...
__export(index_exports, {
  ...
  buildAutomaticFacetGenerator: () => buildAutomaticFacetGenerator,
  buildBreadcrumbManager: () => buildBreadcrumbManager,
  buildCategoryFacet: () => buildCategoryFacet,
  buildCategoryFieldSuggestions: () => buildCategoryFieldSuggestions,
  buildContext: () => buildContext,
  buildController: () => buildController,
  buildCriterionExpression: () => buildCriterionExpression,
  buildDateFacet: () => buildDateFacet,
  buildDateFilter: () => buildDateFilter,
  buildDateRange: () => buildDateRange,
  buildDateSortCriterion: () => buildDateSortCriterion,
  buildDictionaryFieldContext: () => buildDictionaryFieldContext,
  buildDidYouMean: () => buildDidYouMean,
  buildExecuteTrigger: () => buildExecuteTrigger,
  buildFacet: () => buildFacet,
  buildFacetConditionsManager: () => buildCoreFacetConditionsManager,
  buildFacetManager: () => buildFacetManager,
  buildFieldSortCriterion: () => buildFieldSortCriterion,
  buildFieldSuggestions: () => buildFieldSuggestions,
  buildFoldedResultList: () => buildFoldedResultList,
  buildGeneratedAnswer: () => buildGeneratedAnswer,
  buildHistoryManager: () => buildHistoryManager,
  buildInstantResults: () => buildInstantResults,
  buildInteractiveCitation: () => buildInteractiveCitation,
  buildInteractiveInstantResult: () => buildInteractiveInstantResult,
  buildInteractiveRecentResult: () => buildInteractiveRecentResult,
  buildInteractiveResult: () => buildInteractiveResult,
  buildNoSortCriterion: () => buildNoSortCriterion,
  buildNotifyTrigger: () => buildNotifyTrigger,
  buildNumericFacet: () => buildNumericFacet,
  buildNumericFilter: () => buildNumericFilter,
  buildNumericRange: () => buildNumericRange,
  buildPager: () => buildPager,
  buildQueryError: () => buildQueryError,
  ...
  buildQuerySummary: () => buildQuerySummary,
  buildQueryTrigger: () => buildQueryTrigger,
  buildQuickview: () => buildQuickview,
  buildRecentQueriesList: () => buildRecentQueriesList,
  buildRecentResultsList: () => buildRecentResultsList,
  buildRedirectionTrigger: () => buildRedirectionTrigger,
  buildRelevanceInspector: () => buildRelevanceInspector,
  buildRelevanceSortCriterion: () => buildRelevanceSortCriterion,
  buildResultList: () => buildResultList,
  buildResultTemplatesManager: () => buildResultTemplatesManager,
  buildResultsPerPage: () => buildResultsPerPage,
  buildSearchBox: () => buildSearchBox,
  buildSearchEngine: () => buildSearchEngine,
  buildSearchParameterManager: () => buildSearchParameterManager,
  buildSearchParameterSerializer: () => buildSearchParameterSerializer,
  buildSearchStatus: () => buildSearchStatus,
  buildSmartSnippet: () => buildSmartSnippet,
  buildSmartSnippetQuestionsList: () => buildSmartSnippetQuestionsList,
  buildSort: () => buildSort,
  buildStandaloneSearchBox: () => buildStandaloneSearchBox,
  buildStaticFilter: () => buildStaticFilter,
  buildStaticFilterValue: () => buildStaticFilterValue,
  buildTab: () => buildTab,
  buildTabManager: () => buildTabManager,
  buildUrlManager: () => buildUrlManager,
  ...
  getSearchApiBaseUrl: () => getSearchApiBaseUrl,
  loadAdvancedSearchQueryActions: () => loadAdvancedSearchQueryActions,
  loadAutomaticFacetSetActions: () => loadAutomaticFacetSetActions,
  ...
  loadIPXActionsHistoryActions: () => loadIPXActionsHistoryActions,
  ...
  loadSearchParameterActions: () => loadSearchParameterActions,
...
function highlightString(params) {
  ...
  if ((0, import_bueno.isNullOrUndefined)(params.content) || isEmptyString(params.content)) {
...
function shimResponse(response) {
  ...
  if ((0, import_bueno2.isNullOrUndefined)(response.questionAnswer)) {
...
var requiredNonEmptyString = new import_bueno3.StringValue({
  required: true,
  emptyAllowed: false
});
var nonEmptyString = new import_bueno3.StringValue({
  required: false,
  emptyAllowed: false
});
var requiredEmptyAllowedString = new import_bueno3.StringValue({
  required: true,
  emptyAllowed: true
});
var nonRequiredEmptyAllowedString = new import_bueno3.StringValue({
  required: false,
  emptyAllowed: true
});
var nonEmptyStringArray = new import_bueno3.ArrayValue({
  each: requiredNonEmptyString,
  required: true
});
var optionalNonEmptyVersionString = new import_bueno3.StringValue({
  required: false,
  emptyAllowed: false,
  regex: /^\d+\.\d+\.\d+$/
});
var optionalTrackingId = new import_bueno3.StringValue({
  required: false,
  emptyAllowed: false,
  regex: /^[a-zA-Z0-9_\-.]{1,100}$/
});
var requiredTrackingId = new import_bueno3.StringValue({
  required: true,
  emptyAllowed: false,
  regex: /^[a-zA-Z0-9_\-.]{1,100}$/
});
...
var validatePayloadAndThrow = (payload, definition4) => {
  ...
  if (isSchemaValue) {
    return {
      payload: new import_bueno3.Schema({
        value: definition4
      }).validate({ value: payload }).value
    };
  }
  const asRecordValue = new import_bueno3.RecordValue({
    options: { required: true },
    values: definition4
  });
  const isInvalid = asRecordValue.validate(payload);
  if (isInvalid) {
    throw new import_bueno3.SchemaValidationError(isInvalid);
  }
  return { payload };
};
...
var isGeneratedAnswerFeatureEnabledWithAnswerAPI = (state) => "answer" in state && "generatedAnswer" in state && !(0, import_bueno4.isNullOrUndefined)(state.generatedAnswer?.answerConfigurationId);
...
var buildCriterionExpression = (criterion) => {
  if ((0, import_bueno5.isArray)(criterion)) {
...
var criterionDefinition = new import_bueno5.RecordValue({
  values: {
    by: new import_bueno5.EnumValue({ enum: SortBy, required: true }),
    order: new import_bueno5.EnumValue({ enum: SortOrder }),
    field: new import_bueno5.StringValue()
  }
});
...
function getCitationSourceName(citation) {
  ...
  if ((0, import_bueno6.isNullOrUndefined)(source)) {
    return "unknown";
  }
  return source;
}
...
var rawPartialDefinition = {
  urihash: new import_bueno6.StringValue(),
  sourcetype: new import_bueno6.StringValue(),
  permanentid: new import_bueno6.StringValue()
};
var resultPartialDefinition = {
  uniqueId: requiredNonEmptyString,
  raw: new import_bueno6.RecordValue({ values: rawPartialDefinition }),
  title: requiredNonEmptyString,
  uri: requiredNonEmptyString,
  clickUri: requiredNonEmptyString,
  rankingModifier: new import_bueno6.StringValue({ required: false, emptyAllowed: true })
};
...
function getDocumentAuthor(result) {
  ...
  if ((0, import_bueno6.isNullOrUndefined)(author)) {
    return "unknown";
  }
...
var validateResultPayload = (result) => new import_bueno6.Schema(resultPartialDefinition).validate(partialResultPayload(result));
...
var updateSearchConfiguration = (0, import_toolkit5.createAction)(
  ...
  (payload) => {
    return validatePayload(payload, {
      ...
      pipeline: new import_bueno7.StringValue({ required: false, emptyAllowed: true }),
      searchHub: nonEmptyString,
      timezone: nonEmptyString,
      locale: nonEmptyString,
      authenticationProviders: new import_bueno7.ArrayValue({
        required: false,
        each: requiredNonEmptyString
      })
    });
...
var setAgentId = (0, import_toolkit5.createAction)(
  ...
  (payload) => validatePayload(payload, new import_bueno7.StringValue({ required: true }))
);
...
var searchParametersDefinition = {
  q: new import_bueno8.StringValue(),
  enableQuerySyntax: new import_bueno8.BooleanValue(),
  aq: new import_bueno8.StringValue(),
  cq: new import_bueno8.StringValue(),
  firstResult: new import_bueno8.NumberValue({ min: 0 }),
  numberOfResults: new import_bueno8.NumberValue({ min: 0 }),
  sortCriteria: new import_bueno8.StringValue(),
  f: new import_bueno8.RecordValue(),
  fExcluded: new import_bueno8.RecordValue(),
  cf: new import_bueno8.RecordValue(),
  nf: new import_bueno8.RecordValue(),
  mnf: new import_bueno8.RecordValue(),
  df: new import_bueno8.RecordValue(),
  debug: new import_bueno8.BooleanValue(),
  sf: new import_bueno8.RecordValue(),
  tab: new import_bueno8.StringValue(),
  af: new import_bueno8.RecordValue()
};
...
var setPipeline = (0, import_toolkit10.createAction)(
  ...
  (payload) => validatePayload(
    payload,
    new import_bueno9.StringValue({ required: true, emptyAllowed: true })
  )
);
...
var updateFacetAutoSelection = (0, import_toolkit13.createAction)(
  ...
  (payload) => validatePayload(payload, {
    allow: new import_bueno10.BooleanValue({ required: true })
  })
);
...
var numberValue = new import_bueno11.NumberValue({ required: true, min: 0 });
...
var updateQuery = (0, import_toolkit16.createAction)(
  "query/updateQuery",
  (payload) => validatePayload(payload, {
    q: new import_bueno12.StringValue(),
    enableQuerySyntax: new import_bueno12.BooleanValue()
  })
);
...
var buildSearchAndFoldingLoadCollectionRequest2 = async (state, eventDescription) => {
  return {
    ...
    ...state.excerptLength && !(0, import_bueno14.isNullOrUndefined)(state.excerptLength.length) && {
      excerptLength: state.excerptLength.length
    },
    ...state.configuration.search.authenticationProviders.length && {
      authentication: state.configuration.search.authenticationProviders.join(",")
...
var buildRelativeDateDefinition = (period) => {
  ...
  return {
    amount: new import_bueno15.NumberValue({ required: !isNow, min: 1 }),
    unit: new import_bueno15.StringValue({
      required: !isNow,
      constrainTo: validRelativeDateUnits
    }),
    period: new import_bueno15.StringValue({
      required: true,
...
function validateRelativeDate(date) {
  ...
  new import_bueno15.Schema(buildRelativeDateDefinition(relativeDate.period)).validate(
    relativeDate
  );
...
var setCorrectionMode = (0, import_toolkit17.createAction)(
  ...
  (payload) => validatePayload(
    payload,
    new import_bueno16.StringValue({
...
var logUndoTriggerQueryPayloadDefinition = new import_bueno17.RecordValue({
  values: {
...
var updateIgnoreQueryTrigger = (0, import_toolkit18.createAction)(
  ...
  (q) => validatePayload(q, new import_bueno18.StringValue({ emptyAllowed: true, required: true }))
);
var applyQueryTriggerModification = (0, import_toolkit18.createAction)(
  "trigger/query/modification",
  (payload) => validatePayload(
    payload,
    new import_bueno18.RecordValue({
...
var AsyncSearchThunkProcessor = class {
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteModernDidYouMeanAutoCorrection = !(0, import_bueno19.isNullOrUndefined)(queryCorrection) && !(0, import_bueno19.isNullOrUndefined)(queryCorrection.correctedQuery);
...
async function legacyFetchInstantResults(payload, config) {
  validatePayload(payload, {
    ...
    maxResultsPerQuery: new import_bueno20.NumberValue({
      required: true,
      min: 1
    }),
    cacheTimeout: new import_bueno20.NumberValue()
  });
...
var AsyncSearchThunkProcessor2 = class {
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteClassicDidYouMeanAutoCorrection = results.length === 0 && queryCorrections && queryCorrections.length !== 0;
    const shouldExecuteModernDidYouMeanAutoCorrection = !(0, import_bueno21.isNullOrUndefined)(queryCorrection) && !(0, import_bueno21.isNullOrUndefined)(queryCorrection.correctedQuery);
    const shouldExitWithNoAutoCorrection = !shouldExecuteClassicDidYouMeanAutoCorrection && !shouldExecuteModernDidYouMeanAutoCorrection;
    if (shouldExitWithNoAutoCorrection) {
      return null;
    }
...
var prepareForSearchWithQuery = (0, import_toolkit21.createAsyncThunk)("search/prepareForSearchWithQuery", (payload, thunk) => {
  ...
  validatePayload(payload, {
    q: new import_bueno22.StringValue(),
    enableQuerySyntax: new import_bueno22.BooleanValue(),
    clearFilters: new import_bueno22.BooleanValue()
  });
...
var fetchInstantResults2 = (0, import_toolkit21.createAsyncThunk)(
  ...
  async (payload, config) => {
    ...
    validatePayload(payload, {
      id: requiredNonEmptyString,
      q: requiredNonEmptyString,
      maxResultsPerQuery: new import_bueno22.NumberValue({
        required: true,
        min: 1
      }),
      cacheTimeout: new import_bueno22.NumberValue()
    });
    const { q, maxResultsPerQuery } = payload;
...
var getResultProperty = (result, property) => {
  ...
  if (!(0, import_bueno23.isNullOrUndefined)(anyResult[property])) {
    return anyResult[property];
  }
  if (!(0, import_bueno23.isNullOrUndefined)(result.raw[property])) {
...
var fieldsMustBeDefined = (fieldNames) => {
  return (result) => {
    return fieldNames.every(
      (fieldName) => !(0, import_bueno23.isNullOrUndefined)(getResultProperty(result, fieldName))
    );
  };
};
...
var setSearchHub = (0, import_toolkit25.createAction)(
  ...
  (payload) => validatePayload(
    payload,
    new import_bueno24.StringValue({ required: true, emptyAllowed: true })
  )
);
...
// src/features/follow-up-answers/follow-up-answers-actions.ts
var stringValue = new import_bueno25.StringValue({ required: true });
var setIsEnabled = (0, import_toolkit28.createAction)(
  "followUpAnswers/setIsEnabled",
  (payload) => validatePayload(payload, new import_bueno25.BooleanValue({ required: true }))
);
...
var setFollowUpIsLoading = (0, import_toolkit28.createAction)(
  ...
  (payload) => validatePayload(payload, {
    isLoading: new import_bueno25.BooleanValue({ required: true }),
    answerId: requiredNonEmptyString
  })
);
...
var followUpCompleted = (0, import_toolkit28.createAction)(
  ...
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString,
    cannotAnswer: new import_bueno25.BooleanValue({ required: false })
  })
);
var followUpFailed = (0, import_toolkit28.createAction)(
  "followUpAnswers/followUpFailed",
  (payload) => validatePayload(payload, {
    message: new import_bueno25.StringValue(),
...
// src/features/generated-answer/generated-answer-actions.ts
var stringValue2 = new import_bueno26.StringValue({ required: true });
var optionalStringValue = new import_bueno26.StringValue();
var booleanValue = new import_bueno26.BooleanValue({ required: true });
var citationSchema = {
  id: stringValue2,
  title: stringValue2,
  uri: stringValue2,
...
var answerContentFormatSchema = new import_bueno26.StringValue({
  required: true,
...
var setAnswerGenerationMode = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(
    payload,
    new import_bueno26.StringValue({
...
var updateCitations = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(payload, {
    citations: new import_bueno26.ArrayValue({
      required: true,
      each: new import_bueno26.RecordValue({
        values: citationSchema
      })
    })
  })
...
var updateError = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(payload, {
    ...
    code: new import_bueno26.NumberValue({ min: 0 })
  })
);
...
var setId = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(payload, {
    id: new import_bueno26.StringValue({
      required: true
    })
  })
);
...
var updateResponseFormat = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(payload, {
    contentFormat: new import_bueno26.ArrayValue({
...
var setAnswerApiQueryParams = (0, import_toolkit31.createAction)(
  ...
  (payload) => validatePayload(payload, new import_bueno26.RecordValue({}))
);
...
var selectAnswer2 = (state) => {
  ...
  return answerApi.endpoints.getAnswer.select(params ?? import_query3.skipToken)(state);
};
...
function isAnalyticsAction(action) {
  ...
  return isActionWithType(action) && !(0, import_bueno27.isNullOrUndefined)(analytics);
}
...
var registerTab = (0, import_toolkit33.createAction)(
  "tab/register",
  (payload) => {
    const schema = new import_bueno28.RecordValue({
      values: {
        id: requiredNonEmptyString,
...
var configurationReducer = (0, import_toolkit34.createReducer)(
  ...
  (builder) => builder.addCase(updateBasicConfiguration, (state, action) => {
    ...
    if (!(0, import_bueno29.isNullOrUndefined)(action.payload.tab)) {
...
function handleUpdateBasicConfiguration(state, payload) {
  if (!(0, import_bueno29.isNullOrUndefined)(payload.accessToken)) {
    state.accessToken = payload.accessToken;
  }
  state.environment = payload.environment ?? "prod";
  if (!(0, import_bueno29.isNullOrUndefined)(payload.organizationId)) {
    state.organizationId = payload.organizationId;
  }
}
function handleUpdateSearchConfiguration(state, payload) {
  if (!(0, import_bueno29.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.search.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.locale)) {
    state.search.locale = payload.locale;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.timezone)) {
    state.search.timezone = payload.timezone;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.authenticationProviders)) {
...
function handleUpdateAnalyticsConfiguration(state, payload) {
  if (!(0, import_bueno29.isNullOrUndefined)(payload.enabled)) {
    state.analytics.enabled = payload.enabled;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.originContext)) {
    state.analytics.originContext = payload.originContext;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.originLevel2)) {
    state.analytics.originLevel2 = payload.originLevel2;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.originLevel3)) {
    state.analytics.originLevel3 = payload.originLevel3;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.analytics.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.trackingId)) {
    state.analytics.trackingId = payload.trackingId;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.analyticsMode)) {
    state.analytics.analyticsMode = payload.analyticsMode;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.source)) {
  ...
  if (!(0, import_bueno29.isNullOrUndefined)(payload.runtimeEnvironment)) {
    state.analytics.runtimeEnvironment = payload.runtimeEnvironment;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.anonymous)) {
    state.analytics.anonymous = payload.anonymous;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.deviceId)) {
    state.analytics.deviceId = payload.deviceId;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.userDisplayName)) {
    state.analytics.userDisplayName = payload.userDisplayName;
  }
  if (!(0, import_bueno29.isNullOrUndefined)(payload.documentLocation)) {
...
var possiblyWarnOnMismatch = (token, tokenProp, stateProp, defaultProp, payload, logger) => {
  ...
  if ((0, import_bueno30.isNullOrUndefined)(tokenValue)) {
    return;
  }
  if ((0, import_bueno30.isNullOrUndefined)(payload)) {
    return;
  }
...
var engineConfigurationDefinitions = {
  ...
  name: new import_bueno31.StringValue({
    required: false,
    emptyAllowed: false
  }),
  analytics: new import_bueno31.RecordValue({
    options: {
      required: false
    },
    values: {
      enabled: new import_bueno31.BooleanValue({
        required: false
      }),
      originContext: new import_bueno31.StringValue({
        required: false
      }),
      originLevel2: new import_bueno31.StringValue({
        required: false
      }),
      originLevel3: new import_bueno31.StringValue({
        required: false
      }),
      analyticsMode: new import_bueno31.StringValue({
        constrainTo: ["legacy", "next"],
        required: false,
        default: "next"
      }),
      proxyBaseUrl: new import_bueno31.StringValue({
        required: false,
        url: true
      }),
      trackingId: new import_bueno31.StringValue({
        required: false,
        emptyAllowed: false,
        regex: /^[a-zA-Z0-9_\-.]{1,100}$/
      })
  ...
  environment: new import_bueno31.StringValue({
    required: false,
    default: "prod",
    constrainTo: ["prod", "hipaa", "stg", "dev"]
  })
...
// src/app/search-engine/search-engine-configuration.ts
var searchEngineConfigurationSchema = new import_bueno32.Schema({
  ...engineConfigurationDefinitions,
  search: new import_bueno32.RecordValue({
    options: {
      required: false
    },
    values: {
      pipeline: new import_bueno32.StringValue({ required: false, emptyAllowed: true }),
      searchHub: nonEmptyString,
      locale: nonEmptyString,
      timezone: nonEmptyString,
      authenticationProviders: new import_bueno32.ArrayValue({
        required: false,
        each: requiredNonEmptyString
      }),
      proxyBaseUrl: new import_bueno32.StringValue({ required: false, url: true })
    }
  })
});
...
// src/features/facets/automatic-facet-set/automatic-facet-set-actions.ts
var numberOfValuesDefinition = new import_bueno34.NumberValue({
  min: NUMBER_OF_VALUE_MINIMUM,
  default: NUMBER_OF_VALUE_DEFAULT,
  required: false
});
var desiredCountDefinition = new import_bueno34.NumberValue({
...
var categoryFacetValueDefinition = {
  state: new import_bueno35.Value({ required: true }),
  numberOfResults: new import_bueno35.NumberValue({ required: true, min: 0 }),
  value: new import_bueno35.StringValue({ required: true, emptyAllowed: true }),
  path: new import_bueno35.ArrayValue({ required: true, each: requiredNonEmptyString }),
  moreValuesAvailable: new import_bueno35.BooleanValue({ required: false })
};
...
var categoryFacetPayloadDefinition = {
  ...
  tabs: new import_bueno36.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno36.ArrayValue({ each: new import_bueno36.StringValue() }),
      excluded: new import_bueno36.ArrayValue({ each: new import_bueno36.StringValue() })
    }
  }),
  activeTab: new import_bueno36.StringValue({ required: false }),
  delimitingCharacter: new import_bueno36.StringValue({ required: false, emptyAllowed: true }),
  filterFacetCount: new import_bueno36.BooleanValue({ required: false }),
  injectionDepth: new import_bueno36.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno36.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno36.Value({ required: false }),
  basePath: new import_bueno36.ArrayValue({ required: false, each: requiredNonEmptyString }),
  filterByBasePath: new import_bueno36.BooleanValue({ required: false })
};
...
var updateCategoryFacetSortCriterion = (0, import_toolkit40.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    criterion: new import_bueno36.Value()
  })
);
var updateCategoryFacetBasePath = (0, import_toolkit40.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    basePath: new import_bueno36.ArrayValue({ each: requiredNonEmptyString })
  })
);
...
var categoryFacetBreadcrumbPayloadDefinition = {
  ...
  categoryFacetPath: new import_bueno37.ArrayValue({
    required: true,
    each: requiredNonEmptyString
  })
};
...
var updateFacetOptions = (0, import_toolkit41.createAction)(
  ...
  (payload = { freezeFacetOrder: true }) => validatePayload(payload, {
    freezeFacetOrder: new import_bueno38.BooleanValue({ required: false })
  })
);
...
var facetSearchOptionsDefinition = {
  facetId: facetIdDefinition,
  captions: new import_bueno39.RecordValue({ options: { required: false } }),
  numberOfValues: new import_bueno39.NumberValue({ required: false, min: 1 }),
  query: new import_bueno39.StringValue({ required: false, emptyAllowed: true })
};

// src/features/facets/facet-search-set/category/category-facet-search-actions.ts
var categoryFacetSearchResultDefinition = {
  path: new import_bueno40.ArrayValue({
    required: true,
    each: requiredNonEmptyString
  }),
  displayValue: requiredEmptyAllowedString,
  rawValue: requiredEmptyAllowedString,
  count: new import_bueno40.NumberValue({ required: true, min: 0 })
};
var selectCategoryFacetSearchResult = (0, import_toolkit42.createAction)(
  "categoryFacet/selectSearchResult",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    value: new import_bueno40.RecordValue({ values: categoryFacetSearchResultDefinition })
  })
);
...
var facetId = new import_bueno41.StringValue({
  regex: /^[a-zA-Z0-9-_]+$/
});
var field = new import_bueno41.StringValue({ required: true });
var basePath = new import_bueno41.ArrayValue({
  each: new import_bueno41.StringValue()
});
var delimitingCharacter = new import_bueno41.StringValue();
var filterByBasePath = new import_bueno41.BooleanValue();
var filterFacetCount = new import_bueno41.BooleanValue();
var injectionDepth = new import_bueno41.NumberValue({ min: 0 });
var numberOfValues = new import_bueno41.NumberValue({ min: 1 });
var generateAutomaticRanges = new import_bueno41.BooleanValue({
  required: true
});
var captions = new import_bueno41.RecordValue();
var query = new import_bueno41.StringValue();
var facetSearchOptionDefinitions = {
  captions,
  numberOfValues,
  query
};
var facetSearch = new import_bueno41.RecordValue({
  values: facetSearchOptionDefinitions
});
var allowedValues = new import_bueno41.RecordValue({
  options: { required: false },
  values: {
    type: new import_bueno41.StringValue({
      constrainTo: ["simple"],
      emptyAllowed: false,
      required: true
    }),
    values: new import_bueno41.ArrayValue({
      required: true,
      max: 25,
      each: new import_bueno41.StringValue({ emptyAllowed: false, required: true })
    })
  }
});
var hasBreadcrumbs = new import_bueno41.BooleanValue();
var customSort = new import_bueno41.ArrayValue({
  min: 1,
  max: 25,
  required: false,
  each: new import_bueno41.StringValue({ emptyAllowed: false, required: true })
...
var facetRegistrationOptionsDefinition = {
  facetId: facetIdDefinition,
  field: new import_bueno42.StringValue({ required: true, emptyAllowed: true }),
  tabs: new import_bueno42.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno42.ArrayValue({ each: new import_bueno42.StringValue() }),
      excluded: new import_bueno42.ArrayValue({ each: new import_bueno42.StringValue() })
    }
  }),
  activeTab: new import_bueno42.StringValue({ required: false }),
  filterFacetCount: new import_bueno42.BooleanValue({ required: false }),
  injectionDepth: new import_bueno42.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno42.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno42.Value({ required: false }),
  resultsMustMatch: new import_bueno42.Value({ required: false }),
  allowedValues,
  customSort
};
...
var toggleSelectFacetValue = (0, import_toolkit44.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno42.RecordValue({ values: facetValueDefinition })
  })
);
...
var updateFacetNumberOfValues = (0, import_toolkit44.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    numberOfValues: new import_bueno42.NumberValue({ required: true, min: 1 })
  })
);
var updateFacetIsFieldExpanded = (0, import_toolkit44.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    isFieldExpanded: new import_bueno42.BooleanValue({ required: true })
  })
);
var updateFreezeCurrentValues = (0, import_toolkit44.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    freezeCurrentValues: new import_bueno42.BooleanValue({ required: true })
  })
);
...
var logFacetUpdateSort = (payload) => makeAnalyticsAction("analytics/facet/sortChange", (client, state) => {
  validatePayload(payload, {
    facetId: facetIdDefinition,
    criterion: new import_bueno43.Value({
      required: true
    })
  });
  const { facetId: facetId2, criterion } = payload;
...
var selectFacetSearchResultPayloadDefinition = {
  facetId: facetIdDefinition,
  value: new import_bueno44.RecordValue({
    values: {
      displayValue: requiredEmptyAllowedString,
      rawValue: requiredEmptyAllowedString,
      count: new import_bueno44.NumberValue({ required: true, min: 0 })
    }
  })
};
...
var updateRangeFacetSortCriterion = (0, import_toolkit47.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    criterion: new import_bueno45.Value({ required: true })
  })
);
...
var numericFacetValueDefinition = {
  state: requiredNonEmptyString,
  start: new import_bueno46.NumberValue({ required: true }),
  end: new import_bueno46.NumberValue({ required: true }),
  endInclusive: new import_bueno46.BooleanValue({ required: true }),
  numberOfResults: new import_bueno46.NumberValue({ required: true, min: 0 })
};
...
var rangeFacetSelectionPayloadDefinition = (selection) => ({
  facetId: facetIdDefinition,
  selection: typeof selection.start === "string" ? new import_bueno46.RecordValue({ values: dateFacetValueDefinition }) : new import_bueno46.RecordValue({ values: numericFacetValueDefinition })
});
...
var dateFacetRegistrationOptionsDefinition = {
  ...
  currentValues: new import_bueno47.ArrayValue({
    required: false,
    each: new import_bueno47.RecordValue({ values: dateRangeRequestDefinition })
  }),
...
var toggleSelectDateFacetValue = (0, import_toolkit48.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno47.RecordValue({ values: dateFacetValueDefinition })
  })
);
    ...
    try {
      validatePayloadAndThrow(payload, {
        ...
        values: new import_bueno47.ArrayValue({
          each: new import_bueno47.RecordValue({ values: dateFacetValueDefinition })
        })
      });
...
var numericFacetRequestDefinition = {
  state: requiredNonEmptyString,
  start: new import_bueno48.NumberValue({ required: true }),
  end: new import_bueno48.NumberValue({ required: true }),
  endInclusive: new import_bueno48.BooleanValue({ required: true })
};
var numericFacetRegistrationOptionsDefinition = {
  facetId: facetIdDefinition,
  field: requiredNonEmptyString,
  tabs: new import_bueno48.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno48.ArrayValue({ each: new import_bueno48.StringValue() }),
      excluded: new import_bueno48.ArrayValue({ each: new import_bueno48.StringValue() })
    }
  }),
  activeTab: new import_bueno48.StringValue({ required: false }),
  currentValues: new import_bueno48.ArrayValue({
    required: false,
    each: new import_bueno48.RecordValue({ values: numericFacetRequestDefinition })
  }),
  generateAutomaticRanges: new import_bueno48.BooleanValue({ required: true }),
  filterFacetCount: new import_bueno48.BooleanValue({ required: false }),
  injectionDepth: new import_bueno48.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno48.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno48.Value({ required: false }),
  rangeAlgorithm: new import_bueno48.Value({ required: false })
};
...
var toggleSelectNumericFacetValue = (0, import_toolkit50.createAction)(
  ...
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno48.RecordValue({ values: numericFacetValueDefinition })
  })
);
...
var updateNumericFacetValues = (0, import_toolkit50.createAction)(
  ...
  (payload) => {
    try {
      validatePayloadAndThrow(payload, {
        facetId: facetIdDefinition,
        values: new import_bueno48.ArrayValue({
          each: new import_bueno48.RecordValue({ values: numericFacetValueDefinition })
        })
      });
...
var staticFilterValueSchema = new import_bueno49.RecordValue({
  options: { required: true },
  values: {
    caption: requiredEmptyAllowedString,
    expression: requiredEmptyAllowedString,
    state: new import_bueno49.StringValue({
      constrainTo: ["idle", "selected", "excluded"]
    })
  }
});
var staticFilterValuesSchema = new import_bueno49.ArrayValue({
  required: true,
...
// src/controllers/core/context/headless-core-context.ts
var initialStateSchema = new import_bueno51.Schema({
  values: new import_bueno51.RecordValue({
    options: { required: false }
  })
});
...
var facetOptionsReducer = (0, import_toolkit55.createReducer)(
...
var tabSetReducer = (0, import_toolkit56.createReducer)(
  ...
  (builder) => {
    builder.addCase(registerTab, (state, action) => {
      ...
      if (!(0, import_bueno52.isNullOrUndefined)(id)) {
...
function buildCoreTabManager(engine) {
  ...
  const controller = buildController(engine);
  const currentTab = (0, import_toolkit57.createSelector)(
    (state) => state.tabSet,
    (state) => {
...
var setContext2 = (0, import_toolkit58.createAction)(
  "dictionaryFieldContext/set",
  (payload) => {
    const objSchema = new import_bueno53.RecordValue({ options: { required: true } });
    const objError = validatePayload(payload, objSchema).error;
    if (objError) {
      return { payload, error: objError };
    }
    const values = Object.values(payload);
    const valueSchema = new import_bueno53.ArrayValue({ each: requiredEmptyAllowedString });
...
var addContext2 = (0, import_toolkit58.createAction)(
  "dictionaryFieldContext/add",
  (payload) => {
    const schema = new import_bueno53.RecordValue({
      options: { required: true },
      values: {
...
var removeContext2 = (0, import_toolkit58.createAction)(
...
var dictionaryFieldContextReducer = (0, import_toolkit59.createReducer)(
...
// src/features/did-you-mean/did-you-mean-slice.ts
var didYouMeanReducer = (0, import_toolkit60.createReducer)(
...
var automaticFacetSetReducer = (0, import_toolkit61.createReducer)(
...
// src/features/commerce/sort/sort.ts
var sortCriterionDefinition = new import_bueno54.RecordValue({
  options: {
    required: false
  },
  values: {
    by: new import_bueno54.EnumValue({ enum: SortBy2, required: true }),
    fields: new import_bueno54.ArrayValue({
      each: new import_bueno54.RecordValue({
        values: {
          field: new import_bueno54.StringValue({ required: true }),
          direction: new import_bueno54.EnumValue({ enum: SortDirection }),
          displayName: new import_bueno54.StringValue()
        }
      })
    })
  }
...
var executeCommerceFacetSearch = (0, import_toolkit62.createAsyncThunk)(
  "commerce/facetSearch/executeSearch",
  getExecuteFacetSearchThunkPayloadCreator(false)
);
var executeCommerceFieldSuggest = (0, import_toolkit62.createAsyncThunk)(
...
var moreProductsAvailableSelector = (0, import_toolkit63.createSelector)(
  (state) => ({
...
// src/features/commerce/product-listing/product-listing-actions.ts
var fetchProductListing = (0, import_toolkit64.createAsyncThunk)(
...
var fetchMoreProducts = (0, import_toolkit64.createAsyncThunk)(
...
var promoteChildToParentDefinition = {
  child: new import_bueno56.RecordValue({
    options: { required: true },
    values: {
      permanentid: new import_bueno56.StringValue({ required: true })
    }
  })
};
var promoteChildToParent = (0, import_toolkit64.createAction)(
...
// src/features/commerce/query-suggest/query-suggest-actions.ts
var clearQuerySuggest = (0, import_toolkit65.createAction)(
  "commerce/querySuggest/clear",
  (payload) => validatePayload(payload, { id: requiredNonEmptyString })
);
var fetchQuerySuggestions = (0, import_toolkit65.createAsyncThunk)(
...
var registerQuerySuggest = (0, import_toolkit65.createAction)(
  "commerce/querySuggest/register",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString,
    count: new import_bueno57.NumberValue({ min: 0 })
  })
);
var selectQuerySuggestion = (0, import_toolkit65.createAction)(
...
var updateCoreFacetNumberOfValues = (0, import_toolkit66.createAction)(
  "commerce/facets/core/updateNumberOfValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    numberOfValues: new import_bueno58.NumberValue({ required: true, min: 1 })
  })
);
var updateCoreFacetIsFieldExpanded = (0, import_toolkit66.createAction)(
  "commerce/facets/core/updateIsFieldExpanded",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    isFieldExpanded: new import_bueno58.BooleanValue({ required: true })
  })
);
var clearAllCoreFacets = (0, import_toolkit66.createAction)("commerce/facets/core/clearAll");
var deleteAllCoreFacets = (0, import_toolkit66.createAction)(
  "commerce/facets/core/deleteAll"
);
var deselectAllValuesInCoreFacet = (0, import_toolkit66.createAction)(
  "commerce/facets/core/deselectAllValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString
  })
);
var updateCoreFacetFreezeCurrentValues = (0, import_toolkit66.createAction)(
  "commerce/facets/core/updateFreezeCurrentValues",
  (payload) => validatePayload(payload, {
    facetId: requiredNonEmptyString,
    freezeCurrentValues: new import_bueno58.BooleanValue({ required: true })
  })
);
var updateAutoSelectionForAllCoreFacets = (0, import_toolkit66.createAction)(
  "commerce/facets/core/updateAutoSelectionForAll",
  (payload) => validatePayload(payload, {
    allow: new import_bueno58.BooleanValue({ required: true })
  })
);
...
var setPageSizeDefinition = {
  ...slotIdDefinition,
  pageSize: new import_bueno59.NumberValue({ required: true, min: 0 })
};
var setPageSize = (0, import_toolkit67.createAction)(
  "commerce/pagination/setPageSize",
  (payload) => validatePayload(payload, setPageSizeDefinition)
);
var selectPageDefinition = {
  ...slotIdDefinition,
  page: new import_bueno59.NumberValue({ required: true, min: 0 })
};
var selectPage = (0, import_toolkit67.createAction)(
  "commerce/pagination/selectPage",
  (payload) => validatePayload(payload, selectPageDefinition)
);
var nextPage2 = (0, import_toolkit67.createAction)(
  "commerce/pagination/nextPage",
  (payload) => validatePayload(payload, slotIdDefinition)
);
var previousPage2 = (0, import_toolkit67.createAction)(
  "commerce/pagination/previousPage",
  (payload) => validatePayload(payload, slotIdDefinition)
);
var registerRecommendationsSlotPagination = (0, import_toolkit67.createAction)(
...
var updateQuery2 = (0, import_toolkit68.createAction)(
  "commerce/query/update",
  (payload) => validatePayload(payload, {
    query: new import_bueno60.StringValue()
  })
);
...
var updateIgnoreQueryTrigger2 = (0, import_toolkit69.createAction)(
  "commerce/triggers/query/updateIgnore",
  (payload) => validatePayload(payload, {
    q: new import_bueno61.StringValue({ emptyAllowed: true, required: true })
  })
);
var applyQueryTriggerModification2 = (0, import_toolkit69.createAction)(
  "commerce/triggers/query/applyModification",
  (payload) => validatePayload(
    payload,
    new import_bueno61.RecordValue({
      values: { originalQuery: nonEmptyString, modification: nonEmptyString }
    })
  )
);
...
var moreProductsAvailableSelector2 = (0, import_toolkit70.createSelector)(
  (state) => ({
    total: totalEntriesPrincipalSelector(state),
...
var queryExecutedFromResponseSelector = (state, response) => {
  if (!(0, import_bueno62.isNullOrUndefined)(response.queryCorrection?.correctedQuery)) {
...
var AsyncSearchThunkProcessor3 = class {
  ...
  async processQueryCorrectionsOrContinue(fetched) {
    ...
    const shouldExecuteQueryCorrection = !(0, import_bueno63.isNullOrUndefined)(queryCorrection) && !(0, import_bueno63.isNullOrUndefined)(queryCorrection.correctedQuery);
...
// src/features/commerce/search/search-actions.ts
var executeSearch3 = (0, import_toolkit71.createAsyncThunk)("commerce/search/executeSearch", async (payload = {}, config) => {
...
var fetchMoreProducts2 = (0, import_toolkit71.createAsyncThunk)("commerce/search/fetchMoreProducts", async (payload = {}, config) => {
  const { getState } = config;
  const state = getState();
  const { navigatorContext } = config.extra;
...
var prepareForSearchWithQuery2 = (0, import_toolkit71.createAsyncThunk)("commerce/search/prepareForSearchWithQuery", (payload, thunk) => {
  const { dispatch } = thunk;
  validatePayload(payload, {
    query: new import_bueno64.StringValue(),
    clearFilters: new import_bueno64.BooleanValue()
  });
  if (payload.clearFilters) {
...
var fetchInstantProducts = (0, import_toolkit71.createAsyncThunk)(
...
var promoteChildToParentDefinition2 = {
  child: new import_bueno64.RecordValue({
    options: { required: true },
    values: {
      permanentid: new import_bueno64.StringValue({ required: true })
    }
  })
};
var promoteChildToParent2 = (0, import_toolkit71.createAction)(
...
var executeFacetSearch = (0, import_toolkit72.createAsyncThunk)("facetSearch/executeSearch", getExecuteFacetSearchThunkPayloadCreator2(false));
var executeFieldSuggest = (0, import_toolkit72.createAsyncThunk)("facetSearch/executeSearch", getExecuteFacetSearchThunkPayloadCreator2(true));
var clearFacetSearch = (0, import_toolkit72.createAction)(
...
// src/features/facets/facet-search-set/category/category-facet-search-set-slice.ts
var categoryFacetSearchSetReducer = (0, import_toolkit73.createReducer)(
...
// src/controllers/core/facets/category-facet/headless-core-category-facet-options.ts
var categoryFacetOptionsSchema = new import_bueno65.Schema({
  field,
  tabs: new import_bueno65.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno65.ArrayValue({ each: new import_bueno65.StringValue() }),
      excluded: new import_bueno65.ArrayValue({ each: new import_bueno65.StringValue() })
    }
  }),
  basePath,
  delimitingCharacter,
  ...
  injectionDepth,
  numberOfValues,
  sortCriteria: new import_bueno65.StringValue({
...
var currencyDefinition = new import_bueno66.StringValue({
  required: true,
  emptyAllowed: false,
...
var locationDefinition = {
  latitude: new import_bueno66.NumberValue({ min: -90, max: 90, required: true }),
  longitude: new import_bueno66.NumberValue({ min: -180, max: 180, required: true })
};
var customDefinition = {
  custom: new import_bueno66.RecordValue({
    options: { required: false }
  })
};
var contextDefinition = {
  ...
  view: new import_bueno66.RecordValue({
    options: { required: true },
    values: viewDefinition
  }),
  location: new import_bueno66.RecordValue({
    options: { required: false },
...
var contextSchema = new import_bueno66.Schema(contextDefinition);

// src/features/commerce/context/context-actions.ts
var setContext3 = (0, import_toolkit74.createAction)(
  "commerce/context/set",
  (payload) => validatePayload(payload, contextDefinition)
);
var setView = (0, import_toolkit74.createAction)(
  "commerce/context/setView",
  (payload) => validatePayload(payload, viewDefinition)
);
var setLocation = (0, import_toolkit74.createAction)(
  "commerce/context/setLocation",
  (payload) => validatePayload(payload, locationDefinition)
);
var setCustom = (0, import_toolkit74.createAction)(
...
// src/features/facets/facet-search-set/specific/specific-facet-search-set-slice.ts
var specificFacetSearchSetReducer = (0, import_toolkit75.createReducer)(
...
var definition = {
  facetId: facetIdDefinition,
  selection: new import_bueno67.RecordValue({ values: facetValueDefinition })
};
var executeToggleFacetSelect = (0, import_toolkit76.createAsyncThunk)("facet/executeToggleSelect", ({ facetId: facetId2, selection }, thunk) => {
  const {
    dispatch,
...
var executeToggleFacetExclude = (0, import_toolkit76.createAsyncThunk)("facet/executeToggleExclude", ({ facetId: facetId2, selection }, thunk) => {
  const {
    dispatch,
    extra: { validatePayload: validatePayload2 }
  } = thunk;
...
// src/controllers/core/facets/facet/headless-core-facet-options.ts
var facetOptionsSchema = new import_bueno68.Schema({
  facetId,
  tabs: new import_bueno68.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno68.ArrayValue({ each: new import_bueno68.StringValue() }),
      excluded: new import_bueno68.ArrayValue({ each: new import_bueno68.StringValue() })
    }
  }),
  field,
  filterFacetCount,
  injectionDepth,
  numberOfValues,
  sortCriteria: new import_bueno68.StringValue({ constrainTo: facetSortCriteria }),
  resultsMustMatch: new import_bueno68.StringValue({ constrainTo: facetResultsMustMatch }),
  facetSearch
});
...
var facetOptionsSchema2 = new import_bueno69.Schema({
  facetId,
  field,
  ...
  injectionDepth,
  numberOfValues,
  sortCriteria: new import_bueno69.StringValue({ constrainTo: facetSortCriteria }),
  resultsMustMatch: new import_bueno69.StringValue({ constrainTo: facetResultsMustMatch }),
  facetSearch,
  allowedValues,
  hasBreadcrumbs,
  customSort
...
var executeToggleRangeFacetSelect = (0, import_toolkit77.createAction)(
...
var executeToggleRangeFacetExclude = (0, import_toolkit77.createAction)(
...
var definition2 = {
  facetId: facetIdDefinition,
  selection: new import_bueno70.RecordValue({ values: dateFacetValueDefinition })
};
var executeToggleDateFacetSelect = (0, import_toolkit78.createAsyncThunk)(
...
var executeToggleDateFacetExclude = (0, import_toolkit78.createAsyncThunk)(
...
var dateRangeRequestDefinition2 = {
  start: new import_bueno71.StringValue(),
  end: new import_bueno71.StringValue(),
  endInclusive: new import_bueno71.BooleanValue(),
  state: new import_bueno71.StringValue({ constrainTo: facetValueStates })
};
var dateFacetOptionsSchema = new import_bueno71.Schema({
  facetId,
  field,
  ...
  currentValues: new import_bueno71.ArrayValue({
    each: new import_bueno71.RecordValue({ values: dateRangeRequestDefinition2 })
  }),
...
var definition3 = {
  facetId: facetIdDefinition,
  selection: new import_bueno72.RecordValue({ values: numericFacetValueDefinition })
};
var executeToggleNumericFacetSelect = (0, import_toolkit79.createAsyncThunk)(
...
var executeToggleNumericFacetExclude = (0, import_toolkit79.createAsyncThunk)(
...
var numericRangeRequestDefinition = {
  start: new import_bueno73.NumberValue(),
  end: new import_bueno73.NumberValue(),
  endInclusive: new import_bueno73.BooleanValue(),
  state: new import_bueno73.StringValue({ constrainTo: facetValueStates })
};
var numericFacetOptionsSchema = new import_bueno73.Schema({
  facetId,
  tabs: new import_bueno73.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno73.ArrayValue({ each: new import_bueno73.StringValue() }),
      excluded: new import_bueno73.ArrayValue({ each: new import_bueno73.StringValue() })
    }
  }),
  field,
  generateAutomaticRanges,
  ...
  injectionDepth,
  numberOfValues,
  currentValues: new import_bueno73.ArrayValue({
    each: new import_bueno73.RecordValue({ values: numericRangeRequestDefinition })
  }),
  sortCriteria: new import_bueno73.StringValue({ constrainTo: rangeFacetSortCriteria }),
  resultsMustMatch: new import_bueno73.StringValue({ constrainTo: facetResultsMustMatch }),
  rangeAlgorithm: new import_bueno73.StringValue({ constrainTo: rangeFacetRangeAlgorithm })
});
...
var foldingOptionsSchemaDefinition = {
  collectionField: new import_bueno74.StringValue({ emptyAllowed: false, required: false }),
  parentField: new import_bueno74.StringValue({ emptyAllowed: false, required: false }),
  childField: new import_bueno74.StringValue({ emptyAllowed: false, required: false }),
  numberOfFoldedResults: new import_bueno74.NumberValue({ min: 0, required: false })
};
var registerFolding = (0, import_toolkit80.createAction)(
  "folding/register",
  (payload) => validatePayload(payload, foldingOptionsSchemaDefinition)
);
var loadCollection = (0, import_toolkit80.createAsyncThunk)(
...
var foldingReducer = (0, import_toolkit81.createReducer)(
...
var registerQuerySuggest2 = (0, import_toolkit82.createAction)(
  "querySuggest/register",
  (payload) => validatePayload(payload, {
    ...idDefinition,
    count: new import_bueno75.NumberValue({ min: 0 })
  })
);
var unregisterQuerySuggest = (0, import_toolkit82.createAction)(
  "querySuggest/unregister",
  (payload) => validatePayload(payload, idDefinition)
);
var selectQuerySuggestion2 = (0, import_toolkit82.createAction)(
...
var clearQuerySuggest2 = (0, import_toolkit82.createAction)(
  "querySuggest/clear",
  (payload) => validatePayload(payload, idDefinition)
);
var fetchQuerySuggestions2 = (0, import_toolkit82.createAsyncThunk)(
  "querySuggest/fetch",
  async (payload, {
    getState,
    rejectWithValue,
...
// src/features/query/query-slice.ts
var queryReducer = (0, import_toolkit83.createReducer)(
...
var registerFieldsToInclude = (0, import_toolkit84.createAction)(
  "fields/registerFieldsToInclude",
  (payload) => validatePayload(payload, nonEmptyStringArray)
);
var enableFetchAllFields = (0, import_toolkit84.createAction)("fields/fetchall/enable");
var disableFetchAllFields = (0, import_toolkit84.createAction)("fields/fetchall/disable");
var fetchFieldsDescription = (0, import_toolkit84.createAsyncThunk)("fields/fetchDescription", async (_, { extra, getState, rejectWithValue }) => {
  const state = getState();
  const { accessToken, environment, organizationId } = state.configuration;
...
// src/features/fields/fields-slice.ts
var fieldsReducer = (0, import_toolkit85.createReducer)(
...
// src/controllers/core/result-list/headless-core-result-list.ts
var optionsSchema2 = new import_bueno76.Schema({
  fieldsToInclude: new import_bueno76.ArrayValue({
    required: false,
    each: new import_bueno76.StringValue({
      required: true,
      emptyAllowed: false
    })
  })
...
// src/controllers/core/folded-result-list/headless-core-folded-result-list.ts
var optionsSchema3 = new import_bueno77.Schema(
...
// src/features/generated-answer/generated-answer-slice.ts
var generatedAnswerReducer = (0, import_toolkit86.createReducer)(
...
// src/controllers/core/generated-answer/headless-searchapi-generated-answer.ts
...
// src/controllers/knowledge/generated-answer/headless-answerapi-generated-answer.ts
  ...
  return {
    ...
    get state() {
      ...
      return {
        ...
        cannotAnswer: state.cannotAnswer || answerApiState?.generated === false && !answerApiState?.isLoading && !answerApiState?.isStreaming
      };
    },
    retry() {
      const answerApiQueryParams = selectAnswerApiQueryParams(getState());
      engine.dispatch(fetchAnswer(answerApiQueryParams ?? import_query4.skipToken));
    },
    reset() {
      engine.dispatch(resetAnswer());
    },
...
// src/features/follow-up-answers/follow-up-answers-slice.ts
var import_toolkit87 = require("@reduxjs/toolkit");

// src/features/follow-up-answers/follow-up-answers-state.ts
...
var followUpAnswersReducer = (0, import_toolkit87.createReducer)(
  getFollowUpAnswersInitialState(),
  (builder) => builder.addCase(setIsEnabled, (state, { payload }) => {
    state.isEnabled = payload;
...
// src/controllers/knowledge/generated-answer/headless-generated-answer-with-follow-ups.ts
...
var parametersDefinition = {
  f: new import_bueno78.RecordValue(),
  fExcluded: new import_bueno78.RecordValue(),
  lf: new import_bueno78.RecordValue(),
  cf: new import_bueno78.RecordValue(),
  nf: new import_bueno78.RecordValue(),
  nfExcluded: new import_bueno78.RecordValue(),
  mnf: new import_bueno78.RecordValue(),
  mnfExcluded: new import_bueno78.RecordValue(),
  df: new import_bueno78.RecordValue(),
  dfExcluded: new import_bueno78.RecordValue(),
  sortCriteria: new import_bueno78.RecordValue(),
  page: new import_bueno78.NumberValue({ min: 0 }),
  perPage: new import_bueno78.NumberValue({ min: 1 })
};

// src/features/commerce/product-listing-parameters/product-listing-parameters-actions.ts
var restoreProductListingParameters = (0, import_toolkit88.createAction)(
...
var searchParametersDefinition2 = {
  q: new import_bueno79.StringValue(),
  ...parametersDefinition
};

// src/features/commerce/search-parameters/search-parameters-actions.ts
var restoreSearchParameters2 = (0, import_toolkit89.createAction)(
  "commerce/searchParameters/restore",
  (payload) => validatePayload(payload, searchParametersDefinition2)
);

// src/features/facets/facet-order/facet-order-slice.ts
var facetOrderReducer = (0, import_toolkit90.createReducer)(
...
// src/features/history/history-slice.ts
var historyReducer = (0, import_toolkit91.createReducer)(
...
function buildHistoryManager(engine) {
  ...
  const canGoBack = (state) => {
    return state.past.length > 0 && !(0, import_bueno80.isNullOrUndefined)(state.present);
  };
  return {
    ...controller,
...
var registerRecentResultsPayloadDefinition = {
  results: new import_bueno81.ArrayValue({
    required: true,
    each: new import_bueno81.RecordValue({ values: resultPartialDefinition })
  }),
  maxLength: new import_bueno81.NumberValue({ required: true, min: 1, default: 10 })
};
var registerRecentResults = (0, import_toolkit92.createAction)(
  "recentResults/registerRecentResults",
  (payload) => validatePayload(payload, registerRecentResultsPayloadDefinition)
);
var pushRecentResult = (0, import_toolkit92.createAction)(
...
var clearRecentResults = (0, import_toolkit92.createAction)(
...
// src/features/instant-results/instant-results-slice.ts
var instantResultsReducer = (0, import_toolkit93.createReducer)(
...
var instantResultsOptionDefinitions = {
  ...
  maxResultsPerQuery: new import_bueno82.NumberValue({
    required: true,
    min: 1
  }),
  cacheTimeout: new import_bueno82.NumberValue()
};
var instantResultsOptionsSchema = new import_bueno82.Schema(instantResultsOptionDefinitions);
...
var paginationReducer = (0, import_toolkit94.createReducer)(
...
var optionsSchema4 = new import_bueno83.Schema({
  numberOfPages: new import_bueno83.NumberValue({ default: 5, min: 0 })
});
var initialStateSchema2 = new import_bueno83.Schema({
  page: new import_bueno83.NumberValue({ min: 1 })
});
...
// src/features/result-preview/result-preview-actions.ts
var fetchResultContent = (0, import_toolkit95.createAsyncThunk)(
...
var nextPreview = (0, import_toolkit95.createAction)("resultPreview/next");
var previousPreview = (0, import_toolkit95.createAction)("resultPreview/previous");
var preparePreviewPagination = (0, import_toolkit95.createAction)(
  "resultPreview/prepare",
  (payload) => validatePayload(payload, { results: new import_bueno84.ArrayValue({ required: true }) })
);
var MAX_GET_LENGTH = 2048;
var updateContentURL = (0, import_toolkit95.createAsyncThunk)(
...
var resultPreviewReducer = (0, import_toolkit96.createReducer)(
...
var registerRecentQueriesPayloadDefinition = {
  queries: new import_bueno85.ArrayValue({
    required: true,
    each: new import_bueno85.StringValue({ emptyAllowed: false })
  }),
  maxLength: new import_bueno85.NumberValue({ required: true, min: 1, default: 10 })
};
var registerRecentQueries = (0, import_toolkit97.createAction)(
  "recentQueries/registerRecentQueries",
  (payload) => validatePayload(payload, registerRecentQueriesPayloadDefinition)
);
var clearRecentQueries = (0, import_toolkit97.createAction)(
...
// src/features/recent-queries/recent-queries-slice.ts
var recentQueriesReducer = (0, import_toolkit98.createReducer)(
...
var initialStateSchema3 = new import_bueno86.Schema({
  queries: new import_bueno86.ArrayValue({ required: true })
});
var optionsSchema5 = new import_bueno86.Schema({
  maxLength: new import_bueno86.NumberValue({ required: true, min: 1 }),
  clearFilters: new import_bueno86.BooleanValue()
});
...
function buildCoreRecentQueriesList(engine, props) {
  ...
  return {
    ...
    updateRecentQueries(queries) {
      const errorMessage = new import_bueno86.ArrayValue({
        required: true,
        each: new import_bueno86.StringValue({ required: true }),
        min: 1
      }).validate(queries);
      if (errorMessage) {
    ...
    executeRecentQuery(index) {
      const errorMessage = new import_bueno86.NumberValue({
        required: true,
        min: 0,
      ...
      if ((0, import_bueno86.isBoolean)(engine.state.query?.enableQuerySyntax)) {
...
// src/features/recent-results/recent-results-slice.ts
var recentResultsReducer = (0, import_toolkit99.createReducer)(
...
var initialStateSchema4 = new import_bueno87.Schema({
  results: new import_bueno87.ArrayValue({ required: true })
});
var optionsSchema6 = new import_bueno87.Schema({
  maxLength: new import_bueno87.NumberValue({ required: true, min: 1 })
});
...
// src/controllers/relevance-inspector/headless-relevance-inspector.ts
var initialStateSchema5 = new import_bueno88.Schema({
  enabled: new import_bueno88.BooleanValue({ default: false })
});
...
var initialStateSchema6 = new import_bueno89.Schema({
  numberOfResults: new import_bueno89.NumberValue({ min: 0 })
});
...
var registerQuerySetQuery = (0, import_toolkit100.createAction)(
  "querySet/register",
  (payload) => validatePayload(payload, querySetDefinition)
);
var updateQuerySetQuery = (0, import_toolkit100.createAction)(
  "querySet/update",
  (payload) => validatePayload(payload, querySetDefinition)
);
...
var registerQuerySetQuery2 = (0, import_toolkit101.createAction)(
  "commerce/querySet/register",
  (payload) => validatePayload(payload, querySetDefinition)
);
var updateQuerySetQuery2 = (0, import_toolkit101.createAction)(
  "commerce/querySet/update",
  (payload) => validatePayload(payload, querySetDefinition)
);

// src/features/query-set/query-set-slice.ts
var querySetReducer = (0, import_toolkit102.createReducer)(
...
function handleRestoreSearchParameters(state, action) {
  if (!(0, import_bueno90.isNullOrUndefined)(action.payload.q)) {
...
// src/features/query-suggest/query-suggest-slice.ts
var querySuggestReducer = (0, import_toolkit103.createReducer)(
...
var openCloseDelimitersDefinition = {
  open: new import_bueno91.StringValue(),
  close: new import_bueno91.StringValue()
};
var searchBoxOptionDefinitions = {
  id: requiredNonEmptyString,
  numberOfSuggestions: new import_bueno91.NumberValue({ min: 0 }),
  enableQuerySyntax: new import_bueno91.BooleanValue(),
  highlightOptions: new import_bueno91.RecordValue({
    values: {
      notMatchDelimiters: new import_bueno91.RecordValue({
        values: openCloseDelimitersDefinition
      }),
      exactMatchDelimiters: new import_bueno91.RecordValue({
        values: openCloseDelimitersDefinition
      }),
      correctionDelimiters: new import_bueno91.RecordValue({
        values: openCloseDelimitersDefinition
      })
    }
  }),
  clearFilters: new import_bueno91.BooleanValue()
};
var searchBoxOptionsSchema = new import_bueno91.Schema(
...
// src/controllers/core/search-parameter-manager/headless-core-search-parameter-manager.ts
var initialStateSchema7 = new import_bueno92.Schema({
  parameters: new import_bueno92.RecordValue({
    options: { required: true },
...
var uniqueIdentifierPayloadDefinition = () => new import_bueno93.RecordValue({
  values: {
    questionAnswerId: requiredNonEmptyString
  },
  options: { required: true }
});
var inlineLinkPayloadDefinition = () => new import_bueno93.RecordValue({
  values: {
...
var expandSmartSnippet = (0, import_toolkit104.createAction)("smartSnippet/expand");
var collapseSmartSnippet = (0, import_toolkit104.createAction)("smartSnippet/collapse");
var likeSmartSnippet = (0, import_toolkit104.createAction)("smartSnippet/like");
var dislikeSmartSnippet = (0, import_toolkit104.createAction)("smartSnippet/dislike");
var openFeedbackModal = (0, import_toolkit104.createAction)(
  "smartSnippet/feedbackModal/open"
);
var closeFeedbackModal = (0, import_toolkit104.createAction)(
  "smartSnippet/feedbackModal/close"
);
var expandSmartSnippetRelatedQuestion = (0, import_toolkit104.createAction)(
  "smartSnippet/related/expand",
  (payload) => validateQuestionAnsweringActionCreatorPayload(payload)
);
var collapseSmartSnippetRelatedQuestion = (0, import_toolkit104.createAction)(
...
var questionAnsweringReducer = (0, import_toolkit105.createReducer)(
...
var registerSortCriterion = (0, import_toolkit106.createAction)(
  "sortCriteria/register",
  (payload) => validate2(payload)
);
var updateSortCriterion = (0, import_toolkit106.createAction)(
  "sortCriteria/update",
  (payload) => validate2(payload)
);
...
var sortCriteriaReducer = (0, import_toolkit107.createReducer)(
  getSortCriteriaInitialState(),
  (builder) => {
    builder.addCase(
...
function validateSortInitialState(engine, state) {
  ...
  const schema = new import_bueno95.Schema({
    criterion: new import_bueno95.ArrayValue({ each: criterionDefinition })
  });
...
function getCriterionAsArray(state) {
  ...
  return (0, import_bueno95.isArray)(state.criterion) ? state.criterion : [state.criterion];
}
...
var registerStandaloneSearchBox = (0, import_toolkit108.createAction)(
  ...
  (payload) => validatePayload(payload, {
    ...
    overwrite: new import_bueno96.BooleanValue({ required: false })
  })
);
...
var fetchRedirectUrl = (0, import_toolkit108.createAsyncThunk)(
  ...
  async (payload, {
    ...
    validatePayload2(payload, { id: new import_bueno96.StringValue({ emptyAllowed: false }) });
...
var standaloneSearchBoxSchema = new import_bueno97.Schema({
  ...searchBoxOptionDefinitions,
  redirectionUrl: new import_bueno97.StringValue({
    required: true,
    emptyAllowed: false
  }),
  overwrite: new import_bueno97.BooleanValue({
    required: false
  })
});
...
var staticFilterSetReducer = (0, import_toolkit110.createReducer)(
...
// src/controllers/static-filter/headless-static-filter.ts
var optionsSchema7 = new import_bueno98.Schema({
  id: staticFilterIdSchema,
  values: staticFilterValuesSchema
});
...
var optionsSchema8 = new import_bueno99.Schema({
  expression: requiredEmptyAllowedString,
  id: requiredNonEmptyString,
  clearFiltersOnTabChange: new import_bueno99.BooleanValue()
});
var initialStateSchema8 = new import_bueno99.Schema({
  isActive: new import_bueno99.BooleanValue()
});
...
function castUnknownObject(value) {
  ...
  Object.entries(jsonParsed).forEach((entry) => {
    ...
    ret[id] = values.map((v) => (0, import_bueno100.isString)(v) ? decodeURIComponent(v) : v);
  });
  return ret;
}
...
// src/controllers/url-manager/headless-url-manager.ts
var initialStateSchema9 = new import_bueno101.Schema({
  fragment: new import_bueno101.StringValue()
});
...
var addPageViewEntryInActionsHistory = (0, import_toolkit112.createAsyncThunk)(
...
var optionalAndPossiblyEmpty = () => new import_bueno102.StringValue({ required: false, emptyAllowed: true });
var updateAdvancedSearchQueries = (0, import_toolkit113.createAction)(
...
var registerAdvancedSearchQueries = (0, import_toolkit113.createAction)(
...
// src/features/advanced-search-queries/advanced-search-queries-slice.ts
var advancedSearchQueriesReducer = (0, import_toolkit114.createReducer)(
  ...
  (builder) => {
    builder.addCase(updateAdvancedSearchQueries, (state, action) => {
      ...
      if (!(0, import_bueno103.isUndefined)(aq)) {
        state.aq = aq;
        state.aqWasSet = true;
      }
      if (!(0, import_bueno103.isUndefined)(cq)) {
        state.cq = cq;
        state.cqWasSet = true;
      }
      if (!(0, import_bueno103.isUndefined)(lq)) {
        state.lq = lq;
        state.lqWasSet = true;
      }
      if (!(0, import_bueno103.isUndefined)(dq)) {
        state.dq = dq;
        state.dqWasSet = true;
      }
...
var setExcerptLength = (0, import_toolkit115.createAction)(
  "excerptLength/set",
...
// src/features/excerpt-length/excerpt-length-slice.ts
var excerptLengthReducer = (0, import_toolkit116.createReducer)(
...
// src/features/facets/automatic-facet-set/automatic-facet-set-actions-loader.ts
...
// src/features/search-parameters/search-parameter-actions-loader.ts

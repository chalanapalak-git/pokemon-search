...
// src/ssr-next.index.ts
var ssr_next_index_exports = {};
__export(ssr_next_index_exports, {
...
module.exports = __toCommonJS(ssr_next_index_exports);
...
// src/ssr-next/search/controllers/breadcrumb-manager/headless-breadcrumb-manager.ssr.ts
...
// src/ssr-next/search/controllers/context/headless-context.ssr.ts
...
// src/ssr-next/search/controllers/dictionary-field-context/headless-dictionary-field-context.ssr.ts
...
// src/ssr-next/search/controllers/did-you-mean/headless-did-you-mean.ssr.ts
...
// src/ssr-next/search/controllers/facet-manager/headless-facet-manager.ssr.ts
...
// src/ssr-next/search/controllers/facets/automatic-facet-generator/headless-automatic-facet-generator.ssr.ts
...
// src/ssr-next/search/controllers/facets/category-facet/headless-category-facet.ssr.ts
...
// src/ssr-next/search/controllers/facets/facet/headless-facet.ssr.ts
...
// src/ssr-next/search/controllers/facets/range-facet/date-facet/headless-date-facet.ssr.ts
...
// src/ssr-next/search/controllers/facets/range-facet/date-facet/headless-date-filter.ssr.ts
...
// src/ssr-next/search/controllers/facets/range-facet/numeric-facet/headless-numeric-facet.ssr.ts
...
// src/ssr-next/search/controllers/facets/range-facet/numeric-facet/headless-numeric-filter.ssr.ts
...
// src/ssr-next/search/controllers/field-suggestions/category-facet/headless-category-field-suggestions.ssr.ts
...
// src/ssr-next/search/controllers/field-suggestions/facet/headless-field-suggestions.ssr.ts
...
// src/ssr-next/search/controllers/folded-result-list/headless-folded-result-list.ssr.ts
...
// src/ssr-next/search/controllers/history-manager/headless-history-manager.ssr.ts
...
// src/ssr-next/search/controllers/instant-results/instant-results.ssr.ts
...
// src/ssr-next/search/controllers/pager/headless-pager.ssr.ts
...
// src/ssr-next/search/controllers/query-error/headless-query-error.ssr.ts
...
// src/ssr-next/search/controllers/query-summary/headless-query-summary.ssr.ts
...
// src/ssr-next/search/controllers/quickview/headless-quickview.ssr.ts
...
// src/ssr-next/search/controllers/recent-queries-list/headless-recent-queries-list.ssr.ts
...
// src/ssr-next/search/controllers/recent-results-list/headless-recent-results-list.ssr.ts
...
// src/ssr-next/search/controllers/relevance-inspector/headless-relevance-inspector.ssr.ts
...
// src/ssr-next/search/controllers/result-list/headless-result-list.ssr.ts
...
// src/ssr-next/search/controllers/results-per-page/headless-results-per-page.ssr.ts
...
// src/ssr-next/search/controllers/search-box/headless-search-box.ssr.ts
...
// src/ssr-next/search/controllers/search-parameter-manager/headless-search-parameter-manager.ssr.ts
...
// src/ssr-next/search/controllers/search-status/headless-search-status.ssr.ts
...
// src/ssr-next/search/controllers/smart-snippet/headless-smart-snippet.ssr.ts
...
// src/ssr-next/search/controllers/smart-snippet-questions-list/headless-smart-snippet-questions-list.ssr.ts
...
// src/ssr-next/search/controllers/sort/headless-sort.ssr.ts
...
// src/ssr-next/search/controllers/standalone-search-box/headless-standalone-search-box.ssr.ts
...
// src/ssr-next/search/controllers/static-filter/headless-static-filter.ssr.ts
...
// src/ssr-next/search/controllers/tab/headless-tab.ssr.ts
...
// src/ssr-next/search/controllers/tab-manager/headless-tab-manager.ssr.ts
...
// src/ssr-next/search/controllers/triggers/headless-execute-trigger.ssr.ts
...
// src/ssr-next/search/controllers/triggers/headless-notify-trigger.ssr.ts
...
// src/ssr-next/search/controllers/triggers/headless-query-trigger.ssr.ts
...
// src/ssr-next/search/controllers/triggers/headless-redirection-trigger.ssr.ts
...
// src/ssr-next/search/controllers/url-manager/headless-url-manager.ssr.ts
...
// src/ssr-next/common/access-token-manager.ts
...
// src/ssr-next/common/builders/controller-builder.ts
var ControllerBuilder = class {
  constructor(definition4, engine, props) {
    __publicField(this, "_definition");
    __publicField(this, "_engine");
    __publicField(this, "_props");
    __publicField(this, "_additionalArgs", []);
    this._definition = definition4;
    this._engine = engine;
    this._props = props;
  }
  ...
  build() {
    ...
    if ("buildWithProps" in this._definition && typeof this._definition.buildWithProps === "function") {
...
// src/ssr-next/common/builders/static-controller-builder.ts
var StaticControllerBuilder = class {
  constructor() {
    __publicField(this, "_state");
    __publicField(this, "_initialState");
  }
  withState(state) {
...
function createStaticControllerBuilder(controller) {
...
// src/ssr-next/search/controller-utils.ts
function buildControllerDefinitions({
  definitionsMap,
  engine,
  propsMap
}) {
  return mapObject(definitionsMap, (definition4, key) => {
    const props = propsMap?.[key];
    return new ControllerBuilder(definition4, engine, props).build();
  });
}
function createStaticState({
  ...
  return {
    controllers: mapObject(
      controllers,
      (controller) => createStaticControllerBuilder(controller).build()
    ),
    searchActions: clone(searchActions)
  };
}

// src/ssr-next/search/utils/controller-wiring.ts
var import_bueno104 = require("@coveo/bueno");
var searchDefinition = {
  searchParams: new import_bueno104.RecordValue({
    options: { required: false },
    values: { q: nonRequiredEmptyAllowedString }
  })
};
var searchDefinitionSchema = new import_bueno104.Schema(searchDefinition);
function validateBuildConfig(buildConfig) {
  searchDefinitionSchema.validate(buildConfig);
}
var ControllerWirer = class {
...
function wireControllerParams(controllerDefinitions, buildConfig) {
...
// src/ssr-next/common/augment-preprocess-request.ts
...
// src/ssr-next/search/utils/engine-wiring.ts
...
function augmentSearchEngineOptions(engineOptions, buildConfig) {
...
// src/ssr-next/search/factories/build-factory.ts
...
var buildFactory = (controllerDefinitions, options) => async (buildOptions2) => {
  const controllerProps = wireControllerParams(
    controllerDefinitions,
    buildOptions2
  );
  const engineOptions = augmentSearchEngineOptions(options, buildOptions2);
  ...
  if (buildOptions2 && "searchActions" in buildOptions2) {
    buildOptions2.searchActions.forEach((action) => {
      engine.dispatch(action);
    });
  }
  return {
...
// src/ssr-next/search/factories/hydrated-state-factory.ts
...
// src/ssr-next/search/factories/standalone-static-state-factory.ts
function fetchStandaloneStaticStateFactory(controllerDefinitions, options) {
  return async (params) => {
...
// src/ssr-next/search/factories/static-state-factory.ts
...
// src/ssr-next/search/engine/search-engine.ssr.ts
function defineSearchEngine(options) {
  ...
  const fetchStandaloneStaticState = fetchStandaloneStaticStateFactory(
    augmentedControllerDefinition,
    definitionOptions
  );
...
var setExcerptLength = (0, import_toolkit112.createAction)(
  "excerptLength/set",
  (length) => validatePayload(length, new import_bueno105.NumberValue({ min: 0, required: true }))
);
...
var templateSchema = new import_bueno106.Schema({
  content: new import_bueno106.Value({ required: true }),
  conditions: new import_bueno106.Value({ required: true }),
  priority: new import_bueno106.NumberValue({ required: false, default: 0, min: 0 }),
  fields: new import_bueno106.ArrayValue({
    required: false,
    each: requiredNonEmptyString
  })
});
function buildTemplatesManager() {
  ...
  const validateTemplate = (template) => {
    ...
    if (!areConditionsValid) {
      throw new import_bueno106.SchemaValidationError(
...
var import_bueno108 = require("@coveo/bueno");
...
function extendSearchParameters(searchParams, key, value) {
  if ((0, import_bueno107.isNullOrUndefined)(value)) {
    return;
  }
...
function applyToUrlSearchParam(urlSearchParams, previousState, pair) {
  if ((0, import_bueno108.isNullOrUndefined)(pair[1])) {
    return;
  }
  if (isFacetPair(pair)) {

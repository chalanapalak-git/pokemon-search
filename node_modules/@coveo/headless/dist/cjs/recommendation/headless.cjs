...
var recommendation_index_exports = {};
__export(recommendation_index_exports, {
  ...
  buildRecommendationEngine: () => buildRecommendationEngine,
  buildRecommendationList: () => buildRecommendationList,
  ...
  getSampleRecommendationEngineConfiguration: () => getSampleRecommendationEngineConfiguration,
  ...
  loadRecommendationActions: () => loadRecommendationActions,
  loadSearchConfigurationActions: () => loadSearchConfigurationActions,
  loadSearchHubActions: () => loadSearchHubActions
});
module.exports = __toCommonJS(recommendation_index_exports);
...
var updateBasicConfiguration = (0, import_toolkit.createAction)(
...
var updateSearchConfiguration = (0, import_toolkit.createAction)(
  "configuration/updateSearchConfiguration",
  (payload) => {
    return validatePayload(payload, {
      proxyBaseUrl: new import_bueno4.StringValue({ required: false, url: true }),
      pipeline: new import_bueno4.StringValue({ required: false, emptyAllowed: true }),
      searchHub: nonEmptyString,
      timezone: nonEmptyString,
      locale: nonEmptyString,
      authenticationProviders: new import_bueno4.ArrayValue({
        required: false,
        each: requiredNonEmptyString
      })
    });
...
var analyticsConfigurationSchema = {
  enabled: new import_bueno4.BooleanValue({ default: true }),
  originContext: originSchemaOnConfigUpdate(),
  originLevel2: originSchemaOnConfigUpdate(),
  originLevel3: originSchemaOnConfigUpdate(),
  proxyBaseUrl: new import_bueno4.StringValue({ required: false, url: true }),
  runtimeEnvironment: new import_bueno4.Value(),
  anonymous: new import_bueno4.BooleanValue({ default: false }),
  ...
  source: new import_bueno4.RecordValue({
...
var updateAnalyticsConfiguration = (0, import_toolkit.createAction)(
  "configuration/updateAnalyticsConfiguration",
  (payload) => {
    return validatePayload(payload, analyticsConfigurationSchema);
  }
);
var disableAnalytics = (0, import_toolkit.createAction)("configuration/analytics/disable");
var enableAnalytics = (0, import_toolkit.createAction)("configuration/analytics/enable");
var setOriginLevel2 = (0, import_toolkit.createAction)(
  "configuration/analytics/originlevel2",
  (payload) => validatePayload(payload, { originLevel2: originSchemaOnUpdate() })
);
var setOriginLevel3 = (0, import_toolkit.createAction)(
  "configuration/analytics/originlevel3",
  (payload) => validatePayload(payload, { originLevel3: originSchemaOnUpdate() })
);
var setAgentId = (0, import_toolkit.createAction)(
  "knowledge/setAgentId",
  (payload) => validatePayload(payload, new import_bueno4.StringValue({ required: true }))
);
...
var searchParametersDefinition = {
  q: new import_bueno5.StringValue(),
  enableQuerySyntax: new import_bueno5.BooleanValue(),
  aq: new import_bueno5.StringValue(),
  cq: new import_bueno5.StringValue(),
  firstResult: new import_bueno5.NumberValue({ min: 0 }),
  numberOfResults: new import_bueno5.NumberValue({ min: 0 }),
  sortCriteria: new import_bueno5.StringValue(),
  f: new import_bueno5.RecordValue(),
  fExcluded: new import_bueno5.RecordValue(),
  cf: new import_bueno5.RecordValue(),
  nf: new import_bueno5.RecordValue(),
  mnf: new import_bueno5.RecordValue(),
  df: new import_bueno5.RecordValue(),
  debug: new import_bueno5.BooleanValue(),
  sf: new import_bueno5.RecordValue(),
  tab: new import_bueno5.StringValue(),
  af: new import_bueno5.RecordValue()
};

// src/features/search-parameters/search-parameter-actions.ts
var restoreSearchParameters = (0, import_toolkit2.createAction)(
  "searchParameters/restore",
  (payload) => validatePayload(payload, searchParametersDefinition)
);
var restoreTab = (0, import_toolkit2.createAction)(
...
var enableDebug = (0, import_toolkit3.createAction)("debug/enable");
var disableDebug = (0, import_toolkit3.createAction)("debug/disable");

// src/features/debug/debug-state.ts
var getDebugInitialState = () => false;

// src/features/debug/debug-slice.ts
var debugReducer = (0, import_toolkit4.createReducer)(getDebugInitialState(), (builder) => {
...
var setPipeline = (0, import_toolkit5.createAction)(
  "pipeline/set",
  (payload) => validatePayload(
    payload,
    new import_bueno6.StringValue({ required: true, emptyAllowed: true })
  )
);
...
var undo = (0, import_toolkit6.createAction)("history/undo");
var redo = (0, import_toolkit6.createAction)("history/redo");
var snapshot = (0, import_toolkit6.createAction)("history/snapshot");
var back = (0, import_toolkit6.createAsyncThunk)("history/back", async (_, { dispatch }) => {
  dispatch(undo());
  await dispatch(change());
});
var forward = (0, import_toolkit6.createAsyncThunk)(
  "history/forward",
  async (_, { dispatch }) => {
    dispatch(redo());
    await dispatch(change());
...
var change = (0, import_toolkit6.createAsyncThunk)(
  "history/change",
  async (_, { getState }) => {
    const s = getState();
...
// src/features/pipeline/pipeline-slice.ts
var pipelineReducer = (0, import_toolkit7.createReducer)(
...
var setError = (0, import_toolkit8.createAction)("app/setError");
...
var getAnalyticsSource = (0, import_toolkit9.createSelector)(
  (state) => state.source,
...
var citationSourceSelector = (0, import_toolkit10.createSelector)(
...
function makePreparableAnalyticsAction(prefix, buildEvent) {
  const createAnalyticsAction = (body) => makeInstantlyCallable(
    (0, import_toolkit12.createAsyncThunk)(prefix, body)
  );
...
// src/features/recommendation/recommendation-actions.ts
var setRecommendationId = (0, import_toolkit13.createAction)(
  "recommendation/set",
  (payload) => validatePayload(payload, {
    id: requiredNonEmptyString
  })
);
var getRecommendations = (0, import_toolkit13.createAsyncThunk)(
  "recommendation/get",
...
// src/features/recommendation/recommendation-slice.ts
var recommendationReducer = (0, import_toolkit14.createReducer)(
...
var setSearchHub = (0, import_toolkit15.createAction)(
  "searchHub/set",
  (payload) => validatePayload(
    payload,
    new import_bueno10.StringValue({ required: true, emptyAllowed: true })
  )
);

// src/features/search-hub/search-hub-slice.ts
var import_toolkit16 = require("@reduxjs/toolkit");
var searchHubReducer = (0, import_toolkit16.createReducer)(
...
// src/features/generated-answer/answer-api-selectors.ts
var selectAnswerTriggerParams = (0, import_toolkit17.createSelector)(
...
var selectAnswerApiQueryParams = (0, import_toolkit17.createSelector)(
...
// src/features/follow-up-answers/follow-up-answers-actions.ts
var stringValue = new import_bueno11.StringValue({ required: true });
var setIsEnabled = (0, import_toolkit18.createAction)(
  "followUpAnswers/setIsEnabled",
  (payload) => validatePayload(payload, new import_bueno11.BooleanValue({ required: true }))
);
var setFollowUpAnswersConversationId = (0, import_toolkit18.createAction)(
  "followUpAnswers/setFollowUpAnswersConversationId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var createFollowUpAnswer = (0, import_toolkit18.createAction)(
  "followUpAnswers/createFollowUpAnswer",
  (payload) => validatePayload(payload, {
    question: requiredNonEmptyString
  })
);
var setActiveFollowUpAnswerId = (0, import_toolkit18.createAction)(
  "followUpAnswers/setActiveFollowUpAnswerId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setFollowUpAnswerContentFormat = (0, import_toolkit18.createAction)(
...
var setFollowUpIsLoading = (0, import_toolkit18.createAction)(
  "followUpAnswers/setFollowUpIsLoading",
  (payload) => validatePayload(payload, {
    isLoading: new import_bueno11.BooleanValue({ required: true }),
    answerId: requiredNonEmptyString
  })
);
var followUpMessageChunkReceived = (0, import_toolkit18.createAction)(
...
var followUpCitationsReceived = (0, import_toolkit18.createAction)(
  "followUpAnswers/followUpCitationsReceived",
  (payload) => validatePayload(payload, {
    citations: new import_bueno11.ArrayValue({
      required: true,
...
var followUpCompleted = (0, import_toolkit18.createAction)(
  "followUpAnswers/followUpCompleted",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString,
    cannotAnswer: new import_bueno11.BooleanValue({ required: false })
  })
);
var followUpFailed = (0, import_toolkit18.createAction)(
  "followUpAnswers/followUpFailed",
  (payload) => validatePayload(payload, {
    message: new import_bueno11.StringValue(),
    code: new import_bueno11.NumberValue({ min: 0 }),
    answerId: requiredNonEmptyString
  })
);
var likeFollowUp = (0, import_toolkit18.createAction)(
  "followUpAnswers/likeFollowUp",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var dislikeFollowUp = (0, import_toolkit18.createAction)(
  "followUpAnswers/dislikeFollowUp",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var submitFollowUpFeedback = (0, import_toolkit18.createAction)(
  "followUpAnswers/submitFollowUpFeedback",
  (payload) => validatePayload(payload, {
    answerId: requiredNonEmptyString
  })
);
var resetFollowUpAnswers = (0, import_toolkit18.createAction)(
  "followUpAnswers/resetFollowUpAnswers"
);
var generateFollowUpAnswer = (0, import_toolkit18.createAsyncThunk)(
...
var selectAdvancedSearchQueries = (0, import_toolkit19.createSelector)(
...
var fromAnalyticsStateToAnalyticsParams2 = (s, navigatorContext, eventDescription) => {
  return {
    analytics: {
...
var buildSearchAndFoldingLoadCollectionRequest2 = (state, navigatorContext, eventDescription) => {
  return {
    ...
    ...state.configuration.analytics.enabled && fromAnalyticsStateToAnalyticsParams2(
      state.configuration.analytics,
      navigatorContext,
      eventDescription
    ),
...
var getResultProperty = (result, property) => {
  ...
  if (!(0, import_bueno15.isNullOrUndefined)(anyResult[property])) {
    return anyResult[property];
  }
  if (!(0, import_bueno15.isNullOrUndefined)(result.raw[property])) {
...
var fieldsMustBeDefined = (fieldNames) => {
  return (result) => {
    return fieldNames.every(
      (fieldName) => !(0, import_bueno15.isNullOrUndefined)(getResultProperty(result, fieldName))
    );
  };
};
...
// src/features/search/search-selectors.ts
var selectSearchActionCause = (0, import_toolkit21.createSelector)(
  (state) => state.search,
  (state) => {
...
var selectActiveTab = (0, import_toolkit22.createSelector)(
  (state) => state,
  (tabSetState) => {
    if (!tabSetState) {
      return "";
...
var selectActiveTabExpression = (0, import_toolkit22.createSelector)(
  (state) => state,
  (tabSetState) => {
...
var constructAnswerAPIQueryParams = (state, navigatorContext) => {
  ...
  const analyticsParams = fromAnalyticsStateToAnalyticsParams2(
    state.configuration.analytics,
    navigatorContext,
...
// src/features/generated-answer/generated-answer-actions.ts
var stringValue2 = new import_bueno16.StringValue({ required: true });
var optionalStringValue = new import_bueno16.StringValue();
var booleanValue = new import_bueno16.BooleanValue({ required: true });
var citationSchema = {
  id: stringValue2,
  title: stringValue2,
  uri: stringValue2,
...
var answerContentFormatSchema = new import_bueno16.StringValue({
  required: true,
  constrainTo: generatedContentFormat
});
var setIsVisible = (0, import_toolkit23.createAction)(
  "generatedAnswer/setIsVisible",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerId2 = (0, import_toolkit23.createAction)(
  "generatedAnswer/setAnswerId",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setAnswerGenerationMode = (0, import_toolkit23.createAction)(
...
var setIsEnabled2 = (0, import_toolkit23.createAction)(
  "generatedAnswer/setIsEnabled",
  (payload) => validatePayload(payload, booleanValue)
);
var updateMessage = (0, import_toolkit23.createAction)(
  "generatedAnswer/updateMessage",
  (payload) => validatePayload(payload, {
    textDelta: stringValue2
  })
);
var updateCitations = (0, import_toolkit23.createAction)(
  "generatedAnswer/updateCitations",
  (payload) => validatePayload(payload, {
    citations: new import_bueno16.ArrayValue({
      required: true,
      each: new import_bueno16.RecordValue({
        values: citationSchema
      })
    })
  })
);
var updateError = (0, import_toolkit23.createAction)(
  "generatedAnswer/updateError",
  (payload) => validatePayload(payload, {
    message: optionalStringValue,
    code: new import_bueno16.NumberValue({ min: 0 })
  })
);
var resetAnswer = (0, import_toolkit23.createAction)("generatedAnswer/resetAnswer");
var likeGeneratedAnswer = (0, import_toolkit23.createAction)("generatedAnswer/like");
var dislikeGeneratedAnswer = (0, import_toolkit23.createAction)("generatedAnswer/dislike");
var openGeneratedAnswerFeedbackModal = (0, import_toolkit23.createAction)(
  "generatedAnswer/feedbackModal/open"
);
var expandGeneratedAnswer = (0, import_toolkit23.createAction)("generatedAnswer/expand");
var collapseGeneratedAnswer = (0, import_toolkit23.createAction)("generatedAnswer/collapse");
var setId = (0, import_toolkit23.createAction)(
  "generatedAnswer/setId",
  (payload) => validatePayload(payload, {
    id: new import_bueno16.StringValue({
      required: true
    })
  })
);
var closeGeneratedAnswerFeedbackModal = (0, import_toolkit23.createAction)(
  "generatedAnswer/feedbackModal/close"
);
var sendGeneratedAnswerFeedback = (0, import_toolkit23.createAction)(
  "generatedAnswer/sendFeedback"
);
var setIsLoading = (0, import_toolkit23.createAction)(
  "generatedAnswer/setIsLoading",
  (payload) => validatePayload(payload, booleanValue)
);
var setIsStreaming = (0, import_toolkit23.createAction)(
  "generatedAnswer/setIsStreaming",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerContentFormat = (0, import_toolkit23.createAction)(
  "generatedAnswer/setAnswerContentFormat",
  (payload) => validatePayload(payload, answerContentFormatSchema)
);
var updateResponseFormat = (0, import_toolkit23.createAction)(
  "generatedAnswer/updateResponseFormat",
  (payload) => validatePayload(payload, {
    contentFormat: new import_bueno16.ArrayValue({
      each: answerContentFormatSchema,
      default: ["text/plain"]
    })
  })
);
var updateAnswerConfigurationId = (0, import_toolkit23.createAction)(
  "knowledge/updateAnswerConfigurationId",
  (payload) => validatePayload(payload, stringValue2)
);
var registerFieldsToIncludeInCitations = (0, import_toolkit23.createAction)(
  "generatedAnswer/registerFieldsToIncludeInCitations",
  (payload) => validatePayload(payload, nonEmptyStringArray)
);
var setIsAnswerGenerated = (0, import_toolkit23.createAction)(
  "generatedAnswer/setIsAnswerGenerated",
  (payload) => validatePayload(payload, booleanValue)
);
var setCannotAnswer = (0, import_toolkit23.createAction)(
  "generatedAnswer/setCannotAnswer",
  (payload) => validatePayload(payload, booleanValue)
);
var setAnswerApiQueryParams = (0, import_toolkit23.createAction)(
  "generatedAnswer/setAnswerApiQueryParams",
  (payload) => validatePayload(payload, new import_bueno16.RecordValue({}))
);
var streamAnswer = (0, import_toolkit23.createAsyncThunk)("generatedAnswer/streamAnswer", async (params, config) => {
...
var generateAnswer = (0, import_toolkit23.createAsyncThunk)(
...
var generateHeadAnswer = (0, import_toolkit23.createAsyncThunk)(
...
var versionReducer = (0, import_toolkit24.createReducer)(VERSION, (builder) => builder);
...
function isAnalyticsAction(action) {
  ...
  return isActionWithType(action) && !(0, import_bueno17.isNullOrUndefined)(analytics);
}
...
var registerTab = (0, import_toolkit25.createAction)(
  "tab/register",
  (payload) => {
    const schema = new import_bueno18.RecordValue({
      values: {
        id: requiredNonEmptyString,
...
var updateActiveTab = (0, import_toolkit25.createAction)(
  "tab/updateActiveTab",
  (id) => {
...
// src/features/configuration/configuration-slice.ts
var configurationReducer = (0, import_toolkit26.createReducer)(
  ...
  (builder) => builder.addCase(updateBasicConfiguration, (state, action) => {
    ...
    if (!(0, import_bueno19.isNullOrUndefined)(action.payload.tab)) {
...
function handleUpdateBasicConfiguration(state, payload) {
  if (!(0, import_bueno19.isNullOrUndefined)(payload.accessToken)) {
    state.accessToken = payload.accessToken;
  }
  state.environment = payload.environment ?? "prod";
  if (!(0, import_bueno19.isNullOrUndefined)(payload.organizationId)) {
    state.organizationId = payload.organizationId;
  }
}
function handleUpdateSearchConfiguration(state, payload) {
  if (!(0, import_bueno19.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.search.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.locale)) {
    state.search.locale = payload.locale;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.timezone)) {
    state.search.timezone = payload.timezone;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.authenticationProviders)) {
...
function handleUpdateAnalyticsConfiguration(state, payload) {
  if (!(0, import_bueno19.isNullOrUndefined)(payload.enabled)) {
    state.analytics.enabled = payload.enabled;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.originContext)) {
    state.analytics.originContext = payload.originContext;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.originLevel2)) {
    state.analytics.originLevel2 = payload.originLevel2;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.originLevel3)) {
    state.analytics.originLevel3 = payload.originLevel3;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.proxyBaseUrl)) {
    state.analytics.apiBaseUrl = payload.proxyBaseUrl;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.trackingId)) {
    state.analytics.trackingId = payload.trackingId;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.analyticsMode)) {
    state.analytics.analyticsMode = payload.analyticsMode;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.source)) {
  ...
  if (!(0, import_bueno19.isNullOrUndefined)(payload.runtimeEnvironment)) {
    state.analytics.runtimeEnvironment = payload.runtimeEnvironment;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.anonymous)) {
    state.analytics.anonymous = payload.anonymous;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.deviceId)) {
    state.analytics.deviceId = payload.deviceId;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.userDisplayName)) {
    state.analytics.userDisplayName = payload.userDisplayName;
  }
  if (!(0, import_bueno19.isNullOrUndefined)(payload.documentLocation)) {
...
var deselectAllBreadcrumbs = (0, import_toolkit27.createAction)("breadcrumb/deselectAll");
var deselectAllNonBreadcrumbs = (0, import_toolkit27.createAction)(
...
var updateFacetAutoSelection = (0, import_toolkit28.createAction)(
  "facet/updateFacetAutoSelection",
  (payload) => validatePayload(payload, {
    allow: new import_bueno20.BooleanValue({ required: true })
  })
);
...
var registerInstantResults = (0, import_toolkit29.createAction)(
  "instantResults/register",
  (payload) => validatePayload(payload, instantResultsRegisterDefinition)
);
var updateInstantResultsQuery = (0, import_toolkit29.createAction)(
  "instantResults/updateQuery",
  (payload) => validatePayload(payload, instantResultsQueryDefinition)
);
var clearExpiredResults = (0, import_toolkit29.createAction)(
...
var numberValue = new import_bueno21.NumberValue({ required: true, min: 0 });
var registerNumberOfResults = (0, import_toolkit30.createAction)(
  "pagination/registerNumberOfResults",
  (payload) => validatePayload(payload, numberValue)
);
var updateNumberOfResults = (0, import_toolkit30.createAction)(
  "pagination/updateNumberOfResults",
  (payload) => validatePayload(payload, numberValue)
);
var registerPage = (0, import_toolkit30.createAction)(
  "pagination/registerPage",
  (payload) => validatePayload(payload, numberValue)
);
var updatePage = (0, import_toolkit30.createAction)(
  "pagination/updatePage",
  (payload) => validatePayload(payload, numberValue)
);
var nextPage = (0, import_toolkit30.createAction)("pagination/nextPage");
var previousPage = (0, import_toolkit30.createAction)("pagination/previousPage");

// src/features/query/query-actions.ts
var import_bueno22 = require("@coveo/bueno");
var import_toolkit31 = require("@reduxjs/toolkit");
var updateQuery = (0, import_toolkit31.createAction)(
  "query/updateQuery",
  (payload) => validatePayload(payload, {
...
var enableDidYouMean = (0, import_toolkit32.createAction)("didYouMean/enable");
var disableDidYouMean = (0, import_toolkit32.createAction)("didYouMean/disable");
var disableAutomaticQueryCorrection = (0, import_toolkit32.createAction)(
  "didYouMean/automaticCorrections/disable"
);
var enableAutomaticQueryCorrection = (0, import_toolkit32.createAction)(
  "didYouMean/automaticCorrections/enable"
);
var applyDidYouMeanCorrection = (0, import_toolkit32.createAction)(
  "didYouMean/correction",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
var setCorrectionMode = (0, import_toolkit32.createAction)(
...
var updateIgnoreQueryTrigger = (0, import_toolkit33.createAction)(
  "trigger/query/ignore",
  (q) => validatePayload(q, new import_bueno25.StringValue({ emptyAllowed: true, required: true }))
);
var applyQueryTriggerModification = (0, import_toolkit33.createAction)(
...
// src/features/search/legacy/search-actions.ts
var executeSearch = (0, import_toolkit34.createAsyncThunk)("search/executeSearch", async (searchAction, config) => {
  const state = config.getState();
  return await legacyExecuteSearch(state, config, searchAction);
});
var fetchPage = (0, import_toolkit34.createAsyncThunk)("search/fetchPage", async (searchAction, config) => {
  const state = config.getState();
  return await legacyFetchPage(state, config, searchAction);
});
var fetchMoreResults = (0, import_toolkit34.createAsyncThunk)("search/fetchMoreResults", async (_, config) => {
  const state = config.getState();
  return await legacyFetchMoreResults(config, state);
});
var fetchFacetValues = (0, import_toolkit34.createAsyncThunk)(
...
var fetchInstantResults = (0, import_toolkit34.createAsyncThunk)(
...
// src/features/search/search-actions.ts
var prepareForSearchWithQuery = (0, import_toolkit35.createAsyncThunk)("search/prepareForSearchWithQuery", (payload, thunk) => {
...
var executeSearch2 = (0, import_toolkit35.createAsyncThunk)(
...
// src/app/listener-middleware/generate-answer-listener-middleware.ts
var generateAnswerListener = (0, import_toolkit36.createListenerMiddleware)();
...
function createReducerManager(initialReducers, preloadedState) {
  ...
  return {
    get combinedReducer() {
      ...
      return rootReducer(
        (0, import_toolkit37.combineReducers)({ ...placeholderReducers, ...reducers })
      );
    },
...
function configureStore({
  ...
  return (0, import_toolkit38.configureStore)({
    reducer,
    preloadedState,
    devTools: {
...
// src/app/recommendation-engine/recommendation-engine-configuration.ts
var recommendationEngineConfigurationSchema = new import_bueno31.Schema({
...
function buildRecommendationEngine(options) {
  ...
  const { pipeline, searchHub, timezone: timezone2, locale, proxyBaseUrl } = options.configuration;
  engine.dispatch(updateSearchConfiguration({ timezone: timezone2, locale, proxyBaseUrl }));
  if (!(0, import_bueno32.isNullOrUndefined)(pipeline)) {
    engine.dispatch(setPipeline(pipeline));
  }
  if (!(0, import_bueno32.isNullOrUndefined)(searchHub)) {
...
var setContext = (0, import_toolkit39.createAction)(
  "context/set",
  (payload) => {
...
var addContext = (0, import_toolkit39.createAction)(
  "context/add",
  (payload) => nonEmptyPayload(payload.contextKey, payload.contextValue)
);
var removeContext = (0, import_toolkit39.createAction)(
  "context/remove",
  (payload) => validatePayload(payload, requiredNonEmptyString)
);
...
var contextReducer = (0, import_toolkit40.createReducer)(
...
// src/controllers/core/context/headless-core-context.ts
var initialStateSchema = new import_bueno34.Schema({
  values: new import_bueno34.RecordValue({
    options: { required: false }
  })
});
...
var setContext2 = (0, import_toolkit41.createAction)(
  "dictionaryFieldContext/set",
  (payload) => {
    const objSchema = new import_bueno35.RecordValue({ options: { required: true } });
    const objError = validatePayload(payload, objSchema).error;
    if (objError) {
      return { payload, error: objError };
    }
    const values = Object.values(payload);
    const valueSchema = new import_bueno35.ArrayValue({ each: requiredEmptyAllowedString });
...
var addContext2 = (0, import_toolkit41.createAction)(
  "dictionaryFieldContext/add",
  (payload) => {
    const schema = new import_bueno35.RecordValue({
      options: { required: true },
      values: {
...
var removeContext2 = (0, import_toolkit41.createAction)(
...
var dictionaryFieldContextReducer = (0, import_toolkit42.createReducer)(
...
var facetValueDefinition = {
  ...
  numberOfResults: new import_bueno36.NumberValue({ min: 0 }),
...
// src/features/facets/automatic-facet-set/automatic-facet-set-actions.ts
var numberOfValuesDefinition = new import_bueno37.NumberValue({
  min: NUMBER_OF_VALUE_MINIMUM,
  default: NUMBER_OF_VALUE_DEFAULT,
  required: false
});
var desiredCountDefinition = new import_bueno37.NumberValue({
...
var setOptions = (0, import_toolkit43.createAction)(
  "automaticFacet/setOptions",
  (payload) => validatePayload(payload, optionsSchema)
);
var deselectAllAutomaticFacetValues = (0, import_toolkit43.createAction)(
  "automaticFacet/deselectAll",
  (payload) => validatePayload(payload, facetIdDefinition)
);
var fieldDefinition = requiredNonEmptyString;
var toggleSelectAutomaticFacetValue = (0, import_toolkit43.createAction)(
  "automaticFacet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    field: fieldDefinition,
    selection: new import_bueno37.RecordValue({ values: facetValueDefinition })
  })
);
...
var categoryFacetValueDefinition = {
  state: new import_bueno38.Value({ required: true }),
  numberOfResults: new import_bueno38.NumberValue({ required: true, min: 0 }),
  value: new import_bueno38.StringValue({ required: true, emptyAllowed: true }),
  path: new import_bueno38.ArrayValue({ required: true, each: requiredNonEmptyString }),
  moreValuesAvailable: new import_bueno38.BooleanValue({ required: false })
};
...
var categoryFacetPayloadDefinition = {
  ...
  tabs: new import_bueno39.RecordValue({
    options: {
      required: false
    },
    values: {
      included: new import_bueno39.ArrayValue({ each: new import_bueno39.StringValue() }),
      excluded: new import_bueno39.ArrayValue({ each: new import_bueno39.StringValue() })
    }
  }),
  activeTab: new import_bueno39.StringValue({ required: false }),
  delimitingCharacter: new import_bueno39.StringValue({ required: false, emptyAllowed: true }),
  filterFacetCount: new import_bueno39.BooleanValue({ required: false }),
  injectionDepth: new import_bueno39.NumberValue({ required: false, min: 0 }),
  numberOfValues: new import_bueno39.NumberValue({ required: false, min: 1 }),
  sortCriteria: new import_bueno39.Value({ required: false }),
  basePath: new import_bueno39.ArrayValue({ required: false, each: requiredNonEmptyString }),
  filterByBasePath: new import_bueno39.BooleanValue({ required: false })
};
var registerCategoryFacet = (0, import_toolkit44.createAction)(
  "categoryFacet/register",
  (payload) => validatePayload(payload, categoryFacetPayloadDefinition)
);
var toggleSelectCategoryFacetValue = (0, import_toolkit44.createAction)(
...
var deselectAllCategoryFacetValues = (0, import_toolkit44.createAction)(
  "categoryFacet/deselectAll",
  (payload) => validatePayload(payload, categoryFacetPayloadDefinition.facetId)
);
var updateCategoryFacetNumberOfValues = (0, import_toolkit44.createAction)(
...
var updateCategoryFacetSortCriterion = (0, import_toolkit44.createAction)(
  "categoryFacet/updateSortCriterion",
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    criterion: new import_bueno39.Value()
  })
);
var updateCategoryFacetBasePath = (0, import_toolkit44.createAction)(
  "categoryFacet/updateBasePath",
  (payload) => validatePayload(payload, {
    facetId: categoryFacetPayloadDefinition.facetId,
    basePath: new import_bueno39.ArrayValue({ each: requiredNonEmptyString })
  })
);
...
var facetSearchOptionsDefinition = {
  facetId: facetIdDefinition,
  captions: new import_bueno40.RecordValue({ options: { required: false } }),
  numberOfValues: new import_bueno40.NumberValue({ required: false, min: 1 }),
  query: new import_bueno40.StringValue({ required: false, emptyAllowed: true })
};

// src/features/facets/facet-search-set/category/category-facet-search-actions.ts
var categoryFacetSearchResultDefinition = {
  path: new import_bueno41.ArrayValue({
    required: true,
    each: requiredNonEmptyString
  }),
  displayValue: requiredEmptyAllowedString,
  rawValue: requiredEmptyAllowedString,
  count: new import_bueno41.NumberValue({ required: true, min: 0 })
};
var selectCategoryFacetSearchResult = (0, import_toolkit45.createAction)(
  "categoryFacet/selectSearchResult",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    value: new import_bueno41.RecordValue({ values: categoryFacetSearchResultDefinition })
  })
);
var registerCategoryFacetSearch = (0, import_toolkit45.createAction)(
...
var selectFacetSearchResultPayloadDefinition = {
  facetId: facetIdDefinition,
  value: new import_bueno42.RecordValue({
    values: {
      displayValue: requiredEmptyAllowedString,
      rawValue: requiredEmptyAllowedString,
      count: new import_bueno42.NumberValue({ required: true, min: 0 })
    }
  })
};
var registerFacetSearch = (0, import_toolkit46.createAction)(
  "facetSearch/register",
  (payload) => validatePayload(payload, facetSearchOptionsDefinition)
);
var updateFacetSearch = (0, import_toolkit46.createAction)(
  "facetSearch/update",
  (payload) => validatePayload(payload, facetSearchOptionsDefinition)
);
var selectFacetSearchResult = (0, import_toolkit46.createAction)(
  "facetSearch/toggleSelectValue",
  (payload) => validatePayload(payload, selectFacetSearchResultPayloadDefinition)
);
var excludeFacetSearchResult = (0, import_toolkit46.createAction)(
...
var facetId = new import_bueno43.StringValue({
  regex: /^[a-zA-Z0-9-_]+$/
});
var field = new import_bueno43.StringValue({ required: true });
var basePath = new import_bueno43.ArrayValue({
  each: new import_bueno43.StringValue()
});
var delimitingCharacter = new import_bueno43.StringValue();
var filterByBasePath = new import_bueno43.BooleanValue();
var filterFacetCount = new import_bueno43.BooleanValue();
var injectionDepth = new import_bueno43.NumberValue({ min: 0 });
var numberOfValues = new import_bueno43.NumberValue({ min: 1 });
var generateAutomaticRanges = new import_bueno43.BooleanValue({
  required: true
});
var captions = new import_bueno43.RecordValue();
var query = new import_bueno43.StringValue();
var facetSearchOptionDefinitions = {
  captions,
  numberOfValues,
  query
};
var facetSearch = new import_bueno43.RecordValue({
  values: facetSearchOptionDefinitions
});
var allowedValues = new import_bueno43.RecordValue({
  options: { required: false },
  values: {
    type: new import_bueno43.StringValue({
      constrainTo: ["simple"],
      emptyAllowed: false,
      required: true
    }),
    values: new import_bueno43.ArrayValue({
      required: true,
      max: 25,
      each: new import_bueno43.StringValue({ emptyAllowed: false, required: true })
    })
  }
});
var hasBreadcrumbs = new import_bueno43.BooleanValue();
var customSort = new import_bueno43.ArrayValue({
  min: 1,
  max: 25,
  required: false,
  each: new import_bueno43.StringValue({ emptyAllowed: false, required: true })
...
var facetRegistrationOptionsDefinition = {
  facetId: facetIdDefinition,
  field: new import_bueno44.StringValue({ required: true, emptyAllowed: true }),
  ...
  resultsMustMatch: new import_bueno44.Value({ required: false }),
  allowedValues,
  customSort
};
var registerFacet = (0, import_toolkit47.createAction)(
  "facet/register",
  (payload) => validatePayload(payload, facetRegistrationOptionsDefinition)
);
var toggleSelectFacetValue = (0, import_toolkit47.createAction)(
  "facet/toggleSelectValue",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    selection: new import_bueno44.RecordValue({ values: facetValueDefinition })
  })
);
var toggleExcludeFacetValue = (0, import_toolkit47.createAction)(
...
var deselectAllFacetValues = (0, import_toolkit47.createAction)(
  "facet/deselectAll",
  (payload) => validatePayload(payload, facetIdDefinition)
);
var updateFacetSortCriterion = (0, import_toolkit47.createAction)(
...
var updateFacetNumberOfValues = (0, import_toolkit47.createAction)(
  "facet/updateNumberOfValues",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    numberOfValues: new import_bueno44.NumberValue({ required: true, min: 1 })
  })
);
var updateFacetIsFieldExpanded = (0, import_toolkit47.createAction)(
  "facet/updateIsFieldExpanded",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    isFieldExpanded: new import_bueno44.BooleanValue({ required: true })
  })
);
var updateFreezeCurrentValues = (0, import_toolkit47.createAction)(
  "facet/updateFreezeCurrentValues",
  (payload) => validatePayload(payload, {
    facetId: facetIdDefinition,
    freezeCurrentValues: new import_bueno44.BooleanValue({ required: true })
  })
);
...
var updateRangeFacetSortCriterion = (0, import_toolkit48.createAction)(
...
var registerDateFacet = (0, import_toolkit49.createAction)(
  "dateFacet/register",
  (payload) => {
    try {
...
var toggleSelectDateFacetValue = (0, import_toolkit49.createAction)(
...
var toggleExcludeDateFacetValue = (0, import_toolkit49.createAction)(
...
var updateDateFacetValues = (0, import_toolkit49.createAction)(
...
// src/features/pagination/pagination-slice.ts
var paginationReducer = (0, import_toolkit51.createReducer)(
...
// src/controllers/recommendation/headless-recommendation.ts
var optionsSchema2 = new import_bueno49.Schema({
  id: new import_bueno49.StringValue({
    emptyAllowed: true,
    required: false,
    default: ""
  }),
  numberOfRecommendations: new import_bueno49.NumberValue({ min: 0 })
});
...
var optionalAndPossiblyEmpty = () => new import_bueno50.StringValue({ required: false, emptyAllowed: true });
var updateAdvancedSearchQueries = (0, import_toolkit52.createAction)(
...
var registerAdvancedSearchQueries = (0, import_toolkit52.createAction)(
...
// src/features/advanced-search-queries/advanced-search-queries-slice.ts
var advancedSearchQueriesReducer = (0, import_toolkit53.createReducer)(
  ...
  (builder) => {
    builder.addCase(updateAdvancedSearchQueries, (state, action) => {
      ...
      if (!(0, import_bueno51.isUndefined)(aq)) {
        state.aq = aq;
        state.aqWasSet = true;
      }
      if (!(0, import_bueno51.isUndefined)(cq)) {
        state.cq = cq;
        state.cqWasSet = true;
      }
      if (!(0, import_bueno51.isUndefined)(lq)) {
        state.lq = lq;
        state.lqWasSet = true;
      }
      if (!(0, import_bueno51.isUndefined)(dq)) {
        state.dq = dq;
        state.dqWasSet = true;
      }
...
var foldingOptionsSchemaDefinition = {
  collectionField: new import_bueno52.StringValue({ emptyAllowed: false, required: false }),
  parentField: new import_bueno52.StringValue({ emptyAllowed: false, required: false }),
  childField: new import_bueno52.StringValue({ emptyAllowed: false, required: false }),
  numberOfFoldedResults: new import_bueno52.NumberValue({ min: 0, required: false })
};
var registerFolding = (0, import_toolkit54.createAction)(
  "folding/register",
  (payload) => validatePayload(payload, foldingOptionsSchemaDefinition)
);
var loadCollection = (0, import_toolkit54.createAsyncThunk)(
  "folding/loadCollection",
  async (collectionId, { getState, rejectWithValue, extra: { apiClient, navigatorContext } }) => {
    const state = getState();
    const sharedWithSearchRequest = state.configuration.analytics.analyticsMode === "legacy" ? await buildSearchAndFoldingLoadCollectionRequest(state) : buildSearchAndFoldingLoadCollectionRequest2(state, navigatorContext);
...
var registerFieldsToInclude = (0, import_toolkit55.createAction)(
  "fields/registerFieldsToInclude",
  (payload) => validatePayload(payload, nonEmptyStringArray)
);
var enableFetchAllFields = (0, import_toolkit55.createAction)("fields/fetchall/enable");
var disableFetchAllFields = (0, import_toolkit55.createAction)("fields/fetchall/disable");
var fetchFieldsDescription = (0, import_toolkit55.createAsyncThunk)("fields/fetchDescription", async (_, { extra, getState, rejectWithValue }) => {
  const state = getState();
  const { accessToken, environment, organizationId } = state.configuration;
...
// src/features/fields/fields-slice.ts
var fieldsReducer = (0, import_toolkit56.createReducer)(
...
var templateSchema = new import_bueno53.Schema({
  content: new import_bueno53.Value({ required: true }),
  conditions: new import_bueno53.Value({ required: true }),
  priority: new import_bueno53.NumberValue({ required: false, default: 0, min: 0 }),
  fields: new import_bueno53.ArrayValue({
    required: false,
    each: requiredNonEmptyString
  })
});
function buildTemplatesManager() {
  ...
  const validateTemplate = (template) => {
    ...
    if (!areConditionsValid) {
      throw new import_bueno53.SchemaValidationError(

...
import require$$1 from 'react-native';
...
var fastBase64Decode = function base64Decode (source, target) {
...
const base64Decode = fastBase64Decode;
const { NativeModules } = require$$1;
...
function getRandomBase64 (byteLength) {
  ...
  } else if (commonjsGlobal.ExpoModules) {
    // Expo SDK 45+
    return commonjsGlobal.ExpoModules.ExpoRandom.getRandomBase64String(byteLength);
  } else {
...
function getRandomValues (array) {
  ...
  // Expo SDK 48+
  if (commonjsGlobal.expo && commonjsGlobal.expo.modules && commonjsGlobal.expo.modules.ExpoCrypto && commonjsGlobal.expo.modules.ExpoCrypto.getRandomValues) {
    // ExpoCrypto.getRandomValues doesn't return the array
    commonjsGlobal.expo.modules.ExpoCrypto.getRandomValues(array);
    return array
  }
...
function isRemoteDebuggingInChrome () {
  ...
  if ('RN$Bridgeless' in commonjsGlobal && RN$Bridgeless === true) {
    return false
  }

  return __DEV__ && typeof commonjsGlobal.nativeCallSyncHook === 'undefined'
}
...
if (typeof commonjsGlobal.crypto.getRandomValues !== 'function') {

...
var eventTypesForDefaultValues = [exports.EventType.click, exports.EventType.custom, exports.EventType.search, exports.EventType.view];
...
var enhanceViewEvent = function (eventType, payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(eventType === exports.EventType.view)) return [3, 2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, nodePonyfillExports.fetch(url, { headers: this.getHeaders(), method: 'DELETE' })];
                    case 1:
                        _a.sent();
                        return [2];
                }
...
var CoveoAnalyticsClient = (function () {
    ...
    CoveoAnalyticsClient.prototype.makeSearchEvent = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.makeEvent(exports.EventType.search, request)];
            });
        });
    };
    ...
    CoveoAnalyticsClient.prototype.makeClickEvent = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.makeEvent(exports.EventType.click, request)];
            });
        });
    };
    ...
    CoveoAnalyticsClient.prototype.makeCustomEvent = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.makeEvent(exports.EventType.custom, request)];
            });
        });
    };
    ...
    CoveoAnalyticsClient.prototype.makeViewEvent = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.makeEvent(exports.EventType.view, request)];
            });
        });
    };
    ...
    CoveoAnalyticsClient.prototype.isKeyAllowedEmpty = function (evtType, key) {
        ...
        var keysThatCanBeEmpty = (_a = {},
            _a[exports.EventType.search] = ['queryText'],
            _a);
...
var ECPlugin = (function (_super) {
    ...
    ECPlugin.prototype.addHooksForPageView = function () {
        this.client.addEventTypeMapping(ECPluginEventTypes.pageview, {
            newEventType: exports.EventType.collect,
...
var handleOneAnalyticsEvent = function (command) {
    ...
    if (pluginName && fn) {
        return coveoua.callPlugin.apply(coveoua, __spreadArray([pluginName, fn], params, false));
    }
...
var _a;
exports.SearchPageEvents = void 0;
...
var CustomEventsTypes = (_a = {},
    ...
    _a[exports.SearchPageEvents.pagerNext] = 'getMoreResults',
    _a[exports.SearchPageEvents.pagerPrevious] = 'getMoreResults',
    _a[exports.SearchPageEvents.pagerNumber] = 'getMoreResults',
    _a[exports.SearchPageEvents.pagerResize] = 'getMoreResults',
    _a[exports.SearchPageEvents.pagerScrolling] = 'getMoreResults',
    _a[exports.SearchPageEvents.facetSearch] = 'facet',
    _a[exports.SearchPageEvents.facetShowLess] = 'facet',
    _a[exports.SearchPageEvents.facetShowMore] = 'facet',
    _a[exports.SearchPageEvents.recommendation] = 'recommendation',
    _a[exports.SearchPageEvents.likeSmartSnippet] = 'smartSnippet',
    _a[exports.SearchPageEvents.dislikeSmartSnippet] = 'smartSnippet',
    _a[exports.SearchPageEvents.expandSmartSnippet] = 'smartSnippet',
    _a[exports.SearchPageEvents.collapseSmartSnippet] = 'smartSnippet',
    _a[exports.SearchPageEvents.openSmartSnippetFeedbackModal] = 'smartSnippet',
    _a[exports.SearchPageEvents.closeSmartSnippetFeedbackModal] = 'smartSnippet',
    _a[exports.SearchPageEvents.sendSmartSnippetReason] = 'smartSnippet',
    _a[exports.SearchPageEvents.expandSmartSnippetSuggestion] = 'smartSnippetSuggestions',
    _a[exports.SearchPageEvents.collapseSmartSnippetSuggestion] = 'smartSnippetSuggestions',
    _a[exports.SearchPageEvents.showMoreSmartSnippetSuggestion] = 'smartSnippetSuggestions',
    _a[exports.SearchPageEvents.showLessSmartSnippetSuggestion] = 'smartSnippetSuggestions',
    _a[exports.SearchPageEvents.clearRecentQueries] = 'recentQueries',
...
var CoveoSearchPageClient = (function () {
    ...
    CoveoSearchPageClient.prototype.makeInterfaceLoad = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.interfaceLoad);
    };
    ...
    CoveoSearchPageClient.prototype.makeRecommendationInterfaceLoad = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.recommendationInterfaceLoad);
    };
    ...
    CoveoSearchPageClient.prototype.makeRecommendation = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.recommendation);
    };
    ...
    CoveoSearchPageClient.prototype.makeRecommendationOpen = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.recommendationOpen, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeStaticFilterClearAll = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.staticFilterClearAll, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeStaticFilterSelect = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.staticFilterSelect, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeStaticFilterDeselect = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.staticFilterDeselect, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFetchMoreResults = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerScrolling, { type: 'getMoreResults' });
    };
    ...
    CoveoSearchPageClient.prototype.makeInterfaceChange = function (metadata) {
        return this.makeSearchEvent(exports.SearchPageEvents.interfaceChange, metadata);
    };
    ...
    CoveoSearchPageClient.prototype.makeDidYouMeanAutomatic = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.didyoumeanAutomatic);
    };
    ...
    CoveoSearchPageClient.prototype.makeDidYouMeanClick = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.didyoumeanClick);
    };
    ...
    CoveoSearchPageClient.prototype.makeResultsSort = function (metadata) {
        return this.makeSearchEvent(exports.SearchPageEvents.resultsSort, metadata);
    };
    ...
    CoveoSearchPageClient.prototype.makeSearchboxSubmit = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.searchboxSubmit);
    };
    ...
    CoveoSearchPageClient.prototype.makeSearchboxClear = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.searchboxClear);
    };
    ...
    CoveoSearchPageClient.prototype.makeSearchboxAsYouType = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.searchboxAsYouType);
    };
    ...
    CoveoSearchPageClient.prototype.makeBreadcrumbFacet = function (metadata) {
        return this.makeSearchEvent(exports.SearchPageEvents.breadcrumbFacet, metadata);
    };
    ...
    CoveoSearchPageClient.prototype.makeBreadcrumbResetAll = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.breadcrumbResetAll);
    };
    ...
    CoveoSearchPageClient.prototype.makeDocumentQuickview = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.documentQuickview, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeDocumentOpen = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.documentOpen, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeOmniboxAnalytics = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.omniboxAnalytics, formatOmniboxMetadata(meta));
    };
    ...
    CoveoSearchPageClient.prototype.makeOmniboxFromLink = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.omniboxFromLink, formatOmniboxMetadata(meta));
    };
    ...
    CoveoSearchPageClient.prototype.makeSearchFromLink = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.searchFromLink);
    };
    ...
    CoveoSearchPageClient.prototype.makeTriggerNotify = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.triggerNotify, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeTriggerExecute = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.triggerExecute, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeTriggerQuery = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.triggerQuery, { query: this.provider.getSearchEventRequestPayload().queryText }, 'queryPipelineTriggers');
    };
    ...
    CoveoSearchPageClient.prototype.makeUndoTriggerQuery = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.undoTriggerQuery, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeTriggerRedirect = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.triggerRedirect, __assign(__assign({}, meta), { query: this.provider.getSearchEventRequestPayload().queryText }));
    };
    ...
    CoveoSearchPageClient.prototype.makePagerResize = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerResize, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makePagerNumber = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerNumber, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makePagerNext = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerNext, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makePagerPrevious = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerPrevious, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makePagerScrolling = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.pagerScrolling);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetClearAll = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetClearAll, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetSearch = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetSearch, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetSelect = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetSelect, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetDeselect = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetDeselect, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetExclude = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetExclude, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetUnexclude = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetUnexclude, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetSelectAll = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetSelectAll, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetUpdateSort = function (meta) {
        return this.makeSearchEvent(exports.SearchPageEvents.facetUpdateSort, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetShowMore = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.facetShowMore, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeFacetShowLess = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.facetShowLess, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeQueryError = function (meta) {
        return this.makeCustomEvent(exports.SearchPageEvents.queryError, meta);
    };
    ...
    CoveoSearchPageClient.prototype.makeQueryErrorBack = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.makeCustomEvent(exports.SearchPageEvents.queryErrorBack)];
                    case 1:
                                ...
                                log: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.sent();
                                                return [2, this.logSearchEvent(exports.SearchPageEvents.queryErrorBack)];
                                        }
                                    });
                                }); },
                            }];
    ...
    CoveoSearchPageClient.prototype.makeQueryErrorRetry = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.makeCustomEvent(exports.SearchPageEvents.queryErrorRetry)];
                    case 1:
                        customEventBuilder = _a.sent();
                        return [2, {
                                description: customEventBuilder.description,
                                log: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.sent();
                                                return [2, this.logSearchEvent(exports.SearchPageEvents.queryErrorRetry)];
                                        }
                                    });
                                }); },
                            }];
    ...
    CoveoSearchPageClient.prototype.makeQueryErrorClear = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.makeCustomEvent(exports.SearchPageEvents.queryErrorClear)];
                    case 1:
                        customEventBuilder = _a.sent();
                        return [2, {
                                description: customEventBuilder.description,
                                log: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.sent();
                                                return [2, this.logSearchEvent(exports.SearchPageEvents.queryErrorClear)];
                                        }
                                    });
                                }); },
                            }];
    ...
    CoveoSearchPageClient.prototype.makeLikeSmartSnippet = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.likeSmartSnippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeDislikeSmartSnippet = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.dislikeSmartSnippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeExpandSmartSnippet = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.expandSmartSnippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeCollapseSmartSnippet = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.collapseSmartSnippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeOpenSmartSnippetFeedbackModal = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.openSmartSnippetFeedbackModal);
    };
    ...
    CoveoSearchPageClient.prototype.makeCloseSmartSnippetFeedbackModal = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.closeSmartSnippetFeedbackModal);
    };
    ...
    CoveoSearchPageClient.prototype.makeSmartSnippetFeedbackReason = function (reason, details) {
        return this.makeCustomEvent(exports.SearchPageEvents.sendSmartSnippetReason, { reason: reason, details: details });
    };
    ...
    CoveoSearchPageClient.prototype.makeExpandSmartSnippetSuggestion = function (snippet) {
        return this.makeCustomEvent(exports.SearchPageEvents.expandSmartSnippetSuggestion, 'documentId' in snippet ? snippet : { documentId: snippet });
    };
    ...
    CoveoSearchPageClient.prototype.makeCollapseSmartSnippetSuggestion = function (snippet) {
        return this.makeCustomEvent(exports.SearchPageEvents.collapseSmartSnippetSuggestion, 'documentId' in snippet ? snippet : { documentId: snippet });
    };
    ...
    CoveoSearchPageClient.prototype.makeShowMoreSmartSnippetSuggestion = function (snippet) {
        return this.makeCustomEvent(exports.SearchPageEvents.showMoreSmartSnippetSuggestion, snippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeShowLessSmartSnippetSuggestion = function (snippet) {
        return this.makeCustomEvent(exports.SearchPageEvents.showLessSmartSnippetSuggestion, snippet);
    };
    ...
    CoveoSearchPageClient.prototype.makeOpenSmartSnippetSource = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.openSmartSnippetSource, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeOpenSmartSnippetSuggestionSource = function (info, snippet) {
        return this.makeClickEvent(exports.SearchPageEvents.openSmartSnippetSuggestionSource, info, { contentIDKey: snippet.documentId.contentIdKey, contentIDValue: snippet.documentId.contentIdValue }, snippet);
    };
    CoveoSearchPageClient.prototype.makeCopyToClipboard = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.copyToClipboard, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeOpenSmartSnippetInlineLink = function (info, identifierAndLink) {
        return this.makeClickEvent(exports.SearchPageEvents.openSmartSnippetInlineLink, info, { contentIDKey: identifierAndLink.contentIDKey, contentIDValue: identifierAndLink.contentIDValue }, identifierAndLink);
    };
    ...
    CoveoSearchPageClient.prototype.makeOpenSmartSnippetSuggestionInlineLink = function (info, snippetAndLink) {
        return this.makeClickEvent(exports.SearchPageEvents.openSmartSnippetSuggestionInlineLink, info, {
    ...
    CoveoSearchPageClient.prototype.makeRecentQueryClick = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.recentQueryClick);
    };
    ...
    CoveoSearchPageClient.prototype.makeClearRecentQueries = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.clearRecentQueries);
    };
    ...
    CoveoSearchPageClient.prototype.makeRecentResultClick = function (info, identifier) {
        return this.makeCustomEvent(exports.SearchPageEvents.recentResultClick, { info: info, identifier: identifier });
    };
    ...
    CoveoSearchPageClient.prototype.makeClearRecentResults = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.clearRecentResults);
    };
    ...
    CoveoSearchPageClient.prototype.makeNoResultsBack = function () {
        return this.makeSearchEvent(exports.SearchPageEvents.noResultsBack);
    };
    ...
    CoveoSearchPageClient.prototype.makeShowMoreFoldedResults = function (info, identifier) {
        return this.makeClickEvent(exports.SearchPageEvents.showMoreFoldedResults, info, identifier);
    };
    ...
    CoveoSearchPageClient.prototype.makeShowLessFoldedResults = function () {
        return this.makeCustomEvent(exports.SearchPageEvents.showLessFoldedResults);
    };
...
exports.CaseAssistEvents = void 0;
(function (CaseAssistEvents) {
    CaseAssistEvents["click"] = "click";
    CaseAssistEvents["flowStart"] = "flowStart";
})(exports.CaseAssistEvents || (exports.CaseAssistEvents = {}));
exports.CaseAssistActions = void 0;
...
})(exports.CaseAssistActions || (exports.CaseAssistActions = {}));
exports.CaseCancelledReasons = void 0;
(function (CaseCancelledReasons) {
    CaseCancelledReasons["quit"] = "Quit";
    CaseCancelledReasons["solved"] = "Solved";
})(exports.CaseCancelledReasons || (exports.CaseCancelledReasons = {}));
...
var CaseAssistClient = (function () {
    ...
    CaseAssistClient.prototype.logSelectFieldSuggestion = function (meta) {
        this.svc.setAction(exports.CaseAssistActions.fieldSuggestionClick, meta.suggestion);
        this.svc.setTicket(meta.ticket);
        return this.sendClickEvent();
    };
    ...
    CaseAssistClient.prototype.logMoveToNextCaseStep = function (meta) {
        this.svc.setAction(exports.CaseAssistActions.nextCaseStep, {
    ...
    CaseAssistClient.prototype.logCaseCancelled = function (meta) {
        this.svc.setAction(exports.CaseAssistActions.caseCancelled, {
            reason: exports.CaseCancelledReasons.quit,
        });
        this.svc.setTicket(meta.ticket);
        return this.sendClickEvent();
    };
    CaseAssistClient.prototype.logCaseSolved = function (meta) {
        this.svc.setAction(exports.CaseAssistActions.caseSolved, {
            reason: exports.CaseCancelledReasons.solved,
        });
        this.svc.setTicket(meta.ticket);
        return this.sendClickEvent();
    };
    CaseAssistClient.prototype.logCaseCreated = function (meta) {
        this.svc.setAction(exports.CaseAssistActions.caseCreated);
        this.svc.setTicket(meta.ticket);
        return this.sendClickEvent();
    };
    CaseAssistClient.prototype.sendFlowStartEvent = function () {
        return this.coveoAnalyticsClient.sendEvent('event', 'svc', exports.CaseAssistEvents.flowStart, this.provider
            ? {
    ...
    CaseAssistClient.prototype.sendClickEvent = function () {
        return this.coveoAnalyticsClient.sendEvent('event', 'svc', exports.CaseAssistEvents.click, this.provider
            ? {
                searchHub: this.provider.getOriginLevel1(),
            }
            : null);
...
var CoveoInsightClient = (function () {
    ...
    CoveoInsightClient.prototype.logInterfaceLoad = function (metadata) {
        if (metadata) {
            ...
            return this.logSearchEvent(exports.SearchPageEvents.interfaceLoad, metadataToSend);
        }
    ...
    CoveoInsightClient.prototype.logStaticFilterDeselect = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.staticFilterDeselect, metadataToSend);
    };
    CoveoInsightClient.prototype.logFetchMoreResults = function (metadata) {
        if (metadata) {
            var metadataToSend = generateMetadataToSend(metadata);
            return this.logCustomEvent(exports.SearchPageEvents.pagerScrolling, __assign(__assign({}, metadataToSend), { type: 'getMoreResults' }));
        }
        return this.logCustomEvent(exports.SearchPageEvents.pagerScrolling, { type: 'getMoreResults' });
    };
    CoveoInsightClient.prototype.logBreadcrumbFacet = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.breadcrumbFacet, metadataToSend);
    };
    CoveoInsightClient.prototype.logBreadcrumbResetAll = function (metadata) {
        if (metadata) {
            var metadataToSend = generateMetadataToSend(metadata);
            return this.logSearchEvent(exports.SearchPageEvents.breadcrumbResetAll, metadataToSend);
        }
        return this.logSearchEvent(exports.SearchPageEvents.breadcrumbResetAll);
    };
    CoveoInsightClient.prototype.logFacetSelect = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.facetSelect, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetExclude = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.facetExclude, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetDeselect = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.facetDeselect, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetUpdateSort = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.facetUpdateSort, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetClearAll = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.facetClearAll, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetShowMore = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.facetShowMore, metadataToSend);
    };
    CoveoInsightClient.prototype.logFacetShowLess = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.facetShowLess, metadataToSend);
    };
    CoveoInsightClient.prototype.logQueryError = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.queryError, metadataToSend);
    };
    CoveoInsightClient.prototype.logPagerNumber = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.pagerNumber, metadataToSend);
    };
    CoveoInsightClient.prototype.logPagerNext = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.pagerNext, metadataToSend);
    };
    CoveoInsightClient.prototype.logPagerPrevious = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.SearchPageEvents.pagerPrevious, metadataToSend);
    };
    CoveoInsightClient.prototype.logDidYouMeanAutomatic = function (metadata) {
        if (metadata) {
            var metadataToSend = generateMetadataToSend(metadata);
            return this.logSearchEvent(exports.SearchPageEvents.didyoumeanAutomatic, metadataToSend);
        }
        return this.logSearchEvent(exports.SearchPageEvents.didyoumeanAutomatic);
    };
    CoveoInsightClient.prototype.logDidYouMeanClick = function (metadata) {
        if (metadata) {
            var metadataToSend = generateMetadataToSend(metadata);
            return this.logSearchEvent(exports.SearchPageEvents.didyoumeanClick, metadataToSend);
        }
        return this.logSearchEvent(exports.SearchPageEvents.didyoumeanClick);
    };
    CoveoInsightClient.prototype.logResultsSort = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.SearchPageEvents.resultsSort, metadataToSend);
    };
    CoveoInsightClient.prototype.logSearchboxSubmit = function (metadata) {
        if (metadata) {
            var metadataToSend = generateMetadataToSend(metadata);
            return this.logSearchEvent(exports.SearchPageEvents.searchboxSubmit, metadataToSend);
        }
        return this.logSearchEvent(exports.SearchPageEvents.searchboxSubmit);
    };
    CoveoInsightClient.prototype.logContextChanged = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logSearchEvent(exports.InsightEvents.contextChanged, metadataToSend);
    };
    CoveoInsightClient.prototype.logExpandToFullUI = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata);
        return this.logCustomEvent(exports.InsightEvents.expandToFullUI, metadataToSend);
    };
    CoveoInsightClient.prototype.logOpenUserActions = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.InsightEvents.openUserActions, metadataToSend);
    };
    CoveoInsightClient.prototype.logShowPrecedingSessions = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.InsightEvents.showPrecedingSessions, metadataToSend);
    };
    CoveoInsightClient.prototype.logShowFollowingSessions = function (metadata) {
        var metadataToSend = generateMetadataToSend(metadata, false);
        return this.logCustomEvent(exports.InsightEvents.showFollowingSessions, metadataToSend);
    };
    CoveoInsightClient.prototype.logViewedDocumentClick = function (document, metadata) {
        return this.logCustomEvent(exports.InsightEvents.clickViewedDocument, __assign(__assign({}, generateMetadataToSend(metadata, false)), { document: document }));
    };
    ...
    CoveoInsightClient.prototype.logDocumentQuickview = function (info, identifier, caseMetadata) {
        ...
        return this.logClickEvent(exports.SearchPageEvents.documentQuickview, info, identifier, caseMetadata ? __assign(__assign({}, generateMetadataToSend(caseMetadata, false)), metadata) : metadata);
    };
    ...
    CoveoInsightClient.prototype.logDislikeSmartSnippet = function (metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.dislikeSmartSnippet, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logExpandSmartSnippet = function (metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.expandSmartSnippet, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logCollapseSmartSnippet = function (metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.collapseSmartSnippet, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logOpenSmartSnippetFeedbackModal = function (metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.openSmartSnippetFeedbackModal, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logCloseSmartSnippetFeedbackModal = function (metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.closeSmartSnippetFeedbackModal, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logSmartSnippetFeedbackReason = function (reason, details, metadata) {
        return this.logCustomEvent(exports.SearchPageEvents.sendSmartSnippetReason, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), { reason: reason, details: details }) : { reason: reason, details: details });
    };
    CoveoInsightClient.prototype.logExpandSmartSnippetSuggestion = function (snippet, metadata) {
        ...
        return this.logCustomEvent(exports.SearchPageEvents.expandSmartSnippetSuggestion, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), snippetMetadata) : snippetMetadata);
    };
    CoveoInsightClient.prototype.logCollapseSmartSnippetSuggestion = function (snippet, metadata) {
        var snippetMetadata = 'documentId' in snippet ? snippet : { documentId: snippet };
        return this.logCustomEvent(exports.SearchPageEvents.collapseSmartSnippetSuggestion, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), snippetMetadata) : snippetMetadata);
    };
    CoveoInsightClient.prototype.logOpenSmartSnippetSource = function (info, identifier, metadata) {
        return this.logClickEvent(exports.SearchPageEvents.openSmartSnippetSource, info, identifier, metadata ? generateMetadataToSend(metadata, false) : undefined);
    };
    CoveoInsightClient.prototype.logOpenSmartSnippetSuggestionSource = function (info, snippet, metadata) {
        return this.logClickEvent(exports.SearchPageEvents.openSmartSnippetSuggestionSource, info, { contentIDKey: snippet.documentId.contentIdKey, contentIDValue: snippet.documentId.contentIdValue }, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), snippet) : snippet);
    };
    CoveoInsightClient.prototype.logOpenSmartSnippetInlineLink = function (info, identifierAndLink, metadata) {
        return this.logClickEvent(exports.SearchPageEvents.openSmartSnippetInlineLink, info, { contentIDKey: identifierAndLink.contentIDKey, contentIDValue: identifierAndLink.contentIDValue }, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), identifierAndLink) : identifierAndLink);
    };
    CoveoInsightClient.prototype.logOpenSmartSnippetSuggestionInlineLink = function (info, snippetAndLink, metadata) {
        return this.logClickEvent(exports.SearchPageEvents.openSmartSnippetSuggestionInlineLink, info, {
            contentIDKey: snippetAndLink.documentId.contentIdKey,
            contentIDValue: snippetAndLink.documentId.contentIdValue,
    ...
    CoveoInsightClient.prototype.logGeneratedAnswerCitationClick = function (info, citation, metadata) {
        return this.logClickEvent(exports.SearchPageEvents.generatedAnswerCitationClick, __assign(__assign({}, info), { documentPosition: 1 }), { contentIDKey: citation.documentId.contentIdKey, contentIDValue: citation.documentId.contentIdValue }, metadata ? __assign(__assign({}, generateMetadataToSend(metadata, false)), citation) : citation);
    };
...
exports.CustomEventsTypes = CustomEventsTypes;

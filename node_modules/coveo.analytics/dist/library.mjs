...
export { CaseAssistActions, CaseAssistClient, CaseAssistEvents, CaseCancelledReasons, CoveoAnalyticsClient, CoveoInsightClient, CoveoSearchPageClient, CoveoUA, CustomEventsTypes, EventType, InsightEvents, SearchPageEvents, simpleanalytics as SimpleAnalytics, analytics, donottrack, getCurrentClient, handleOneAnalyticsEvent, history, storage };
